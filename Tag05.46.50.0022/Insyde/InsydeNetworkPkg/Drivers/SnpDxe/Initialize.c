  ...
  )
{
  ...
  for (Index = 0; Index < 3; Index++) {
      ...
      PerformanceStartMeasure (0, "UNDI Initialize", NULL, 0);
      (*Snp->IssueUndi32Command) ((UINT64)(UINTN) &Snp->Cdb);
      PerformanceEndMeasure (0, "UNDI Initialize", NULL, 0);
  ...
  if (Snp->Cdb.StatCode == PXE_STATCODE_ALREADY_INITIALIZED) {
    ErrFlag = FALSE;
  }
