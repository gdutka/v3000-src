...
#include <Protocol/PxeDeviceInfo.h>
...
struct _PXEBC_VIRTUAL_NIC {
  ...
  BOOLEAN                                   LoadFileSuccess;
};

#pragma pack(1)
typedef struct _PXEBC_CANCEL_HOT_KEY {
  UINT8                                     KeyCode;
  UINT8                                     ScanCode;
} PXEBC_CANCEL_HOT_KEY;
#pragma pack()
...
struct _PXEBC_PRIVATE_DATA {
  ...
  //
  // For cancel hot key use.
  //
  BOOLEAN                                   KeyCheckEventClean;
  BOOLEAN                                   CursorRelocation;
  EFI_SIMPLE_TEXT_INPUT_EX_PROTOCOL         *SimpleTextInEx;
  PXEBC_CANCEL_HOT_KEY                      *HotKeyList;
};
...
#define PXE_BC_KEY_CHECK_TIMER              1000000              // every 100 mS

#define CONSOLE_DEFAULT_RESOLUTION_HOR      1024
#define CONSOLE_DEFAULT_RESOLUTION_VER      768
