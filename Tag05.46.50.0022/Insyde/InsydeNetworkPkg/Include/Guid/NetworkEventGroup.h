...
//
// Insyde H2O event group, to indicate PXE is running.
//
#define H2O_NETWORK_PXE_RUNNING_GUID \
{ 0xbe465124, 0x99b2, 0x471d, 0xb5, 0xc0, 0x38, 0xb9, 0x23, 0x69, 0xd8, 0x58 }
...
extern EFI_GUID gH2ONetworkPxeRunningGuid;
