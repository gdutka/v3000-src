...
#define EFI_GIF_DECODER2_PROTOCOL_GUID \
  {0x7ef36949, 0xd78b, 0x47e5, 0x90, 0x9d, 0x50, 0xf8, 0xb3, 0x47, 0xac, 0x1f}

//
// Forward reference for pure ANSI compatability
//
typedef struct _EFI_GIF_DECODER_PROTOCOL  EFI_GIF_DECODER_PROTOCOL;
typedef struct _EFI_GIF_DECODER2_PROTOCOL EFI_GIF_DECODER2_PROTOCOL;
...
typedef
EFI_STATUS
(EFIAPI *EFI_GIF_DECODER2_CREATE_ANIMATION_FROM_MEM) (
...
typedef
EFI_STATUS
(EFIAPI *EFI_GIF_DECODER2_DESTROY_ANIMATION) (
  IN      EFI_GIF_DECODER2_PROTOCOL    *This,
  IN      ANIMATION                    *Animation
  );
...
typedef
EFI_STATUS
(EFIAPI *EFI_GIF_DECODER2_NEXT_ANIMATION_FRAME) (
  IN      EFI_GIF_DECODER2_PROTOCOL    *This,
  IN      ANIMATION_REFRESH_ENTRY      *AnimationRefrshEntry,
  IN      EFI_GRAPHICS_OUTPUT_PROTOCOL *Gop
  );
...
typedef
EFI_STATUS
(EFIAPI *EFI_GIF_DECODER2_REFRESH_ANIMATION) (
  IN      EFI_GIF_DECODER2_PROTOCOL    *This,
  IN      ANIMATION_REFRESH_ENTRY      *AnimationRefrshEntry,
  IN      EFI_GRAPHICS_OUTPUT_PROTOCOL *Gop,
  IN      UINT64                       CpuFrequency OPTIONAL
...
typedef
EFI_STATUS
(EFIAPI *EFI_GIF_DECODER2_CONVERT_ANIMATION_TO_BLT) (
  IN     EFI_GIF_DECODER2_PROTOCOL     *This,
  IN     ANIMATION                     *Animation,
...
struct _EFI_GIF_DECODER2_PROTOCOL {
  UINT32                                        Size;
  EFI_GIF_DECODER2_CREATE_ANIMATION_FROM_MEM    CreateAnimationFromMem;
  EFI_GIF_DECODER2_DESTROY_ANIMATION            DestroyAnimation;
  EFI_GIF_DECODER2_NEXT_ANIMATION_FRAME         NextAnimationFrame;
  EFI_GIF_DECODER2_REFRESH_ANIMATION            RefreshAnimation;
  EFI_GIF_DECODER2_CONVERT_ANIMATION_TO_BLT     ConvertAnimationToBlt;
};

extern EFI_GUID gEfiGifDecoderProtocolGuid;
extern EFI_GUID gEfiGifDecoder2ProtocolGuid;
