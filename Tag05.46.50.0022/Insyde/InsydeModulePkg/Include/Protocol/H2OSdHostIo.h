...
#ifndef _H2O_SD_HOST_IO_H_
#define _H2O_SD_HOST_IO_H_

#define H2O_SD_HOST_IO_PROTOCOL_GUID \
  { \
  0x296d31a3, 0x59a3, 0x432a, 0xa4, 0x5, 0x37, 0xbd, 0x62, 0x8c, 0x6a, 0xfe \
  }

//
// Forward reference for pure ANSI compatability
//
typedef struct _H2O_SD_HOST_IO_PROTOCOL  H2O_SD_HOST_IO_PROTOCOL;

#define H2O_SD_HOST_IO_PROTOCOL_REVISION_01 0x01
...
#define   LIMIT_ERR                 BIT23       // 032h bit7
#define   AUTO_CMD12_ERR            BIT24       // 032h bit8
...
#define   EXEC_TUNING               BIT6
#define   SPL_CLK_SEL               BIT7
#define   HOST_VER_4_ENABLE         BIT12
...
#define SD_HOST_SPEC_VER_400        0x03
#define SD_HOST_SPEC_VER_410        0x04
#define SD_HOST_SPEC_VER_420        0x05
...
// SMM communication
//
#define SD_HOST_SMM_COMMUNICATION_GUID \
  { 0x3779ad93, 0xb988, 0x43bc, 0x91, 0xf0, 0x3b, 0x6c, 0x6e, 0x38, 0xfa, 0xdb }
#define SD_MMC_SMM_COMMUNICATION_GUID \
...
typedef struct {
  ...
  ///
//  UINT8       Data[1];
} H2O_SDHC_SMM_COMMUNICATE_HEADER;

enum {
  SMM_COMM_INIT_SMM_DATA  = 0,
  SMM_COMM_S3_RESUME      = 1,
  SMM_COMM_UNINSTALL,
  SMM_COMM_OP_MAX
};
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_READ) (
  IN     H2O_SD_HOST_IO_PROTOCOL     *This,
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_WRITE) (
  IN H2O_SD_HOST_IO_PROTOCOL         *This,
  IN H2O_SD_HOST_IO_WIDTH            Width,
  IN UINT64                          Offset,
  IN VOID                            *Buffer
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_OR) (
  IN  H2O_SD_HOST_IO_PROTOCOL       *This,
  IN  H2O_SD_HOST_IO_WIDTH          Width,
  IN  UINT64                        Offset,
  IN  UINTN                         Data
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_AND) (
  IN  H2O_SD_HOST_IO_PROTOCOL      *This,
  IN  H2O_SD_HOST_IO_WIDTH          Width,
  IN  UINT64                        Offset,
  IN  UINTN                         Data
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_SEND_COMMAND) (
  IN   H2O_SD_HOST_IO_PROTOCOL     *This,
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_SET_CLOCK_FREQUENCY) (
  IN  H2O_SD_HOST_IO_PROTOCOL     *This,
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_SET_BUS_WIDTH) (
  IN  H2O_SD_HOST_IO_PROTOCOL     *This,
  IN  UINT32                      BusWidth
  );
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_SET_HOST_VOLTAGE) (
  IN  H2O_SD_HOST_IO_PROTOCOL     *This,
  IN  UINT32                      Voltage
  );
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_RESET_SD_HOST) (
  IN  H2O_SD_HOST_IO_PROTOCOL     *This,
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_DETECT_CARD_AND_INIT_HOST) (
  IN  H2O_SD_HOST_IO_PROTOCOL    *This
  );
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_SET_HOST_DDR_MODE) (
  IN  H2O_SD_HOST_IO_PROTOCOL    *This,
  IN  BOOLEAN                    DdrMode
  );
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_SET_HOST_SPEED_MODE) (
  IN  H2O_SD_HOST_IO_PROTOCOL    *This,
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_ENABLE_AUTO_STOP_CMD) (
  IN  H2O_SD_HOST_IO_PROTOCOL    *This,
  IN  BOOLEAN                    Enable
  );
...
typedef
EFI_STATUS
(EFIAPI *H2O_SD_HOST_IO_PROTOCOL_GET_SLOT_NUM) (
  IN H2O_SD_HOST_IO_PROTOCOL     *This,
  IN OUT UINT8                   *SlotNum
  );

struct _H2O_SD_HOST_IO_PROTOCOL {
  UINT32                                            Revision;
  HOST_CAPABILITY                                   HostCapability;
  H2O_SD_HOST_IO_PROTOCOL_READ                      SdHostRead;
  H2O_SD_HOST_IO_PROTOCOL_WRITE                     SdHostWrite;
  H2O_SD_HOST_IO_PROTOCOL_OR                        SdHostOr;
  H2O_SD_HOST_IO_PROTOCOL_AND                       SdHostAnd;
  H2O_SD_HOST_IO_PROTOCOL_SEND_COMMAND              SendCommand;
  H2O_SD_HOST_IO_PROTOCOL_SET_CLOCK_FREQUENCY       SetClockFrequency;
  H2O_SD_HOST_IO_PROTOCOL_SET_BUS_WIDTH             SetBusWidth;
  H2O_SD_HOST_IO_PROTOCOL_SET_HOST_VOLTAGE          SetHostVoltage;
  H2O_SD_HOST_IO_PROTOCOL_RESET_SD_HOST             ResetSdHost;
  H2O_SD_HOST_IO_PROTOCOL_DETECT_CARD_AND_INIT_HOST DetectCardAndInitHost;
  H2O_SD_HOST_IO_PROTOCOL_SET_HOST_SPEED_MODE       SetHostSpeedMode;
  H2O_SD_HOST_IO_PROTOCOL_SET_HOST_DDR_MODE         SetHostDdrMode;
  H2O_SD_HOST_IO_PROTOCOL_ENABLE_AUTO_STOP_CMD      EnableAutoStopCmd;
  //
  // temp
  //
  H2O_SD_HOST_IO_PROTOCOL_GET_SLOT_NUM              GetSlotNum;
};

extern EFI_GUID gH2OSdHostIoProtocolGuid;
