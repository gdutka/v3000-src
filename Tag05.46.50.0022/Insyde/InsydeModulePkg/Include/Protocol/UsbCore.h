...
#define NON_SMM_POLLING_INTERVAL        (MINIMUM_POLLING_INTERVAL * 1000 * 10)

#define LEGACY_FREE_HC_POLLING_INTERVAL NON_SMM_POLLING_INTERVAL

#define CONNECT_CONTROLLER              0
#define DISCONNECT_CONTROLLER           1
#define FUNCTION_ENABLE                 2
#define FUNCTION_DISABLE                3
...
#define CPU_SAVE_STATE_SIGNATURE2       SIGNATURE_32 ('$', 'C', 'P', '2')
