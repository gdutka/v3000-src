...
typedef
EFI_STATUS
(EFIAPI *EFI_SETUP_MOUSE_SET_MOUSE_ATTRIBUTES) (
  IN  struct _EFI_SETUP_MOUSE_PROTOCOL   *This,
...
typedef
EFI_STATUS
(EFIAPI *EFI_SETUP_MOUSE_GET_MOUSE_ATTRIBUTES) (
  IN  struct _EFI_SETUP_MOUSE_PROTOCOL   *This,
...
struct _EFI_SETUP_MOUSE_PROTOCOL {
  ...
  EFI_SETUP_MOUSE_SET_MOUSE_ATTRIBUTES    SetMouseAttributes;
  EFI_SETUP_MOUSE_GET_MOUSE_ATTRIBUTES    GetMouseAttributes;
};
