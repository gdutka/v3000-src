...
//
#define EFI_RESTORE_FACTORY_DEFAULT_NAME       L"RestoreFactoryDefault"
...
#define RESTORE_FACTORY_DEFAULT_FUN_NUM        0x04
...
#define SELECT_SECURE_BOOT_MODE_FUN_NUM        0x0A
#define UPDATE_DBT_FUN_NUM                     0x0B
#define UPDATE_DBR_FUN_NUM                     0x0C


#define UPDATE_AUTHENTICATED_VARIABLE          0x00
#define APPEND_AUTHENTICATED_VARIABLE          0x01

#define H2O_USER_MODE                          0x00
#define H2O_SETUP_MODE                         0x01
#define H2O_AUDIT_MODE                         0x02
#define H2O_DEPLOYED_MODE                      0x03
