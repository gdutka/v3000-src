...
///
/// Indicates the types of entity that are supported by the TCM
///
...
///
/// Identifies a TCM capability area
///
...
///
/// The area where a key is held assigned by the TCM
///
...
///
/// The types of resources that a TCM may have using internal resources
///
...
///
/// The family ID. Family IDs are automatically assigned a sequence number by the TCM.
/// A trusted process can set the FamilyID value in an individual row to NULL, which
/// invalidates that row. The family ID resets to NULL on each change of TCM Owner.
///
...
//
// Part 2, section 3.1: TCM_STRUCTURE_TAG
//
...
#define TCM_TAG_DA_INFO             ((TCM_STRUCTURE_TAG) 0x0037)
#define TCM_TAG_DA_LIMITED          ((TCM_STRUCTURE_TAG) 0x0038)
#define TCM_TAG_DA_ACTION_TYPE      ((TCM_STRUCTURE_TAG) 0x0039)
...
//
// Part 2, section 4.3: TCM_ENTITY_TYPE
//
...
#define TCM_ET_OPERATOR             ((UINT16) 0x000C) ///< The entity is the operator
...
//   The TCM MUST support the algorithms TCM_ALG_RSA, TCM_ALG_SHA, TCM_ALG_HMAC,
//   TCM_ALG_MGF1
//
#define TCM_ALG_RSA                 ((TCM_ALGORITHM_ID) 0x00000001) ///< The RSA algorithm.
#define TCM_ALG_DES                 ((TCM_ALGORITHM_ID) 0x00000002) ///< The DES algorithm
#define TCM_ALG_3DES                ((TCM_ALGORITHM_ID) 0x00000003) ///< The 3DES algorithm in EDE mode
#define TCM_ALG_SHA                 ((TCM_ALGORITHM_ID) 0x00000004) ///< The SHA1 algorithm
#define TCM_ALG_HMAC                ((TCM_ALGORITHM_ID) 0x00000005) ///< The RFC 2104 HMAC algorithm
#define TCM_ALG_AES128              ((TCM_ALGORITHM_ID) 0x00000006) ///< The AES algorithm, key size 128
#define TCM_ALG_MGF1                ((TCM_ALGORITHM_ID) 0x00000007) ///< The XOR algorithm using MGF1 to create a string the size of the encrypted block
#define TCM_ALG_AES192              ((TCM_ALGORITHM_ID) 0x00000008) ///< AES, key size 192
#define TCM_ALG_AES256              ((TCM_ALGORITHM_ID) 0x00000009) ///< AES, key size 256
#define TCM_ALG_XOR                 ((TCM_ALGORITHM_ID) 0x0000000A) ///< XOR using the rolling nonces
#define TCM_ALG_SM3_256             ((TCM_ALGORITHM_ID) 0x00000012) ///< The SM3-256 algorithm
...
#define TCM_SM3_256_HASH_LEN        0x20
#define TCM_SHA1BASED_NONCE_LEN     TCM_SM3_256_HASH_LEN

///
/// Part 2, section 5.4: TCM_DIGEST
///
typedef struct tdTCM_DIGEST{
  UINT8                             digest[TCM_SM3_256_HASH_LEN];
} TCM_DIGEST;

///
/// This SHALL be the digest of the chosen identityLabel and privacyCA for a new TCM identity
///
...
///
/// This SHALL be a random value generated by a TCM immediately after the EK is installed
/// in that TCM, whenever an EK is installed in that TCM
///
typedef TCM_NONCE                  TCM_DAA_TCM_SEED;
///
/// This SHALL be a random value
///
typedef TCM_NONCE                  TCM_DAA_CONTEXT_SEED;
...
#define TCM_ES_RSAESOAEP_SHA1_MGF1  ((TCM_ENC_SCHEME) 0x0003)
#define TCM_ES_SYM_CNT              ((TCM_ENC_SCHEME) 0x0004)  ///< rev94 defined
#define TCM_ES_SYM_CTR              ((TCM_ENC_SCHEME) 0x0004)
#define TCM_ES_SYM_OFB              ((TCM_ENC_SCHEME) 0x0005)

#define TCM_SS_NONE                 ((TCM_SIG_SCHEME) 0x0001)
#define TCM_SS_RSASSAPKCS1v15_SHA1  ((TCM_SIG_SCHEME) 0x0002)
...
//
#define TCM_CMK_DELEGATE_SIGNING    ((TCM_CMK_DELEGATE) BIT31)
#define TCM_CMK_DELEGATE_STORAGE    ((TCM_CMK_DELEGATE) BIT30)
#define TCM_CMK_DELEGATE_BIND       ((TCM_CMK_DELEGATE) BIT29)
#define TCM_CMK_DELEGATE_LEGACY     ((TCM_CMK_DELEGATE) BIT28)
#define TCM_CMK_DELEGATE_MIGRATE    ((TCM_CMK_DELEGATE) BIT27)
...
//
// Part 2, section 7.1.1: Flag Restrictions (of TCM_PERMANENT_FLAGS)
//
...
#define TCM_PF_DISABLEFULLDALOGICINFO       ((TCM_CAPABILITY_AREA) 20)
...
//
// Part 2, section 7.2.1: Flag Restrictions (of TCM_STCLEAR_FLAGS)
//
...
//
// Part 2, section 7.3.1: Flag Restrictions (of TCM_STANY_FLAGS)
//
...
//
#define TCM_PD_REVMAJOR               ((TCM_CAPABILITY_AREA) 1)
#define TCM_PD_REVMINOR               ((TCM_CAPABILITY_AREA) 2)
#define TCM_PD_TCMPROOF               ((TCM_CAPABILITY_AREA) 3)
#define TCM_PD_OWNERAUTH              ((TCM_CAPABILITY_AREA) 4)
#define TCM_PD_OPERATORAUTH           ((TCM_CAPABILITY_AREA) 5)
#define TCM_PD_MANUMAINTPUB           ((TCM_CAPABILITY_AREA) 6)
#define TCM_PD_ENDORSEMENTKEY         ((TCM_CAPABILITY_AREA) 7)
#define TCM_PD_SRK                    ((TCM_CAPABILITY_AREA) 8)
#define TCM_PD_DELEGATEKEY            ((TCM_CAPABILITY_AREA) 9)
#define TCM_PD_CONTEXTKEY             ((TCM_CAPABILITY_AREA) 10)
#define TCM_PD_AUDITMONOTONICCOUNTER  ((TCM_CAPABILITY_AREA) 11)
#define TCM_PD_MONOTONICCOUNTER       ((TCM_CAPABILITY_AREA) 12)
#define TCM_PD_PCRATTRIB              ((TCM_CAPABILITY_AREA) 13)
#define TCM_PD_ORDINALAUDITSTATUS     ((TCM_CAPABILITY_AREA) 14)
#define TCM_PD_AUTHDIR                ((TCM_CAPABILITY_AREA) 15)
#define TCM_PD_RNGSTATE               ((TCM_CAPABILITY_AREA) 16)
#define TCM_PD_FAMILYTABLE            ((TCM_CAPABILITY_AREA) 17)
#define TCM_DELEGATETABLE             ((TCM_CAPABILITY_AREA) 18)
#define TCM_PD_EKRESET                ((TCM_CAPABILITY_AREA) 19)
#define TCM_PD_MAXNVBUFSIZE           ((TCM_CAPABILITY_AREA) 20)
#define TCM_PD_LASTFAMILYID           ((TCM_CAPABILITY_AREA) 21)
#define TCM_PD_NOOWNERNVWRITE         ((TCM_CAPABILITY_AREA) 22)
#define TCM_PD_RESTRICTDELEGATE       ((TCM_CAPABILITY_AREA) 23)
#define TCM_PD_TCMDAASEED             ((TCM_CAPABILITY_AREA) 24)
#define TCM_PD_DAAPROOF               ((TCM_CAPABILITY_AREA) 25)
...
//
#define TCM_SD_CONTEXTNONCEKEY            ((TCM_CAPABILITY_AREA)0x00000001)
#define TCM_SD_COUNTID                    ((TCM_CAPABILITY_AREA)0x00000002)
#define TCM_SD_OWNERREFERENCE             ((TCM_CAPABILITY_AREA)0x00000003)
#define TCM_SD_DISABLERESETLOCK           ((TCM_CAPABILITY_AREA)0x00000004)
#define TCM_SD_PCR                        ((TCM_CAPABILITY_AREA)0x00000005)
#define TCM_SD_DEFERREDPHYSICALPRESENCE   ((TCM_CAPABILITY_AREA)0x00000006)

//
// Part 2, section 7.6.1: STANY_DATA Subcap for SetCapability
//
#define TCM_AD_CONTEXTNONCESESSION        ((TCM_CAPABILITY_AREA) 1)
#define TCM_AD_AUDITDIGEST                ((TCM_CAPABILITY_AREA) 2)
#define TCM_AD_CURRENTTICKS               ((TCM_CAPABILITY_AREA) 3)
#define TCM_AD_CONTEXTCOUNT               ((TCM_CAPABILITY_AREA) 4)
#define TCM_AD_CONTEXTLIST                ((TCM_CAPABILITY_AREA) 5)
#define TCM_AD_SESSIONS                   ((TCM_CAPABILITY_AREA) 6)
...
///
/// Part 2, section 11.1: TCM_CERTIFY_INFO Structure
///
...
///
/// Part 2, section 11.2: TCM_CERTIFY_INFO2 Structure
///
...
///
/// Part 2, section 11.3 TCM_QUOTE_INFO Structure
///
...
///
/// Part 2, section 11.4 TCM_QUOTE_INFO2 Structure
///
...
///
/// Part 2, section 12.1 TCM_EK_BLOB
///
...
///
/// Part 2, section 12.2 TCM_EK_BLOB_ACTIVATE
///
...
///
/// Part 2, section 12.3 TCM_EK_BLOB_AUTH
///
...
///
/// Part 2, section 12.5 TCM_IDENTITY_CONTENTS
///
...
///
/// Part 2, section 12.6 TCM_IDENTITY_REQ
///
...
///
/// Part 2, section 12.7 TCM_IDENTITY_PROOF
///
...
///
/// Part 2, section 12.8 TCM_ASYM_CA_CONTENTS
///
...
///
/// Part 2, section 12.9 TCM_SYM_CA_ATTESTATION
///
...
///
/// Part 2, section 13.1: TCM _TRANSPORT_PUBLIC
///
...
//
// Part 2, section 13.1.1 TCM_TRANSPORT_ATTRIBUTES Definitions
//
#define TCM_TRANSPORT_ENCRYPT       ((UINT32)BIT0)
#define TCM_TRANSPORT_LOG           ((UINT32)BIT1)
#define TCM_TRANSPORT_EXCLUSIVE     ((UINT32)BIT2)

///
/// Part 2, section 13.2 TCM_TRANSPORT_INTERNAL
///
...
///
/// Part 2, section 13.3 TCM_TRANSPORT_LOG_IN structure
///
...
///
/// Part 2, section 13.4 TCM_TRANSPORT_LOG_OUT structure
///
...
///
/// Part 2, section 13.5 TCM_TRANSPORT_AUTH structure
///
...
///
/// Part 2, section 14.1 TCM_AUDIT_EVENT_IN structure
///
...
///
/// Part 2, section 14.2 TCM_AUDIT_EVENT_OUT structure
///
...
#define TCM_ORD_BASE                               0x00008000
#define TCM_ORD_ActivateIdentity                  ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000007A)
#define TCM_ORD_AuthorizeMigrationKey             ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000002B)
#define TCM_ORD_CertifyKey                        ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000032)
#define TCM_ORD_CertifyKey2                       ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000033)
#define TCM_ORD_CertifySelfTest                   ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000052)
#define TCM_ORD_ChangeAuth                        ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000000C)
#define TCM_ORD_ChangeAuthAsymFinish              ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000000F)
#define TCM_ORD_ChangeAuthAsymStart               ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000000E)
#define TCM_ORD_ChangeAuthOwner                   ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000010)
#define TCM_ORD_CMK_ApproveMA                     ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000001D)
#define TCM_ORD_CMK_ConvertMigration              ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000024)
#define TCM_ORD_CMK_CreateBlob                    ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000001B)
#define TCM_ORD_CMK_CreateKey                     ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000013)
#define TCM_ORD_CMK_CreateTicket                  ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000012)
#define TCM_ORD_CMK_SetRestrictions               ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000001C)
#define TCM_ORD_ContinueSelfTest                  ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000053)
#define TCM_ORD_ConvertMigrationBlob              ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000002A)
#define TCM_ORD_CreateCounter                     ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000DC)
#define TCM_ORD_CreateEndorsementKeyPair          ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000078)
#define TCM_ORD_CreateMaintenanceArchive          ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000002C)
#define TCM_ORD_CreateMigrationBlob               ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000028)
#define TCM_ORD_CreateRevocableEK                 ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000007F)
#define TCM_ORD_CreateWrapKey                     ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000001F)
#define TCM_ORD_DAA_JOIN                          ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000029)
#define TCM_ORD_DAA_SIGN                          ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000031)
#define TCM_ORD_Delegate_CreateKeyDelegation      ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000D4)
#define TCM_ORD_Delegate_CreateOwnerDelegation    ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000D5)
#define TCM_ORD_Delegate_LoadOwnerDelegation      ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000D8)
#define TCM_ORD_Delegate_Manage                   ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000D2)
#define TCM_ORD_Delegate_ReadTable                ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000DB)
#define TCM_ORD_Delegate_UpdateVerification       ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000D1)
#define TCM_ORD_Delegate_VerifyDelegation         ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000D6)
#define TCM_ORD_DirRead                           ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000001A)
#define TCM_ORD_DirWriteAuth                      ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000019)
#define TCM_ORD_DisableForceClear                 ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000005E)
#define TCM_ORD_DisableOwnerClear                 ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000005C)
#define TCM_ORD_DisablePubekRead                  ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000007E)
#define TCM_ORD_DSAP                              ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000011)
#define TCM_ORD_EstablishTransport                ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000E6)
#define TCM_ORD_EvictKey                          ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000022)
#define TCM_ORD_ExecuteTransport                  ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000E7)
#define TCM_ORD_Extend                            ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000014)
#define TCM_ORD_FieldUpgrade                      ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000AA)
#define TCM_ORD_FlushSpecific                     ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000BA)
#define TCM_ORD_ForceClear                        ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000005D)
#define TCM_ORD_GetAuditDigest                    ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000085)
#define TCM_ORD_GetAuditDigestSigned              ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000086)
#define TCM_ORD_GetAuditEvent                     ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000082)
#define TCM_ORD_GetAuditEventSigned               ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000083)
#define TCM_ORD_GetCapability                     ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000065)
#define TCM_ORD_GetCapabilityOwner                ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000066)
#define TCM_ORD_GetCapabilitySigned               ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000064)
#define TCM_ORD_GetOrdinalAuditStatus             ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000008C)
#define TCM_ORD_GetPubKey                         ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000021)
#define TCM_ORD_GetRandom                         ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000046)
#define TCM_ORD_GetTestResult                     ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000054)
#define TCM_ORD_GetTicks                          ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000F1)
#define TCM_ORD_IncrementCounter                  ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000DD)
#define TCM_ORD_Init                              ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000097)
#define TCM_ORD_KeyControlOwner                   ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000023)
#define TCM_ORD_KillMaintenanceFeature            ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000002E)
#define TCM_ORD_LoadAuthContext                   ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000B7)
#define TCM_ORD_LoadContext                       ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000B9)
#define TCM_ORD_LoadKey                           ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000020)
#define TCM_ORD_LoadKey2                          ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000041)
#define TCM_ORD_LoadKeyContext                    ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000B5)
#define TCM_ORD_LoadMaintenanceArchive            ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000002D)
#define TCM_ORD_LoadManuMaintPub                  ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000002F)
#define TCM_ORD_MakeIdentity                      ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000079)
#define TCM_ORD_MigrateKey                        ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000025)
#define TCM_ORD_NV_DefineSpace                    ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000CC)
#define TCM_ORD_NV_ReadValue                      ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000CF)
#define TCM_ORD_NV_ReadValueAuth                  ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000D0)
#define TCM_ORD_NV_WriteValue                     ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000CD)
#define TCM_ORD_NV_WriteValueAuth                 ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000CE)
#define TCM_ORD_OIAP                              ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000000A)
#define TCM_ORD_OSAP                              ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000000B)
#define TCM_ORD_OwnerClear                        ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000005B)
#define TCM_ORD_OwnerReadInternalPub              ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000081)
#define TCM_ORD_OwnerReadPubek                    ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000007D)
#define TCM_ORD_OwnerSetDisable                   ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000006E)
#define TCM_ORD_PCR_Reset                         ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000C8)
#define TCM_ORD_PcrRead                           ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000015)
#define TCM_ORD_PhysicalDisable                   ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000070)
#define TCM_ORD_PhysicalEnable                    ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000006F)
#define TCM_ORD_PhysicalSetDeactivated            ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000072)
#define TCM_ORD_Quote                             ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000016)
#define TCM_ORD_Quote2                            ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000003E)
#define TCM_ORD_ReadCounter                       ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000DE)
#define TCM_ORD_ReadManuMaintPub                  ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000030)
#define TCM_ORD_ReadPubek                         ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000007C)
#define TCM_ORD_ReleaseCounter                    ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000DF)
#define TCM_ORD_ReleaseCounterOwner               ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000E0)
#define TCM_ORD_ReleaseTransportSigned            ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000E8)
#define TCM_ORD_Reset                             ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000005A)
#define TCM_ORD_ResetLockValue                    ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000040)
#define TCM_ORD_RevokeTrust                       ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000080)
#define TCM_ORD_SaveAuthContext                   ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000B6)
#define TCM_ORD_SaveContext                       ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000B8)
#define TCM_ORD_SaveKeyContext                    ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000B4)
#define TCM_ORD_SaveState                         ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000098)
#define TCM_ORD_Seal                              ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000017)
#define TCM_ORD_Sealx                             ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000003D)
#define TCM_ORD_SelfTestFull                      ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000050)
#define TCM_ORD_SetCapability                     ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000003F)
#define TCM_ORD_SetOperatorAuth                   ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000074)
#define TCM_ORD_SetOrdinalAuditStatus             ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000008D)
#define TCM_ORD_SetOwnerInstall                   ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000071)
#define TCM_ORD_SetOwnerPointer                   ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000075)
#define TCM_ORD_SetRedirection                    ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000009A)
#define TCM_ORD_SetTempDeactivated                ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000073)
#define TCM_ORD_SHA1Complete                      ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000A2)
#define TCM_ORD_SHA1CompleteExtend                ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000A3)
#define TCM_ORD_SHA1Start                         ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000A0)
#define TCM_ORD_SHA1Update                        ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000A1)
#define TCM_ORD_Sign                              ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000003C)
#define TCM_ORD_Startup                           ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000099)
#define TCM_ORD_StirRandom                        ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000047)
#define TCM_ORD_TakeOwnership                     ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000000D)
#define TCM_ORD_Terminate_Handle                  ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000096)
#define TCM_ORD_TickStampBlob                     ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x000000F2)
#define TCM_ORD_UnBind                            ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x0000001E)
#define TCM_ORD_Unseal                            ((TCM_COMMAND_CODE)TCM_ORD_BASE + 0x00000018)
...
///
/// Part 2, section 18.1: TCM_CONTEXT_BLOB
///
...
///
/// Part 2, section 18.2 TCM_CONTEXT_SENSITIVE
///
...
//
// Part 2, section 19.1.1: Required TCM_NV_INDEX values
//
...
///
/// Part 2, section 19.2: TCM_NV_ATTRIBUTES
///
...
#define TCM_NV_PER_READ_STCLEAR        (BIT31)
#define TCM_NV_PER_AUTHREAD            (BIT18)
#define TCM_NV_PER_OWNERREAD           (BIT17)
#define TCM_NV_PER_PPREAD              (BIT16)
#define TCM_NV_PER_GLOBALLOCK          (BIT15)
#define TCM_NV_PER_WRITE_STCLEAR       (BIT14)
#define TCM_NV_PER_WRITEDEFINE         (BIT13)
#define TCM_NV_PER_WRITEALL            (BIT12)
#define TCM_NV_PER_AUTHWRITE           (BIT2)
#define TCM_NV_PER_OWNERWRITE          (BIT1)
#define TCM_NV_PER_PPWRITE             (BIT0)

///
/// Part 2, section 19.3: TCM_NV_DATA_PUBLIC
///
...
//
#define TCM_DELEGATE_SetOrdinalAuditStatus          (BIT30)
#define TCM_DELEGATE_DirWriteAuth                   (BIT29)
#define TCM_DELEGATE_CMK_ApproveMA                  (BIT28)
#define TCM_DELEGATE_NV_WriteValue                  (BIT27)
#define TCM_DELEGATE_CMK_CreateTicket               (BIT26)
#define TCM_DELEGATE_NV_ReadValue                   (BIT25)
#define TCM_DELEGATE_Delegate_LoadOwnerDelegation   (BIT24)
#define TCM_DELEGATE_DAA_Join                       (BIT23)
#define TCM_DELEGATE_AuthorizeMigrationKey          (BIT22)
#define TCM_DELEGATE_CreateMaintenanceArchive       (BIT21)
#define TCM_DELEGATE_LoadMaintenanceArchive         (BIT20)
#define TCM_DELEGATE_KillMaintenanceFeature         (BIT19)
#define TCM_DELEGATE_OwnerReadInteralPub            (BIT18)
#define TCM_DELEGATE_ResetLockValue                 (BIT17)
#define TCM_DELEGATE_OwnerClear                     (BIT16)
#define TCM_DELEGATE_DisableOwnerClear              (BIT15)
#define TCM_DELEGATE_NV_DefineSpace                 (BIT14)
#define TCM_DELEGATE_OwnerSetDisable                (BIT13)
#define TCM_DELEGATE_SetCapability                  (BIT12)
#define TCM_DELEGATE_MakeIdentity                   (BIT11)
#define TCM_DELEGATE_ActivateIdentity               (BIT10)
#define TCM_DELEGATE_OwnerReadPubek                 (BIT9)
#define TCM_DELEGATE_DisablePubekRead               (BIT8)
#define TCM_DELEGATE_SetRedirection                 (BIT7)
#define TCM_DELEGATE_FieldUpgrade                   (BIT6)
#define TCM_DELEGATE_Delegate_UpdateVerification    (BIT5)
#define TCM_DELEGATE_CreateCounter                  (BIT4)
#define TCM_DELEGATE_ReleaseCounterOwner            (BIT3)
#define TCM_DELEGATE_DelegateManage                 (BIT2)
#define TCM_DELEGATE_Delegate_CreateOwnerDelegation (BIT1)
#define TCM_DELEGATE_DAA_Sign                       (BIT0)

//
// Part 2, section 20.2.3: Key Permission settings
//
#define TCM_KEY_DELEGATE_CMK_ConvertMigration       (BIT28)
#define TCM_KEY_DELEGATE_TickStampBlob              (BIT27)
#define TCM_KEY_DELEGATE_ChangeAuthAsymStart        (BIT26)
#define TCM_KEY_DELEGATE_ChangeAuthAsymFinish       (BIT25)
#define TCM_KEY_DELEGATE_CMK_CreateKey              (BIT24)
#define TCM_KEY_DELEGATE_MigrateKey                 (BIT23)
#define TCM_KEY_DELEGATE_LoadKey2                   (BIT22)
#define TCM_KEY_DELEGATE_EstablishTransport         (BIT21)
#define TCM_KEY_DELEGATE_ReleaseTransportSigned     (BIT20)
#define TCM_KEY_DELEGATE_Quote2                     (BIT19)
#define TCM_KEY_DELEGATE_Sealx                      (BIT18)
#define TCM_KEY_DELEGATE_MakeIdentity               (BIT17)
#define TCM_KEY_DELEGATE_ActivateIdentity           (BIT16)
#define TCM_KEY_DELEGATE_GetAuditDigestSigned       (BIT15)
#define TCM_KEY_DELEGATE_Sign                       (BIT14)
#define TCM_KEY_DELEGATE_CertifyKey2                (BIT13)
#define TCM_KEY_DELEGATE_CertifyKey                 (BIT12)
#define TCM_KEY_DELEGATE_CreateWrapKey              (BIT11)
#define TCM_KEY_DELEGATE_CMK_CreateBlob             (BIT10)
#define TCM_KEY_DELEGATE_CreateMigrationBlob        (BIT9)
#define TCM_KEY_DELEGATE_ConvertMigrationBlob       (BIT8)
#define TCM_KEY_DELEGATE_CreateKeyDelegation        (BIT7)
#define TCM_KEY_DELEGATE_ChangeAuth                 (BIT6)
#define TCM_KEY_DELEGATE_GetPubKey                  (BIT5)
#define TCM_KEY_DELEGATE_UnBind                     (BIT4)
#define TCM_KEY_DELEGATE_Quote                      (BIT3)
#define TCM_KEY_DELEGATE_Unseal                     (BIT2)
#define TCM_KEY_DELEGATE_Seal                       (BIT1)
#define TCM_KEY_DELEGATE_LoadKey                    (BIT0)

//
// Part 2, section 20.3: TCM_FAMILY_FLAGS
//
#define TCM_DELEGATE_ADMIN_LOCK           (BIT1)
#define TCM_FAMFLAG_ENABLE                (BIT0)

///
/// Part 2, section 20.4: TCM_FAMILY_LABEL
///
...
///
/// Part 2, section 20.5: TCM_FAMILY_TABLE_ENTRY
///
...
//
// Part 2, section 20.6: TCM_FAMILY_TABLE
//
...
///
/// Part 2, section 20.7: TCM_DELEGATE_LABEL
///
...
///
/// Part 2, section 20.8: TCM_DELEGATE_PUBLIC
///
...
///
/// Part 2, section 20.9: TCM_DELEGATE_TABLE_ROW
///
...
//
// Part 2, section 20.10: TCM_DELEGATE_TABLE
//
...
///
/// Part 2, section 20.11: TCM_DELEGATE_SENSITIVE
///
...
///
/// Part 2, section 20.12: TCM_DELEGATE_OWNER_BLOB
///
...
///
/// Part 2, section 20.13: TTCM_DELEGATE_KEY_BLOB
///
...
//
// Part 2, section 20.14: TCM_FAMILY_OPERATION Values
//
...
#define TCM_CAP_PROP_SESSION_DAA        ((TCM_CAPABILITY_AREA) 0x0000011A)
...
//
// Part 2, section 21.4: TCM_CAPABILITY_AREA for SetCapability
//
#define TCM_SET_PERM_FLAGS              ((TCM_CAPABILITY_AREA) 0x00000001)
#define TCM_SET_PERM_DATA               ((TCM_CAPABILITY_AREA) 0x00000002)
#define TCM_SET_STCLEAR_FLAGS           ((TCM_CAPABILITY_AREA) 0x00000003)
#define TCM_SET_STCLEAR_DATA            ((TCM_CAPABILITY_AREA) 0x00000004)
#define TCM_SET_STANY_FLAGS             ((TCM_CAPABILITY_AREA) 0x00000005)
#define TCM_SET_STANY_DATA              ((TCM_CAPABILITY_AREA) 0x00000006)
...
///
/// Part 2, section 21.10: TCM_DA_ACTION_TYPE
///
...
#define TCM_DA_ACTION_FAILURE_MODE     (((UINT32)1)<<3)
#define TCM_DA_ACTION_DEACTIVATE       (((UINT32)1)<<2)
#define TCM_DA_ACTION_DISABLE          (((UINT32)1)<<1)
#define TCM_DA_ACTION_TIMEOUT          (((UINT32)1)<<0)

///
/// Part 2, section 21.7: TCM_DA_INFO
///
typedef struct tdTCM_DA_INFO {
  ...
  TCM_DA_ACTION_TYPE                actionAtThreshold;
...
///
/// Part 2, section 21.8: TCM_DA_INFO_LIMITED
///
...
//
#define TCM_DA_STATE_INACTIVE          ((UINT8)0x00)
#define TCM_DA_STATE_ACTIVE            ((UINT8)0x01)
...
///
/// Part 2, section 22.3: TCM_DAA_ISSUER
///
...
///
/// Part 2, section 22.4: TCM_DAA_TCM
///
...
///
/// Part 2, section 22.5: TCM_DAA_CONTEXT
///
...
///
/// Part 2, section 22.6: TCM_DAA_JOINDATA
///
...
///
/// Part 2, section 22.8: TCM_DAA_BLOB
///
...
///
/// Part 2, section 22.9: TCM_DAA_SENSITIVE
///
...
///
/// Part 2 section 23.1: TCM_REDIR_COMMAND
...
///
/// TCM Command Headers defined in Part 3
///
...
///
/// TCM Response Headers defined in Part 3
///
...
//
///
/// Event Log Entry Structure Definition with SM3-256 digest
///
...
//
/// Event Log Entry Header Definition with SM3-256 digest
//
typedef struct tdTCM_PCR_EVENT_HDR {
  TCM_PCRINDEX                      PCRIndex;
  TCG_EVENTTYPE                     EventType;
  TCM_DIGEST                        Digest;  // SM3-256
  UINT32                            EventSize;
} TCM_PCR_EVENT_HDR;
