...
#define PEI_BOARD_ID_SETUP_FAILED             0x8E        // BoardId maybe not be declared in both [SkuIds] and SKUID_IDENTIFIER of Project.dsc
...
#define DXE_FAULT_TOLERANCE_FCHECK_FAILED     0x63        // Platform does not comply with the BIOS update fault tolerance requirement.
//
// BDS Functionality
//
...
#define BDS_ENTER_FIRMWARE_UI                 0x39        // Enter firmware UI
#define BDS_PLATFORM_RECOVERY                 0x3A        // Perform Platform-Defined boot option recovery
#define BDS_OS_RECOVERY                       0x3B        // Perform OS-Defined boot option recovery
#define BDS_SYSPREP                           0x3C        // Perform system preparation applications
...
// Platform Security
//
#define POST_COMPILER_ERROR                          0xEC        // Stack Frame Checks
#define POST_CPU_GENERAL_PROTECTION_FAULT_EXCEPTION  0xED        // General Protection Fault
#define POST_CPU_PAGE_FAULT_EXCEPTION                0xEE        // Page Fault
