...
#define EFI_FLASH_AREA_CPU_MICROCODE  0x10  // CPU Microcode
#define EFI_FLASH_AREA_FV_EC          0x11  // FVEC
#define EFI_FLASH_AREA_GPNV           0x12  // GPNV
#define EFI_FLASH_AREA_NV_COMMON_STORE 0x13  // NV_COMMON_STORE
