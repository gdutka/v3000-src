...
#define MWIF_BGRX8888	 0x00050000L		/* 32bpp BGRX image order no alpha (new)*/
...
typedef BOOLEAN 		MWBOOL;		/* boolean value*/
...
// We use MWIF_ARGB8888 (0xAARRGGBB format)
/* create MWCOLORVAL (0xAARRGGBB format)*/
#define MWARGB(a,r,g,b)	((MWCOLORVAL)(((unsigned char)(b)|\
...
/* Mouse button bits*/
#define MWBUTTON_WHEEL   0x08
#define MWBUTTON_L	0x04
#define MWBUTTON_M	0x02
#define MWBUTTON_R	0x01
