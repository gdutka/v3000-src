...
#define MAX_XHCI_CONTROLLER     8
#define EVENT_RING_SIZE         8
#define BULK_RING_SIZE          8
#define FLAGS_FORCE_STOP        0x00000001
//
// The definition of XHCI Token
//
#define B_TOKEN_XHCI_PCI_BUS    0xff000000
#define N_TOKEN_XHCI_PCI_BUS    24
#define B_TOKEN_XHCI_PCI_DEV    0x00f80000
#define N_TOKEN_XHCI_PCI_DEV    19
#define B_TOKEN_XHCI_PCI_FUN    0x00070000
#define N_TOKEN_XHCI_PCI_FUN    16
...
typedef struct {
  ...
  UINT32                        Rsvd2[8];
  XHCI_NORMAL_TRB               BulkOutTRB[BULK_RING_SIZE - 1];
  XHCI_LINK_TRB                 BulkOutLinkTRB;
  XHCI_NORMAL_TRB               BulkInTRB[BULK_RING_SIZE - 1];
  XHCI_LINK_TRB                 BulkInLinkTRB;
  UINT32                        BulkOutIndex;
  UINT32                        BulkOutCycleBit;
  UINT32                        BulkInIndex;
  UINT32                        BulkInCycleBit;
