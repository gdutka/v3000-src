...
/**
  ...
  Hotkey can be used to cancel the memory test process. 
  The hotkey value is define at PcdH2OBdsCancelMemoryTestHotKey.
...
/**
  ...
  @param  DriverOptionList        The header of the driver option link list. Deprecated
  @param  BootOptionList          The header of the boot option link list. Deprecated
