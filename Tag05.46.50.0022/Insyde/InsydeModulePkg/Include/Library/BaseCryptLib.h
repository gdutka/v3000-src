...
#define  EC_P192_TYPE                       0x01
#define  EC_P224_TYPE                       0x02
#define  EC_P256_TYPE                       0x03
#define  EC_P384_TYPE                       0x04
#define  EC_P521_TYPE                       0x05
...
/**
  ...
  It can be called multiple times to compute the digest of long or discontinuous data streams.
  SM3 context should be already correctly intialized by Sm3Init(), and should not be finalized
...
/**
  ...
  be used again.
  SM3 context should be already correctly intialized by Sm3Init(), and should not be
  finalized by Sm3Final(). Behavior with invalid SM3 context is undefined.

  If Sm3Context is NULL, then return FALSE.
  If HashValue is NULL, then return FALSE.

  @param[in, out]  Sha256Context  Pointer to the SM3 context.
...
/**
  ...
  If HashSize is not equal to the size of MD5, SHA-1, SHA-256, SHA-224, SHA-512 or SHA-384 digest,then return FALSE.
...
/**
  Retrieve the X509 CA certificate from the PEM file.
  This function will parse the data from the first CA CERTIFICATE section and translate it to DER data.

  @param[in]  PemData      Pointer to the PEM-encoded key data to be retrieved.
  @param[in]  PemSize      Size of the PEM key data in bytes.
  @param[out] DerData      Pointer to CA certificate of the DER file content.
  @param[out] DerDataSize  Size of the DER data in bytes.

  If PemData is NULL, then return FALSE.
  If DerData is NULL, then return FALSE.

  @retval  TRUE   DER CA certificate data was retrieved successfully.
  @retval  FALSE  Invalid PEM CA certificate data.

**/
BOOLEAN
EFIAPI
X509GetCaCertificateFromPemToDer (
  IN   CONST UINT8        *PemData,
  IN   UINTN              PemSize,
  OUT  UINT8              **DerData,
...
/**
  Get Issuer content and translate to string from one X.509 certificate.
  e.g.
    /C=SL/ST=Western/L=Colombo/OU=Insyde/CN=Insyde.com
