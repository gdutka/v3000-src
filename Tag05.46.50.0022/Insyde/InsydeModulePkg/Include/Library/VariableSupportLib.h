...
///
/// Globally "dbtDefault" variable for the OEM's default authenticated timestamp signature store.
///
#define EFI_DBT_DEFAULT_VARIABLE_NAME            L"dbtDefault"
///
/// Globally "dbrDefault" variable for the OEM's default public authenticated recovery signature database.
///
