...
//
#define SECURITY_LOCK                0x01 // For HddPassword
#define NO_ACCESS_PASSWORD           0x10 // For HddPassword / SysPassword
#define CHANGE_PASSWORD              0x20 // For HddPassword / SysPassword
#define DISABLE_PASSWORD             0x30 // For HddPassword / SysPassword
#define ENABLE_PASSWORD              0x40 // For HddPassword
#define MASTER_PASSWORD_GRAYOUT      0x50 // For HddPassword
...
typedef struct {
  ...
  EFI_STRING_ID                         LastToken;               ///< For compatiblity. It is not used when using H2O form browser
  EFI_STRING_ID                         BootTypeTokenRecord;     ///< For compatiblity. It is not used when using H2O form browser
  EFI_STRING_ID                         LegacyAdvanceTokenRecord;///< For compatiblity. It is not used when using H2O form browser
  EFI_STRING_ID                         EfiTokenRecord;          ///< For compatiblity. It is not used when using H2O form browser
  EFI_STRING_ID                         AdvanceTokenRecord;      ///< For compatiblity. It is not used when using H2O form browser
  EFI_STRING_ID                         LegacyNormalTokenRecord[MAX_BOOT_ORDER_NUMBER];///< For compatiblity. It is not used when using H2O form browser
...
/**
 Load the default value of all varstores belongs to setup utility library.

 @retval EFI_SUCCESS             Load the default value successfully
 @retval Other                   Load the default value failed.
**/
EFI_STATUS
