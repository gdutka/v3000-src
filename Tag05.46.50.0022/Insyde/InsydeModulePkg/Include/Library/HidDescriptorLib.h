...
#define HID_FIDO_U2FHID                         0x01
#define HID_FIDO_U2FHID_DATA_IN                 0x20
#define HID_FIDO_U2FHID_DATA_OUT                0x21

#define KEYBOARD_CLASS_CODE                     ((HID_UP_GENDESK << 8) | HID_GD_KEYBOARD)
#define KEYPAD_CLASS_CODE                       ((HID_UP_GENDESK << 8) | HID_GD_KEYPAD)
...
#define CONSUMER_CLASS_CODE                     ((HID_UP_CONSUMER << 8) | HID_CONSUMER_CONTROL)
#define FIDO_U2FHID_CLASS_CODE                  ((HID_UP_FIDO << 8) | HID_FIDO_U2FHID)
...
typedef struct {
  UINT16                        Usage[MAXIMUM_USAGES];  /* usage array */
  UINT16                        UsageIndex;
  UINT16                        UsageMin;
  UINT16                        UsageMax;
} HID_LOCAL;
