...
#define SETUP_MOUSE_KEYBOARD_CONSOLE_IN_EX_NOTIFY_SIGNATURE     SIGNATURE_32 ('S', 'C', 'E', 'N')
#define SETUP_MOUSE_KEYBOARD_CONSOLE_IN_EX_NOTIFY_FROM_THIS(a)  CR (a, SETUP_MOUSE_KEYBOARD_CONSOLE_IN_EX_NOTIFY, Link, SETUP_MOUSE_KEYBOARD_CONSOLE_IN_EX_NOTIFY_SIGNATURE);

typedef struct {
  UINTN                                 Signature;
  LIST_ENTRY                            Link;
  EFI_KEY_DATA                          KeyData;
  EFI_KEY_NOTIFY_FUNCTION               KeyNotifyFn;
} SETUP_MOUSE_KEYBOARD_CONSOLE_IN_EX_NOTIFY;
...
typedef struct {
  ...
  EFI_EVENT                     EdidActiveHotplugEvent;
