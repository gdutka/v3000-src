...
#define FORM_MAIN_ID_BOOT                    0x1023
#define FORM_MAIN_ID_DRIVER                  0x1024
#define FORM_MAIN_ID_DRV_ADD                 0x1025
#define FORM_MAIN_ID_CON_MAIN                0x1026
...
// For Boot Formset
//
#define KEY_DESCRIPTION_DATA_BOOT              0x107A
#define KEY_DESCRIPTION_DATA_DRIVER            0x107B
#define KEY_OPTIONAL_DATA_BOOT                 0x107C
#define KEY_OPTIONAL_DATA_DRIVER               0x107D
#define KEY_FORCE_RECONNECT                    0x107E
...
///
typedef struct {
  UINT16  DescriptionData[DESCRIPTION_DATA_SIZE];
  UINT16  OptionalData[OPTIONAL_DATA_SIZE];
  UINT8   Active;
