...
STRING_DEPOSITORY   *FileOptionStrDepository = NULL;
STRING_DEPOSITORY   *ConsoleOptionStrDepository = NULL;
STRING_DEPOSITORY   *BootOptionStrDepository = NULL;
STRING_DEPOSITORY   *BootOptionHelpStrDepository = NULL;
STRING_DEPOSITORY   *DriverOptionStrDepository = NULL;
STRING_DEPOSITORY   *DriverOptionHelpStrDepository = NULL;
STRING_DEPOSITORY   *TerminalStrDepository = NULL;
