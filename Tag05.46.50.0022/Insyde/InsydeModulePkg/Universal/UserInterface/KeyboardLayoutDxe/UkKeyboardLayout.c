/** @file
 UK Keyboard layout data.

;******************************************************************************
;* Copyright (c) 2018 - 2022, Insyde Software Corp. All Rights Reserved.
;*
...
GLOBAL_REMOVE_IF_UNREFERENCED H2O_KEYBOARD_LAYOUT_UK_PACK_BIN   mH2OKeyboardLayoutUkBin = {
  sizeof (H2O_KEYBOARD_LAYOUT_UK_PACK_BIN),   // Binary size

  //
  // EFI_HII_PACKAGE_HEADER
  //
  {
    sizeof (H2O_KEYBOARD_LAYOUT_UK_PACK_BIN) - sizeof (UINT32),
  ...
  //
  sizeof (H2O_KEYBOARD_LAYOUT_UK_PACK_BIN) - sizeof (UINT32) - sizeof (EFI_HII_PACKAGE_HEADER) - sizeof (UINT16), // LayoutLength
  H2O_USB_KEYBOARD_UK_LAYOUT_KEY_GUID,  // KeyGuid
  sizeof (UINT16) + sizeof (EFI_GUID) + sizeof (UINT32) + sizeof (UINT8) + (H2O_KEYBOARD_LAYOUT_UK_KEY_COUNT * sizeof (EFI_KEY_DESCRIPTOR)), // LayoutDescriptorStringOffset
  H2O_KEYBOARD_LAYOUT_UK_KEY_COUNT, // DescriptorCount
  {
    //
    // EFI_KEY_DESCRIPTOR (total number is H2O_KEYBOARD_LAYOUT_UK_KEY_COUNT)
    //
  ...
  1,                          // DescriptionCount
  {'e', 'n', '-', 'G', 'B'},  // RFC4646 language code
  ' ',                        // Space
  {H2O_KEYBOARD_LAYOUT_UK_DESCRIPTION_STR}, // DescriptionString[]
};
