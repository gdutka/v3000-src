...
GLOBAL_REMOVE_IF_UNREFERENCED H2O_KEYBOARD_LAYOUT_JAPANESE_PACK_BIN   mH2OKeyboardLayoutJapaneseBin = {
  sizeof (H2O_KEYBOARD_LAYOUT_JAPANESE_PACK_BIN),   // Binary size

  //
  // EFI_HII_PACKAGE_HEADER
  //
  {
    sizeof (H2O_KEYBOARD_LAYOUT_JAPANESE_PACK_BIN) - sizeof (UINT32),
  ...
  //
  sizeof (H2O_KEYBOARD_LAYOUT_JAPANESE_PACK_BIN) - sizeof (UINT32) - sizeof (EFI_HII_PACKAGE_HEADER) - sizeof (UINT16), // LayoutLength
  H2O_USB_KEYBOARD_JAPANESE_LAYOUT_KEY_GUID,  // KeyGuid
  sizeof (UINT16) + sizeof (EFI_GUID) + sizeof (UINT32) + sizeof (UINT8) + (H2O_KEYBOARD_LAYOUT_JAPANESE_KEY_COUNT * sizeof (EFI_KEY_DESCRIPTOR)), // LayoutDescriptorStringOffset
  H2O_KEYBOARD_LAYOUT_JAPANESE_KEY_COUNT, // DescriptorCount
  {
    //
    // EFI_KEY_DESCRIPTOR (total number is H2O_KEYBOARD_LAYOUT_JAPANESE_KEY_COUNT)
    //
    ...
    {EfiKeyE10,        '0',      0x00, 0, 0,  EFI_NULL_MODIFIER,   EFI_AFFECTED_BY_STANDARD_SHIFT},
    ...
    {EfiKeyE11,        '-',      '=',  0, 0,  EFI_NULL_MODIFIER,   EFI_AFFECTED_BY_STANDARD_SHIFT},
    ...
    {EfiKeyD13,        0x00,     0x00, 0, 0,  EFI_NULL_MODIFIER},
    ...
    {EfiKeyE0,         0x00,     0x00, 0, 0,  EFI_NULL_MODIFIER},
    ...
    {EfiKeyIntl1,      '\\',     '_',  0, 0,  EFI_NULL_MODIFIER,   EFI_AFFECTED_BY_STANDARD_SHIFT},
    {EfiKeyIntl3,      0xa5,     '|',  0, 0,  EFI_NULL_MODIFIER,   EFI_AFFECTED_BY_STANDARD_SHIFT},
  },
  1,                          // DescriptionCount
  {'j', 'a', '-', 'J', 'P'},  // RFC4646 language code
  ' ',                        // Space
  {H2O_KEYBOARD_LAYOUT_JAPANESE_DESCRIPTION_STR}, // DescriptionString[]
};
