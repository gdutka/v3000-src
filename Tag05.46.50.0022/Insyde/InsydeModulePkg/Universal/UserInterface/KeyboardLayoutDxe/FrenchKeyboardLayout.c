...
GLOBAL_REMOVE_IF_UNREFERENCED H2O_KEYBOARD_LAYOUT_FRENCH_PACK_BIN  mH2OKeyboardLayoutFrenchBin = {
  ...
  H2O_KEYBOARD_LAYOUT_FRENCH_KEY_COUNT, // DescriptorCount
  {
    ...
    // Non-spacing keys
    //
    {EfiKeyD11,        0,        0,    0,        0,  EFI_NS_KEY_MODIFIER,            0},
    {EfiKeyD1,         0xE2,     0xC2, 0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},
    ...
    {EfiKeyD11,        '^',      0xA8, 0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},

    {EfiKeyD11,        0,        1,    0,        0,  EFI_NS_KEY_MODIFIER           , EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},
    {EfiKeyD1,         0xE4,     0xC4, 0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},
    {EfiKeyD3,         0xEB,     0xCB, 0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},
    {EfiKeyD8,         0xEF,     0xCF, 0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},
    {EfiKeyD9,         0xF6,     0xD6, 0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},
    {EfiKeyD7,         0xFC,     0xDC, 0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},
    {EfiKeyD6,         0xFF,     'Y',  0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},
    {EfiKeyD11,        '^',      0xA8, 0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},

    {EfiKeyE2,         0,        0,    1,        0,  EFI_NS_KEY_MODIFIER           , EFI_AFFECTED_BY_STANDARD_SHIFT},
    {EfiKeyD1,         0xE3,     0xC3, 0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},
    {EfiKeyB6,         0xF1,     0xD1, 0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},
    {EfiKeyD9,         0xF5,     0xD5, 0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},
    {EfiKeyE2,         0xE9,     '2',  '~',      0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT},

    {EfiKeyE7,         0,        0,    1,        0,  EFI_NS_KEY_MODIFIER           , EFI_AFFECTED_BY_STANDARD_SHIFT},
    {EfiKeyD1,         0xE0,     0xC0, 0,        0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT | EFI_AFFECTED_BY_CAPS_LOCK},
    ...
    {EfiKeyE7,         0xE8,     '7',  '`',      0,  EFI_NS_KEY_DEPENDENCY_MODIFIER, EFI_AFFECTED_BY_STANDARD_SHIFT},
  },
  1,                          // DescriptionCount
