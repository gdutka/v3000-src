...
#define PEI_CD_EXPRESS_VOLUME_ID_SIZE           32
//
// Recovery file name (in root directory)
//
#define PEI_RECOVERY_FILE_NAME  PcdGetPtr (PcdPeiRecoveryFile)
...
#define PEI_CD_EXPRESS_VOLUME_ID_OFFSET         40
...
#define PEI_CD_EXPRESS_VOLUME_TYPE_SECONDARY    2
