...
)
{
  ...
  if (SetupVariable.IoApicMode == 0) {
    ...
    case 0x07:
     ((EFI_ACPI_6_3_MULTIPLE_APIC_DESCRIPTION_TABLE_HEADER *)(Table))->Header.Revision = EFI_ACPI_6_3_MULTIPLE_APIC_DESCRIPTION_TABLE_REVISION;
      break;
    case 0x06:
    case 0x05:
