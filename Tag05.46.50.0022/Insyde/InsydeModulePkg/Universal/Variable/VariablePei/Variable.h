...
typedef struct {
  ...
  UINT32          Index[VARIABLE_INDEX_TABLE_VOLUME];
} VARIABLE_INDEX_TABLE_EX;

#define VARIABLE_HEADER_ALIGNMENT  1
#define VARIABLE_HEADER_ALIGN(Header)  (((UINTN) (Header) + VARIABLE_HEADER_ALIGNMENT - 1) & (~(VARIABLE_HEADER_ALIGNMENT - 1)))
//
// Functions
//
/**
