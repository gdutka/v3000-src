...
/**
  Get TPM capability version info TPM_CAP_VERSION_VAL.

  @param[in]  TpmHandle    TPM handle.
  @param[out] Buffer       Pointer to the buffer for version info structure.
