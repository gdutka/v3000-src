  ...
  )
{
  ...
  mBeepTypeList = NULL;
  DEBUG_OEM_SVC ((DEBUG_INFO, "OemKernelServices Call: OemSvcSmmUpdateStatusCodeBeep \n"));
  Status = OemSvcSmmUpdateStatusCodeBeep (&mStatusCodeBeepList, &mBeepTypeList);
  DEBUG_OEM_SVC ((DEBUG_INFO, "OemKernelServices OemSvcSmmUpdateStatusCodeBeep Status: %r\n", Status));
