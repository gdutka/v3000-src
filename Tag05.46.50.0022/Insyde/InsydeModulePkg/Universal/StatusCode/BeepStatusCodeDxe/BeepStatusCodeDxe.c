  ...
  )
{
  ...
  mBeepTypeList = NULL;
  DEBUG_OEM_SVC ((DEBUG_INFO, "OemKernelServices Call: OemSvcDxeUpdateStatusCodeBeep \n"));
  Status = OemSvcDxeUpdateStatusCodeBeep (&mStatusCodeBeepList, &mBeepTypeList);
  DEBUG_OEM_SVC ((DEBUG_INFO, "OemKernelServices OemSvcDxeUpdateStatusCodeBeep Status: %r\n", Status));
