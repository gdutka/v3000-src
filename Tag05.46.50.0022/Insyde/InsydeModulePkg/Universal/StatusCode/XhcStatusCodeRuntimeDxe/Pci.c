  ...
  if (Write)
  {
    switch (Width)
    {
      ...
      case EfiWidthUint32:
        ...
        break;
      case EfiWidthUint64:
        IoWrite32((UINT16)PciData, *(UINT32*)((UINTN)Buffer + 0));
        IoWrite32(0xcf8, Address + 4);
        IoWrite32((UINT16)PciData, *(UINT32*)((UINTN)Buffer + 4));
        break;
    }
  }
  else
    ...
    switch (Width)
    {
      ...
      case EfiWidthUint32:
        *(UINT32*)Buffer = IoRead32((UINT16)PciData);
        break;
      case EfiWidthUint64:
        *(UINT32*)((UINTN)Buffer + 0) = IoRead32((UINT16)PciData);
        IoWrite32(0xcf8, Address + 4);
        *(UINT32*)((UINTN)Buffer + 4) = IoRead32((UINT16)PciData);
        break;
    }
  }
