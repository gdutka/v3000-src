  ...
  )
{
  ...
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.SetSku);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Get8);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Get16);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Get32);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Get64);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.GetPtr);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.GetBool);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.GetSize);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Get8Ex);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Get16Ex);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Get32Ex);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Get64Ex);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.GetPtrEx);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.GetBoolEx);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.GetSizeEx);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Set8);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Set16);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Set32);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Set64);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.SetPtr);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.SetBool);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Set8Ex);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Set16Ex);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Set32Ex);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.Set64Ex);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.SetPtrEx);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.SetBoolEx);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.CallbackOnSet);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.CancelCallback);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.GetNextToken);
  gRT->ConvertPointer (0, (VOID **)&mPcdInstance.GetNextTokenSpace);

  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.SetSku);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.Get8);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.Get16);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.Get32);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.Get64);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.GetPtr);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.GetBool);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.GetSize);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.Set8);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.Set16);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.Set32);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.Set64);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.SetPtr);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.SetBool);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.CallbackOnSet);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.CancelCallback);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.GetNextToken);
  gRT->ConvertPointer (0, (VOID **)&mEfiPcdInstance.GetNextTokenSpace);

  gRT->ConvertPointer (0, (VOID **)&mGetPcdInfoInstance.GetInfo);
  gRT->ConvertPointer (0, (VOID **)&mGetPcdInfoInstance.GetInfoEx);
  gRT->ConvertPointer (0, (VOID **)&mGetPcdInfoInstance.GetSku);

  gRT->ConvertPointer (0, (VOID **)&mEfiGetPcdInfoInstance.GetInfo);
  gRT->ConvertPointer (0, (VOID **)&mEfiGetPcdInfoInstance.GetSku);

  gRT->ConvertPointer (0, (VOID **)&mPcdDatabase.PeiDb);
  gRT->ConvertPointer (0, (VOID **)&mPcdDatabase.DxeDb);

  for (Index = 0; Index < TmpTokenSpaceBufferCount; Index++) {
    if (TmpTokenSpaceBuffer[Index] != NULL) {
      gRT->ConvertPointer (0, (VOID **)&TmpTokenSpaceBuffer[Index]);
    }
  }
  gRT->ConvertPointer (0, (VOID **)&TmpTokenSpaceBuffer);
  gRT->ConvertPointer (0, (VOID **)&mDistinctTokenSpace);
}

/**
  Initialize PCD services in SMM.
**/
VOID
InitSmmPcdServices (
  VOID
...
/**
  The notification of gEfiSmmReadyToLockProtocolGuid protocol
...
{
  return InitializePcdAcpiSupport ();
  ...
  )
{
  ...
  if (!InSmm()) {
    ...
    //
    // Now in Runtime DXE module entry
    //
    BuildPcdDxeDataBase ();

    if (mPcdDatabase.PeiDb == NULL || mPcdDatabase.DxeDb == NULL) {
      return EFI_ABORTED;
    }
    //
  ...
  )
{
  ...
  PcdValue = (UINT8 *) GetWorker (TokenNumber, sizeof (UINT8));
  return PcdValue == NULL ? 0 : *PcdValue;
}
...
{
  BOOLEAN      *PcdValue;
  PcdValue = (BOOLEAN *) GetWorker (TokenNumber, sizeof (BOOLEAN));
  return PcdValue == NULL ? FALSE : *PcdValue;
}
  ...
  )
{
  ...
  if (IsPeiDb) {
    TokenNumber -= mDxeLocalTokenCount;
  }
...
{
  UINT8     *PcdValue;
  PcdValue = (UINT8 *) ExGetWorker (Guid, ExTokenNumber, sizeof(UINT8));
  return PcdValue == NULL ? 0 : *PcdValue;
}
  ...
  )
{
  ...
  PcdValue = (BOOLEAN *) ExGetWorker (Guid, ExTokenNumber, sizeof(BOOLEAN));
  return PcdValue == NULL ? FALSE : *PcdValue;
}
...
{
  EFI_STATUS          PeiDbStatus;
  EFI_STATUS          DxeDbStatus;
  BOOLEAN             PeiExMapTableEmpty;
  BOOLEAN             DxeExMapTableEmpty;
  BOOLEAN             IsPeiDbTokenNumber;
  UINTN               PeiTokenNumber;
  UINTN               DxeTokenNumber;

  PeiDbStatus = EFI_NOT_FOUND;
  DxeDbStatus = EFI_NOT_FOUND;
  PeiExMapTableEmpty = mPeiExMapTableEmpty;
  DxeExMapTableEmpty = mDxeExMapTableEmpty;
  DxeTokenNumber = *TokenNumber;
  ...
  if (!PeiExMapTableEmpty) {
    ...
    PeiTokenNumber = *TokenNumber;
    IsPeiDbTokenNumber = TRUE;

    if (PeiTokenNumber != 0) {
      IsPeiDbTokenNumber = IsTokenNumberExistInDb (
                             Guid,
                             PeiTokenNumber,
    ...
    if (IsPeiDbTokenNumber) {
      PeiDbStatus = ExGetNextTokeNumber (
                        Guid,
                        &PeiTokenNumber,
                        (EFI_GUID *)((UINT8 *)mPcdDatabase.PeiDb + mPcdDatabase.PeiDb->GuidTableOffset),
                        mPeiGuidTableSize,
      ...
      if (!EFI_ERROR (PeiDbStatus)){
        *TokenNumber = PeiTokenNumber;
        return EFI_SUCCESS;
      }
    }
  }
  ...
  //
  // If Dxe find Pcd is exist in PeiDb, then serch next until not found or not PeiPcd.
  //
  DxeTokenNumber = *TokenNumber;

  do {
      DxeDbStatus = ExGetNextTokeNumber (
                        Guid,
                        &DxeTokenNumber,
      ...
      //
      // return TokenNumber has not in PEI DB.
      //
      PeiTokenNumber = DxeTokenNumber;
      IsPeiDbTokenNumber = IsTokenNumberExistInDb (
                             Guid,
                             PeiTokenNumber,
                             (EFI_GUID *)((UINT8 *)mPcdDatabase.PeiDb + mPcdDatabase.PeiDb->GuidTableOffset),
  ...
  )
{
  ...
  ZeroMem (mDistinctTokenSpace, (mPcdDatabase.PeiDb->ExTokenCount + mPcdDatabase.DxeDb->ExTokenCount) * sizeof (EFI_GUID *));
  TsIdx = 0;
  OldGuidIndex = ExMapTable[0].ExGuidIndex;
  mDistinctTokenSpace[TsIdx] = &GuidTable[OldGuidIndex];
  for (Idx = 1; Idx < *ExMapTableSize; Idx++) {
    Match = FALSE;
    OldGuidIndex = ExMapTable[Idx].ExGuidIndex;
    for (TempTsIdx = 0; TempTsIdx <= TsIdx; TempTsIdx++) {
      if (&GuidTable[OldGuidIndex] == mDistinctTokenSpace[TempTsIdx]) {
        //
  ...
  // to the mDistinctTokenSpace[]
  //
  *ExMapTableSize = TsIdx + 1;
  return mDistinctTokenSpace;
