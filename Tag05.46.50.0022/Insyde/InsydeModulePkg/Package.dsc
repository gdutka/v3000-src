...
!endif
  ...
  gInsydeTokenSpaceGuid.PcdH2OPciOptionRomSecurityControlBySlot|FALSE

  #
  # Enable/disable MultiBoard PCI Option ROM Feature.
  #
  gInsydeTokenSpaceGuid.PcdH2OMultiBoardPciOptionRomSupported|FALSE
  gInsydeTokenSpaceGuid.PcdH2OMultiBoardSupported|FALSE
  #
  # Enable/disable Multiboard VerbTableCfg
  #
  gInsydeTokenSpaceGuid.PcdH2OMultiBoardVerbTableCfgSupported|FALSE

  gInsydeTokenSpaceGuid.PcdH2OBdsOemBadgingSupported|FALSE
  gInsydeTokenSpaceGuid.PcdH2OWarningLogoSupported|TRUE

  #
  # Enable/disable Unittest Drivers.
  #
  gInsydeTokenSpaceGuid.PcdH2OUnitTestBuild|FALSE
  gEfiMdeModulePkgTokenSpaceGuid.PcdPs2MouseExtendedVerification|TRUE
...
!endif
  ...
  H2OSerialConfigLib|InsydeModulePkg/Library/H2OSerialConfigLibNull/H2OSerialConfigLibNull.inf
...
!if gInsydeTokenSpaceGuid.PcdSecureFlashSupported
  FirmwareAuthenticationLib|InsydeModulePkg/Library/FirmwareAuthenticationLib/FirmwareAuthenticationLib.inf
!else
...
!endif
  ...
  UefiDecompressLib|MdePkg/Library/BaseUefiDecompressLib/BaseUefiDecompressLib.inf {
    <SOURCE_OVERRIDE_PATH>
      MdePkg/Override/Library/BaseUefiDecompressLib
  }
  ...
  H2OSecurityEventLib|InsydeModulePkg/Library/H2OSecurityEventLib/DxeH2OSecurityEventLib/DxeH2OSecurityEventLib.inf
  FmpAuthenticationLib|InsydeModulePkg/Library/FmpAuthenticationLibPkcs7/FmpAuthenticationLibPkcs7.inf
...
[LibraryClasses.common.SEC]
  ...
  H2OSecurityEventLib|InsydeModulePkg/Library/H2OSecurityEventLib/PeiH2OSecurityEventLib/PeiH2OSecurityEventLib.inf
...
!if gInsydeTokenSpaceGuid.PcdH2OTpm2Supported
  ...
  TpmPlatformHierarchyLib|InsydeModulePkg/Library/PeiTpmPlatformHierarchyLib/PeiTpmPlatformHierarchyLib.inf
!endif
...
[PcdsFeatureFlag]
  ...
  gEfiMdeModulePkgTokenSpaceGuid.PcdDisableDefaultKeyboardLayoutInUsbKbDriver|TRUE
...
!if gInsydeTokenSpaceGuid.PcdFrontPageSupported
  gInsydeTokenSpaceGuid.PcdH2OBdsBootFailApp|{"VenHw(E0BA9B98-DD2D-4434-BB94-599CC9E4305D)"}
  gInsydeTokenSpaceGuid.PcdH2OBdsBootSuccessApp|{"VenHw(E0BA9B98-DD2D-4434-BB94-599CC9E4305D)"}
!else
  gInsydeTokenSpaceGuid.PcdH2OBdsBootFailApp|{"VenHw(77E79A1E-E1FB-491F-A7C1-FA1B5412532A)"}
  gInsydeTokenSpaceGuid.PcdH2OBdsBootSuccessApp|{"VenHw(77E79A1E-E1FB-491F-A7C1-FA1B5412532A)"}
!endif
...
gInsydeTokenSpaceGuid.PcdIhisiRegisterTable|{ \
  ...
  gEfiMdeModulePkgTokenSpaceGuid.PcdAcpiExposedTableVersions|0x7E
...
[PcdsDynamicExDefault]
  ...
  gInsydeTokenSpaceGuid.PcdH2OPciOptionRomPreferPlugIn|FALSE

  gInsydeTokenSpaceGuid.PcdSetupDataInvalid|FALSE
  #
  # PcdH2OBoardIds : To control BoardIds support, build.exe will fill supported BoardIds at build time.
  # PcdH2OBoardId  : It will be filled in function entry of PlatformBoardIdPei to indicate current BoardId.
  #
  ...
  gEfiSecurityPkgTokenSpaceGuid.PcdTpm2PossibleIrqNumBuf|{0x0B, 0x00, 0x00, 0x00}
  gEfiSecurityPkgTokenSpaceGuid.PcdTpm2AcpiTableRev|0x04
  ...
  #
!if gInsydeTokenSpaceGuid.PcdFrontPageSupported
!if gInsydeTokenSpaceGuid.PcdDynamicHotKeySupported == FALSE
...
!endif
  ...
  # Entry format: Device   Fuction (assume the bus number is 0)
  #
  gInsydeTokenSpaceGuid.PcdH2OInternalDmaDisableTable|{ \
    UINT8(0xff), UINT8(0xff)     \  #List end
    }

  gSmbiosTokenSpaceGuid.PcdActiveSmbiosType043|TRUE
  gSmbiosTokenSpaceGuid.PcdType043Record | { \
      0x2B,                       \ # Type
      0x1F,                       \ # Length
      UINT16(0x0000),             \ # Handle
      UINT32(0x00000000),         \ # Vendor ID
      0x00,                       \ # Major Spec Version
      0x00,                       \ # Minor Spec Version
      UINT32(0x00000000),         \ # Firmware Version 1
      UINT32(0x00000000),         \ # Firmware Version 2
      0x01,                       \ # Description
      UINT64(0x0000000000000000), \ # Characteristics
      UINT32(0x00000000)          \ # OEM-defined
  }
  gSmbiosTokenSpaceGuid.PcdType043Strings|"TPM Device;"

  gEfiMdeModulePkgTokenSpaceGuid.PcdAcpiDefaultOemId|"INSYDE"

  gLinkBootTokenSpaceGuid.PcdH2ORamDiskFormsetGuid|{GUID("E817DECB-5BD5-45a1-9520-83D3191F96FC")}

  gInsydeTokenSpaceGuid.PcdPeiRecoveryFile|L"Firmware.bin"
...
InsydeModulePkg/Universal/Security/H2OCryptoServciesPreMemPei/H2OCryptoServicesPreMemPei.inf
InsydeModulePkg/Universal/Security/H2OCryptoServciesPostMemPei/H2OCryptoServicesPostMemPei.inf
#
# Helper tool modules
#
...
!endif
!if gInsydeTokenSpaceGuid.PcdStatusCodeUseStorage
  InsydeModulePkg/Universal/StatusCode/StorageStatusCodePei/StorageStatusCodePei.inf
!endif
  InsydeModulePkg/Universal/CommonPolicy/PlatformBoardIdPei/PlatformBoardIdPei.inf
...
!if gInsydeTokenSpaceGuid.PcdH2OUfsSupported
  InsydeModulePkg/Bus/Pci/UfsPciHcPei/UfsPciHcPei.inf
  InsydeModulePkg/Bus/Ufs/UfsBlockIoPei/UfsBlockIoPei.inf
!endif
...
[Components.$(DXE_ARCH)]
  InsydeModulePkg/Universal/DxeSmmIoLibSmm/DxeSmmIoLibSmm.inf
...
!endif
!if gInsydeTokenSpaceGuid.PcdStatusCodeUseStorage
  InsydeModulePkg/Universal/StatusCode/StorageStatusCodeDxe/StorageStatusCodeDxe.inf
  InsydeModulePkg/Universal/StatusCode/StorageStatusCodeSmm/StorageStatusCodeSmm.inf
!endif
!if gInsydeTokenSpaceGuid.PcdH2OSmartErrorReportStatusSupported
  InsydeModulePkg/Universal/StatusCode/SmartStatusCodeDxe/SmartStatusCodeDxe.inf
!endif
...
!endif
  ...
  InsydeModulePkg/Csm/8259InterruptControllerDxe/8259.inf
...
!if gInsydeTokenSpaceGuid.PcdH2OUfsSupported
  ...
  InsydeModulePkg/Bus/Ufs/UfsPassThruDxe/UfsPassThruDxe.inf
!endif
...
!endif
  ...
  InsydeModulePkg/Universal/UserInterface/KeyboardLayoutDxe/KeyboardLayoutDxe.inf
...
!endif
  ...
  InsydeModulePkg/Universal/Security/EsataBootControlDxe/EsataBootControlDxe.inf
...
!elseif gInsydeTokenSpaceGuid.PcdUefiCapsuleUpdateSupported
  MdeModulePkg/Universal/CapsuleRuntimeDxe/CapsuleRuntimeDxe.inf
  MdeModulePkg/Universal/EsrtFmpDxe/EsrtFmpDxe.inf
!else
  InsydeModulePkg/Universal/CapsuleUpdate/CapsuleRuntimeDxeNull/CapsuleRuntimeDxeNull.inf
!endif
...
!endif
  ...
  InsydeModulePkg/Universal/ResetSystemRuntimeDxe/ResetSystemRuntimeDxe.inf
...
!endif
  ...
  InsydeModulePkg/Bus/Isa/IsaBusDxe/IsaBusDxe.inf
  InsydeModulePkg/Universal/DataHubDxe/DataHubDxe.inf {
    <PcdsFixedAtBuild>
      gEfiMdePkgTokenSpaceGuid.PcdMaximumLinkedListLength|0
  }
  InsydeModulePkg/Universal/DataHubStdErrDxe/DataHubStdErrDxe.inf
