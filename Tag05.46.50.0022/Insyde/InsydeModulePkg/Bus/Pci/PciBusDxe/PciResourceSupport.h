...
typedef struct {
  ...
  UINT64            BaseAddress;
  UINT64            EndAddress;
} PCI_AVAILABLE_SPACE_DESCRIPTOR;
#define AVAILABLE_SPACE_FROM_LINK(a) \
  BASE_CR (a, PCI_AVAILABLE_SPACE_DESCRIPTOR, Link)
...
/**
  ...
  @param[in] Bridge      PCI resouce node for given bridge device.
