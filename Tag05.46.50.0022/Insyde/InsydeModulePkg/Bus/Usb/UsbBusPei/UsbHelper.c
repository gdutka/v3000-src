  ...
  )
{
  ...
  UsbHcToken = PEI_USB_HC_TOKEN_FROM_THIS (This);
  return UsbHcToken->UsbHcPpi->ControlTransfer (
                                 PeiServices,
                                 UsbHcToken->UsbHcPpi,
                                 DeviceAddress,
                                 DeviceSpeed,
  ...
  )
{
  ...
  UsbHcToken = PEI_USB_HC_TOKEN_FROM_THIS (This);
  return UsbHcToken->UsbHcPpi->BulkTransfer (
                                 PeiServices,
                                 UsbHcToken->UsbHcPpi,
                                 DeviceAddress,
                                 EndPointAddress,
  ...
  )
{
  ...
  UsbHcToken = PEI_USB_HC_TOKEN_FROM_THIS (This);
  return UsbHcToken->UsbHcPpi->GetRootHubPortNumber (
                                 PeiServices,
                                 UsbHcToken->UsbHcPpi,
                                 PortNumber
                                 );
  ...
  )
{
  ...
  UsbHcToken = PEI_USB_HC_TOKEN_FROM_THIS (This);
  return UsbHcToken->UsbHcPpi->GetRootHubPortStatus (
                                 PeiServices,
                                 UsbHcToken->UsbHcPpi,
                                 PortNumber,
                                 PortStatus
  ...
  )
{
  ...
  UsbHcToken = PEI_USB_HC_TOKEN_FROM_THIS (This);
  return UsbHcToken->UsbHcPpi->SetRootHubPortFeature (
                                 PeiServices,
                                 UsbHcToken->UsbHcPpi,
                                 PortNumber,
                                 PortFeature
  ...
  )
{
  ...
  UsbHcToken = PEI_USB_HC_TOKEN_FROM_THIS (This);
  return UsbHcToken->UsbHcPpi->ClearRootHubPortFeature (
                                 PeiServices,
                                 UsbHcToken->UsbHcPpi,
                                 PortNumber,
                                 PortFeature
