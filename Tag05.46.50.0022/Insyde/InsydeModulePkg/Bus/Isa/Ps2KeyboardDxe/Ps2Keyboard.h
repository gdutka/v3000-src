...
#define PS2_NS_KEY_SIGNATURE  SIGNATURE_32 ('p', 'n', 's', 'k')

typedef struct {
  UINTN                         Signature;
  LIST_ENTRY                    Link;
  EFI_KEY_DESCRIPTOR            NsKey;
  UINTN                         PhysicalKeyCount;
//EFI_KEY_DESCRIPTOR            PhysicalKeyList[PhysicalKeyCount];
} PS2_NS_KEY;

#define PS2_NS_KEY_FORM_FROM_LINK(a)  CR (a, PS2_NS_KEY, Link, PS2_NS_KEY_SIGNATURE)
...
#define PS2BD_VALID_JP_SCANCODE_MAKE(ScanCode) (((UINT8) (ScanCode) == 0x73) || ((UINT8) (ScanCode) == 0x7D))
