...
/**
  Internal function uses to enable ISA IO attributes.

  @param[in]  PciIo                A pointer to the EFI_PCI_IO_PROTOCOL instance.

  @retval EFI_SUCCESS              Enable ISA IO attributes successfully.
  @retval EFI_INVALID_PARAMETER    Input
  @return Other                    cannot get supported attributes from EFI_PCI_IO_PROTOCOL instance.
  ...
  )
{
  ...
  if ((Supports & EFI_PCI_IO_ATTRIBUTE_ISA_IO_16) == EFI_PCI_IO_ATTRIBUTE_ISA_IO_16) {
    Status = PciIo->Attributes (
                      PciIo,
  ...
  } else if ((Supports & EFI_PCI_IO_ATTRIBUTE_ISA_IO) == EFI_PCI_IO_ATTRIBUTE_ISA_IO) {
    Status = PciIo->Attributes (
                      PciIo,
                      EfiPciIoAttributeOperationEnable,
