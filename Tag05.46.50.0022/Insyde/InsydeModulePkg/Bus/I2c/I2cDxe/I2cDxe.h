...
typedef struct {
  ...
  //
  // Event to set for asynchronous operations to device handler, NULL for
  // synchronous operations
  //
  EFI_EVENT                         DeviceEvent;

  //
  // Event to receive asynchronous operations from I2C master driver
  //
  EFI_EVENT                         MasterEvent;

  //
  // I2C operation status from I2C master driver
  //
  EFI_STATUS                        MasterStatus;
...
typedef struct {
  ...
  //
  // I2C request for sync request
  //
  I2C_REQUEST                                   *SyncI2cRequest;
