...
#define KBC_CMDECHO_FAILED_ACK    0xFE
...
#define MAX_KEYBOARD_DEV   8
#define EBDA16(a)                       (*(UINT16*)(UINTN)(((*(UINT16*)(UINTN)0x40e) << 4) + (a)))
#define IS_EBDA_VALID                   ((*(UINT16*)(UINTN)0x40e) > 0 && (*(UINT16*)(UINTN)0x40e) < 0xa000)
#define EBDA_KEYBORD_SCAN_CODE          0x0164
//
