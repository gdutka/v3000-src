/** @file
  Header file for Legacy Bios Driver's Data Structures
...
// Low stub lay out
//
#define LOW_CODE_SIZE       (4 * 1024)  // 4K
...
#define CSM16_SUPPORT_PCI3_0 (1 << 0)
#define EFI_SUPPORT_PCI3_0   (1 << 1)
