...
STATIC EFI_FORM_BROWSER2_PROTOCOL  *mUefiFormBrowser2 = NULL;
  ...
  )
{
  ...
  if (PackageListLength > PackageListSize) {
    PackageListLength = (UINT32)PackageListSize;
  }
