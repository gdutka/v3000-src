  ...
  )
{
  ...
  Value = mDxeSmmIoLibProtocol->MmioRead(Address, SMM_IO_UINT8);
  return Value;
}
  ...
  )
{
  ...
  Value = mDxeSmmIoLibProtocol->MmioRead(Address, SMM_IO_UINT16);
  return Value;
}
  ...
  )
{
  ...
  Value = mDxeSmmIoLibProtocol->MmioRead(Address, SMM_IO_UINT32);
  return Value;
}
  ...
  )
{
  ...
  mDxeSmmIoLibProtocol->MmioWrite(Address, SMM_IO_UINT64, Value);
  return Value;
}
