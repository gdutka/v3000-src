  ...
  )
{
  ...
  if (gSmst) {
    Status = gSmst->SmmLocateProtocol (&gH2ODxeSmmIoLibProtocolGuid, NULL, (VOID**)&mDxeSmmIoLibProtocol);
  } else {
     Status = gBS->LocateProtocol (&gH2ODxeSmmIoLibProtocolGuid, NULL, (VOID **) &mDxeSmmIoLibProtocol);
  }
  return EFI_SUCCESS;
}
