...
STATIC struct {
  ...
  //
  { 0x0d00, HID_UP_GENDESK,    HID_GD_X,                            0xff, 0xff, ATTR_TOUCH_PANEL_INPUT, (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.TouchPanel.FieldX              },
  { 0x0d00, HID_UP_GENDESK,    HID_GD_Y,                            0xff, 0xff, ATTR_TOUCH_PANEL_INPUT, (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.TouchPanel.FieldY              },
  { 0x0d00, HID_UP_DIGITIZERS, HID_DIGITIZERS_TIP_SWITCH,           0x01, 0xff, ATTR_TOUCH_PANEL_INPUT, (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.TouchPanel.FieldTouchActive    },
  { 0x0d00, HID_UP_DIGITIZERS, HID_DIGITIZERS_SECONDARY_TIP_SWITCH, 0x01, 0xff, ATTR_TOUCH_PANEL_INPUT, (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.TouchPanel.FieldAltActive      },
  { 0x0d00, HID_UP_DIGITIZERS, HID_DIGITIZERS_BARREL_SWITCH,        0x01, 0xff, ATTR_TOUCH_PANEL_INPUT, (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.TouchPanel.FieldAltActive      },
  { 0x0d00, HID_UP_BUTTON,     1,                                   0x01, 0xff, ATTR_TOUCH_PANEL_INPUT, (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.TouchPanel.FieldTouchActive    },
  { 0x0d00, HID_UP_BUTTON,     2,                                   0x01, 0xff, ATTR_TOUCH_PANEL_INPUT, (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.TouchPanel.FieldAltActive      },
  { 0x0d00, HID_UP_DIGITIZERS, HID_DIGITIZERS_CONTACT_COUNT,        0xff, 0xff, ATTR_TOUCH_PANEL_INPUT, (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.TouchPanel.FieldContactCount   },
  { 0x0d00, HID_UP_DIGITIZERS, HID_DIGITIZERS_DEVICE_MODE,          0xff, 0xff, ATTR_TOUCH_PANEL_MODE,  (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.TouchPanelMode.FieldDeviceMode },
  { 0x0d00, HID_UP_DIGITIZERS, HID_DIGITIZERS_DEVICE_ID,            0xff, 0xff, ATTR_TOUCH_PANEL_MODE,  (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.TouchPanelMode.FieldDeviceId   },
  { 0x0d00, HID_UP_VENDOR,     0xff,                                0xff, 0xff, ATTR_VENDOR_FEATURE,    (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.VendorData.VendorDefined       },
  //
  // The report field lookup table for pad
  //
  { 0x0101, HID_UP_GENDESK,    HID_GD_X,                            0xff, 0xff, ATTR_MOUSE_INPUT,       (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Mouse.FieldX                   },
  { 0x0101, HID_UP_GENDESK,    HID_GD_Y,                            0xff, 0xff, ATTR_MOUSE_INPUT,       (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Mouse.FieldY                   },
  { 0x0101, HID_UP_GENDESK,    HID_GD_WHEEL,                        0xff, 0xff, ATTR_MOUSE_INPUT,       (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Mouse.FieldZ                   },
  { 0x0101, HID_UP_BUTTON,     1,                                   0x01, 0xff, ATTR_MOUSE_INPUT,       (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Mouse.FieldButton1             },
  { 0x0101, HID_UP_BUTTON,     2,                                   0x01, 0xff, ATTR_MOUSE_INPUT,       (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Mouse.FieldButton2             },
  //
  // The report field lookup table for mouse
  //
  { 0x0102, HID_UP_GENDESK,    HID_GD_X,                            0xff, 0xff, ATTR_MOUSE_INPUT,       (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Mouse.FieldX                   },
  { 0x0102, HID_UP_GENDESK,    HID_GD_Y,                            0xff, 0xff, ATTR_MOUSE_INPUT,       (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Mouse.FieldY                   },
  { 0x0102, HID_UP_GENDESK,    HID_GD_WHEEL,                        0xff, 0xff, ATTR_MOUSE_INPUT,       (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Mouse.FieldZ                   },
  { 0x0102, HID_UP_BUTTON,     1,                                   0x01, 0xff, ATTR_MOUSE_INPUT,       (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Mouse.FieldButton1             },
  { 0x0102, HID_UP_BUTTON,     2,                                   0x01, 0xff, ATTR_MOUSE_INPUT,       (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Mouse.FieldButton2             },
  //
  // The report field lookup table for keyboard
  //
  { 0x0106, HID_UP_KEYBOARD,   0xff,                                0x01, 0xe0, ATTR_KEYBOARD_INPUT,    (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Keyboard.FieldModKeyCode       },
  { 0x0106, HID_UP_KEYBOARD,   0xff,                                0xff, 0xff, ATTR_KEYBOARD_INPUT,    (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Keyboard.FieldKeyCode          },
  { 0x0107, HID_UP_KEYBOARD,   0xff,                                0x01, 0xe0, ATTR_KEYBOARD_INPUT,    (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Keyboard.FieldModKeyCode       },
  { 0x0107, HID_UP_KEYBOARD,   0xff,                                0x01, 0xff, ATTR_KEYBOARD_INPUT,    (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Keyboard.FieldKeyCode          },
  { 0x0106, HID_UP_LED,        0xff,                                0x01, 0xff, ATTR_KEYBOARD_LED,      (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.KeyboardLed.FieldLed           },
  //
  // The report field lookup table for comsumer device
  //
  { 0x0C01, HID_UP_CONSUMER,   0xff,                                0xff, 0xff, ATTR_CONSUMER_INPUT,    (UINT8)(UINTN)&((REPORT_GROUP*)0)->Data.Consumer.FieldData             },
  //
  // End of table
  //
  { 0x0000, 0,                 0,                                   0,    0,    0,                      0                                                                      },
  ...
  )
{
  ...
  for (Index = 0, ReportField = NULL, Attr = 0; mHidReportField[Index].ClassCode != 0; Index ++) {
    if (mHidReportField[Index].ClassCode == RootClassCode &&
        ...
        (mHidReportField[Index].UsageMinValue == 0xff || mHidReportField[Index].UsageMinValue == mHidParser.Local.UsageMin)) {
  ...
  )
{
  ...
  UINT8     *ptr;
  HID_ITEM  HidItem;
  UINT16    CurrentUsagePage = 0;
  UINT8     CurrentUsage = 0;
  UINT16    TargetUsagePage = (UINT16)(ClassCode >> 8);
  ...
  while (ptr != NULL) {
    ...
    case HID_ITEM_TYPE_GLOBAL:
      ...
      if (HidItem.Tag == HID_GLOBAL_ITEM_TAG_USAGE_PAGE) {
        CurrentUsagePage = (UINT16) GetItemData (&HidItem);
      }
      break;
