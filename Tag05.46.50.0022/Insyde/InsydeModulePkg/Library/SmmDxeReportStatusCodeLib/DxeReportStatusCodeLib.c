...
STATIC EFI_STATUS_CODE_PROTOCOL  *mReportStatusCodeLibStatusCodeProtocol = NULL;
STATIC EFI_EVENT                 mReportStatusCodeLibVirtualAddressChangeEvent;
STATIC EFI_EVENT                 mReportStatusCodeLibExitBootServicesEvent;
STATIC BOOLEAN                   mHaveExitedBootServices = FALSE;
...
**/
VOID
DxeInternalGetReportStatusCode (
  VOID
  )
{
  EFI_STATUS  Status;
  ...
  )
{
  ...
  gRT->ConvertPointer (0, (VOID **) &mReportStatusCodeLibStatusCodeProtocol);
}
...
EFI_STATUS
EFIAPI
DxeReportStatusCodeLibConstructor (
...
EFI_STATUS
EFIAPI
DxeReportStatusCodeLibDestructor (
  IN EFI_HANDLE        ImageHandle,
  IN EFI_SYSTEM_TABLE  *SystemTable
  )
{
...
BOOLEAN
EFIAPI
DxeReportStatusCodeExtractAssertInfo (
  IN EFI_STATUS_CODE_TYPE        CodeType,
  IN EFI_STATUS_CODE_VALUE       Value,
...
BOOLEAN
EFIAPI
DxeReportStatusCodeExtractDebugInfo (
  IN CONST EFI_STATUS_CODE_DATA  *Data,
...
{
  return DxeInternalReportStatusCode (Type, Value, 0, &gEfiCallerIdGuid, NULL);
}
...
EFI_STATUS
EFIAPI
DxeReportStatusCodeWithDevicePath (
  IN EFI_STATUS_CODE_TYPE            Type,
  IN EFI_STATUS_CODE_VALUE           Value,
...
EFI_STATUS
EFIAPI
DxeReportStatusCodeWithExtendedData (
  IN EFI_STATUS_CODE_TYPE   Type,
  IN EFI_STATUS_CODE_VALUE  Value,
  ...
  )
{
  ...
  Status = DxeInternalReportStatusCode (Type, Value, Instance, CallerId, StatusCodeData);
