...
#define OEM_LOGO_RESOLUTION_DISPLAY_ENGINE_MAX_NUM  5
...
typedef struct  {
  ...
  //H2O_DISPLAY_ENGINE_RESOLUTION DisplayEngineGuid[OEM_LOGO_RESOLUTION_DISPLAY_ENGINE_MAX_NUM];
