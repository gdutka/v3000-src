...
CHAR16 *mTimeItemChilds = L""
  L"<HorizontalLayout height='156'>"
    L"<NumberPicker background-color='@menucolor' name='Hour'/>"
    L"<VerticalLayout width='5' background-color='0xFF333333'>"
      ...
      L"<Label height='65'/>"
    L"</VerticalLayout>"
    L"<NumberPicker background-color='@menucolor' name='Minute'/>"
    L"<VerticalLayout width='5' background-color='0xFF333333'>"
      L"<Label height='52'/>"
      ...
      L"<Label height='65'/>"
    L"</VerticalLayout>"
    L"<NumberPicker background-color='@menucolor' name='Second'/>"
  L"</HorizontalLayout>";
  ...
  )
{
  ...
  if (StrCmp (Name, L"efitime") == 0) {
    ...
    CopyMem (&This->EfiTime, EfiTime, sizeof(EFI_TIME));
    if (This->EfiTime.Hour   == 0xFF ||
        This->EfiTime.Minute == 0xFF ||
        This->EfiTime.Second == 0xFF) {
      This->EfiTime.Hour   = 0;
      This->EfiTime.Minute = 0;
      This->EfiTime.Second = 0;
    }
    H2OTimeItemNumberPickerUpdate (This, &This->EfiTime);
  } else {
