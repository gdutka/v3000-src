...
typedef struct _H2O_SETUP_PAGE_PANEL_IFR_OPCODE_INFO {
  UINT8                                 IfrOpcode;
  H2O_PROPERTY_INFO                     **PropertyList;
  UINTN                                 PropertyCount;
} H2O_SETUP_PAGE_PANEL_IFR_OPCODE_INFO;
...
struct _H2O_SETUP_PAGE_PANEL {
  ...
  H2O_SETUP_PAGE_PANEL_IFR_OPCODE_INFO      *IfrOpcodeInfoList;
  UINTN                                     IfrOpcodeInfoCount;
};
