  ...
  )
{
  ...
  ScrollBarWidth = Control->VScrollBar->Control.Width.Value;
  ...
  )
{
  ...
  VScrollBar = Control->VScrollBar;

  switch (WParam) {

  case VK_DOWN:
    SCROLLBAR_CLASS(VScrollBar)->SetScrollPos (VScrollBar, VScrollBar->ScrollPos + VScrollBar->LineSize);
    break;
