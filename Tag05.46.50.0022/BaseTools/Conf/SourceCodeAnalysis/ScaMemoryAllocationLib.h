...
#ifndef __SCA_MEMORY_ALLOCATION_LIB_H__
#define __SCA_MEMORY_ALLOCATION_LIB_H__
...
EFIAPI
ReallocatePool (
  _In_                           IN UINTN  OldSize,
  _In_                           IN UINTN  NewSize,
  _Pre_maybenull_ _Post_invalid_ IN VOID   *OldBuffer  OPTIONAL
  );
...
EFIAPI
FreePool (
  _Pre_maybenull_ _Post_invalid_ IN VOID   *Buffer
  );
