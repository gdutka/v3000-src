...
#define PcdGetPtr(SKU,STORE,GuidCName,TokenCName) SKU##_##STORE##_##GuidCName##_##TokenCName
#define PcdGetPtrSize(SKU,STORE,GuidCName,TokenCName) SKU##_##STORE##_##GuidCName##_##TokenCName##_SIZE
