...
:set_PATH
  ...
  if defined TOOL_BIN_PATH (
    if "%TOOL_BIN_PATH%"=="Win64" (
      set "PATH=%EDK_TOOLS_PATH%\Bin;%EDK_TOOLS_PATH%\Bin\Win64;%EDK_TOOLS_PATH%\Bin\Win32;%PATH%"
    ) else (
...
IF NOT EXIST "%EDK_TOOLS_PATH%\Bin\Win32\VfcfCompile.exe" goto check_build_environment
