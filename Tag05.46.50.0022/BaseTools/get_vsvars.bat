...
if defined VCINSTALLDIR goto :done
  if defined VS160COMNTOOLS  call :read_vsvars  "%VS160COMNTOOLS%" VS2019
  if defined VS150COMNTOOLS  call :read_vsvars  "%VS150COMNTOOLS%" VS2017
...
:select
  if "%1"=="VS2019"    goto :VS2019Setup
  if "%1"=="VS2019x86" goto :VS2019Setup
  if "%1"=="VS2017"    goto :VS2017Setup
  if "%1"=="VS2017x86" goto :VS2017Setup
  if "%1"=="VS2015"    goto :VS2015Setup
  if "%1"=="VS2015x86" goto :VS2015Setup
  if "%1"=="VS2014"    goto :VS2014Setup
  if "%1"=="VS2014x86" goto :VS2014Setup
  if "%1"=="VS2013"    goto :VS2013Setup
  if "%1"=="VS2013x86" goto :VS2013Setup
  if "%1"=="VS2012"    goto :VS2012Setup
  if "%1"=="VS2012x86" goto :VS2012Setup
  if "%1"=="VS2010"    goto :VS2010Setup
  if "%1"=="VS2010x86" goto :VS2010Setup
  if "%1"=="VS2008"    goto :VS2008Setup
  if "%1"=="VS2008x86" goto :VS2008Setup
  if "%1"=="VS2005"    goto :VS2005Setup
  if "%1"=="VS2005x86" goto :VS2005Setup
