...
//
// Define terminal type for ESC code table
//
#define TP_ANSI_100                       (TP_PCANSI | TP_VT100)
#define TP_ANSI_TTY                       (TP_PCANSI | TP_TTY)
#define TP_ANSI_SCO                       (TP_PCANSI | TP_SCO)
#define TP_ANSI_100_TTY                   (TP_PCANSI | TP_VT100 | TP_TTY)
#define TP_PLUS_UTF8                      (TP_VT100P | TP_VTUTF8)
#define TP_100P_UTF8                      (TP_VT100 | TP_VT100P | TP_VTUTF8)
#define TP_PLUS_TTY_XTR6                  (TP_VT100P | TP_TTY | TP_XTERM_R6)
#define TP_100P_TTY_XTR6                  (TP_VT100 | TP_VT100P | TP_TTY | TP_XTERM_R6)
#define TP_400_XTR6                       (TP_VT400 | TP_XTERM_R6)
#define TP_400_LINUX_XTR6                 (TP_VT400 | TP_LINUX | TP_XTERM_R6)
#define TP_ALL_TYPE                       (TP_PCANSI | TP_VT100 | TP_VT100P | TP_VTUTF8 | TP_LOG | TP_TTY | TP_LINUX | TP_XTERM_R6 | TP_VT400 | TP_SCO)
...
typedef struct {
  ...
  //
  // ++++ Insyde H2O Console Redirection add ++++
  //
