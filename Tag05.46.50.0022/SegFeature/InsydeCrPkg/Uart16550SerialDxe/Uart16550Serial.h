...
;******************************************************************************
*/
#ifndef _UART_16550_SERIAL_H_
#define _UART_16550_SERIAL_H_
...
//
extern EFI_DRIVER_BINDING_PROTOCOL  gUart16550Driver;
extern EFI_COMPONENT_NAME_PROTOCOL  gUart16550ComponentName;
extern EFI_COMPONENT_NAME2_PROTOCOL gUart16550ComponentName2;
...
#define FLOW_CONTROL_HARDWARE         BIT0
#define FLOW_CONTROL_XON_XOFF         BIT1
...
typedef struct {
  ...
  BOOLEAN                                SoftwareFlowControl;
  UINT8                                  UartUid;
  UINT8                                  HostFlowCtrlState;
  UINT8                                  RemoteFlowCtrlState;
  EFI_UART_TYPE                          Type;
...
//
#define READ_RBR(IO)     Uart16550ReadRegister (IO, SERIAL_REGISTER_RBR)
#define READ_DLL(IO)     Uart16550ReadRegister (IO, SERIAL_REGISTER_DLL)
#define READ_DLM(IO)     Uart16550ReadRegister (IO, SERIAL_REGISTER_DLM)
#define READ_IER(IO)     Uart16550ReadRegister (IO, SERIAL_REGISTER_IER)
#define READ_IIR(IO)     Uart16550ReadRegister (IO, SERIAL_REGISTER_IIR)
#define READ_LCR(IO)     Uart16550ReadRegister (IO, SERIAL_REGISTER_LCR)
#define READ_MCR(IO)     Uart16550ReadRegister (IO, SERIAL_REGISTER_MCR)
#define READ_LSR(IO)     Uart16550ReadRegister (IO, SERIAL_REGISTER_LSR)
#define READ_MSR(IO)     Uart16550ReadRegister (IO, SERIAL_REGISTER_MSR)
#define READ_SCR(IO)     Uart16550ReadRegister (IO, SERIAL_REGISTER_SCR)

#define WRITE_THR(IO, D) Uart16550WriteRegister (IO, SERIAL_REGISTER_THR, D)
#define WRITE_DLL(IO, D) Uart16550WriteRegister (IO, SERIAL_REGISTER_DLL, D)
#define WRITE_DLM(IO, D) Uart16550WriteRegister (IO, SERIAL_REGISTER_DLM, D)
#define WRITE_IER(IO, D) Uart16550WriteRegister (IO, SERIAL_REGISTER_IER, D)
#define WRITE_FCR(IO, D) Uart16550WriteRegister (IO, SERIAL_REGISTER_FCR, D)
#define WRITE_LCR(IO, D) Uart16550WriteRegister (IO, SERIAL_REGISTER_LCR, D)
#define WRITE_MCR(IO, D) Uart16550WriteRegister (IO, SERIAL_REGISTER_MCR, D)
#define WRITE_LSR(IO, D) Uart16550WriteRegister (IO, SERIAL_REGISTER_LSR, D)
#define WRITE_MSR(IO, D) Uart16550WriteRegister (IO, SERIAL_REGISTER_MSR, D)
#define WRITE_SCR(IO, D) Uart16550WriteRegister (IO, SERIAL_REGISTER_SCR, D)
