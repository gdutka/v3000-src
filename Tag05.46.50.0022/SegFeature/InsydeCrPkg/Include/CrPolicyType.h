...
#define CR_PARITY_MARK                  4
#define CR_PARITY_SPACE                 5
...
typedef struct _CR_POLICY_PCD {
  ...
  UINT8                  Reserve7;            //This column from SCU setting, PCD reserve
  UINT8                  Reserve8;            //This column from SCU setting, PCD reserve
  UINT8                  CRForceAsyncForLegacy;
