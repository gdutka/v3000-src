...
#define COMMON_CR_DEVICE_SUPPORT_NUM  10
#define EXTRA_CR_DEVICE_SUPPORT_NUM   22
#define MAX_CR_DEVICE_VARIABLE        COMMON_CR_DEVICE_SUPPORT_NUM + EXTRA_CR_DEVICE_SUPPORT_NUM
...
typedef struct {
  ...
  CR_SERIAL_PORT_CONFIG  CrPortConfig[COMMON_CR_DEVICE_SUPPORT_NUM];
  UINT8                  LoadVarDefault;  
  CR_SERIAL_PORT_CONFIG  ExCrPortConfig[EXTRA_CR_DEVICE_SUPPORT_NUM];
} CR_CONFIGURATION;

#pragma pack()

extern EFI_GUID gH2OCrConfigurationGuid;
extern EFI_GUID gH2OCrFormsetGuid;
