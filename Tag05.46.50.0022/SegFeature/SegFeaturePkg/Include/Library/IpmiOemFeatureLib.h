...
/**
 ...
 @param[out]        VersionArray         Fw information for IdTag, define at H2O_IPMI_SUPERVYSE_FW_VERSION_INFO
...
/**
 ...
 @param[out]        CpldRevision            Return CPLD Revision, define in H2O_IPMI_SUPERVYSE_CPLD_REVISION_RESPONSE
...
/**
 ...
 @param[out]        SelInfo            A pointer to H2O_IPMI_SUPERVYSE_SEL_INFO_RESPONSE structure.
...
/**
 ...
 @param[out]        SelAllocInfo            A pointer to H2O_IPMI_SUPERVYSE_SEL_ALLOC_INFO_RESPONSE structure.

 @return Execute Lib IPMI Command Status.
*/
EFI_STATUS
IpmiBmcFeatureLibGetSelAllocInfo (
  OUT UINT8                             *SelAllocInfo,
  IN  BOOLEAN                           IsHeci
  );
...
/**
 ...
 @param[out]        SelEntry            A pointer to H2O_IPMI_SUPERVYSE_SEL_ENTRY structure.
...
/**
 ...
 @param[in]         SelRecordId         SEL Record ID.
 @param[out]        SelEntry            A pointer to H2O_IPMI_SUPERVYSE_SEL_ENTRY_RESPONSE structure.
...
/**
  ...
  @param[in]            RequestOffset         Request Offset
  @param[in out]        ResponseData          Response of Send Data Region Status.
  @param[in out]        ResponseSize          in : size of ResponseData.
                                              out: size of BMC response data.
...
/**
 ...
 @param[out]  UsbList  return Supervyse USB device status      
...
//[-start-190419-IB09330599-add]//
/**
 Clear Dimm Error Status

 @retval EFI_SUCCESS                    Clear Dimm error status to BMC success.
 @retval Others                         Clear Dimm error status to BMC fail.
*/
EFI_STATUS
IpmiBmcFeatureLibClearDimmError (
  VOID
  );

/**
 Clear Dimm Error variable
 This should be called in DXE phase

 @retval EFI_SUCCESS                    Clear Dimm error variable success.
 @retval Others                         Clear Dimm error variable fail.
*/
EFI_STATUS
IpmiBmcFeatureLibClearDimmErrorVariable (
  VOID
  );
//[-end-190419-IB09330599-add]//
