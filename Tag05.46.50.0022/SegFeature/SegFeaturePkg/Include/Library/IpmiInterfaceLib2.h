/** @file
 H2O IPMI interface library header file.

 This file contains functions prototype that can easily send command to BMC
 following IPMI specification.
...
*/
#ifndef _IPMI_INTERFACE_LIB2_H_
#define _IPMI_INTERFACE_LIB2_H_
