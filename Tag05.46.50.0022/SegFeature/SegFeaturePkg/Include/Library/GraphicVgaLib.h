/** @file
  Header file for GraphicVgaLib

  This library provides function to show the string on the monitor screen.
...
#ifndef _GRAPHIC_VGA_LIB_H_
#define _GRAPHIC_VGA_LIB_H_

#define GRAPHIC_VGA_RED     0xFFFF0000
#define GRAPHIC_VGA_GREEN   0xFF00FF00
#define GRAPHIC_VGA_BLUE    0xFF0000FF
#define GRAPHIC_VGA_AQUA    0xFF00FFFF
#define GRAPHIC_VGA_WHITE   0xFFFFFFFF
#define GRAPHIC_VGA_BLACK   0x00000000
...
/**
 ...
 @param[in]          DenstinationX   - where Row start to output the Bitmap
 @param[in]          DenstinationY   - where column start to output the Bitmap
 @param[in]          ImageData       - Pointer to the raw data of image
 @param[in]          ImageSize       - Size of ImageData
 @param[in]          BltBuffer       - PNG data
