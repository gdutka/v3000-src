...
typedef struct {
  USB_DEVICE_PATH                Node;
  EFI_DEVICE_PATH_PROTOCOL       End;
} HII_TEMP_USB_DEVICE_PATH;

HII_TEMP_USB_DEVICE_PATH  mHiiTempUsbDevicePath = {
  {
    {
...
typedef struct {
  ...
  EFI_DEVICE_PATH_PROTOCOL       End;
} HII_TEMP_SATA_DEVICE_PATH;

HII_TEMP_SATA_DEVICE_PATH  mHiiTempSataDevicePath = {
  {
    {
      MESSAGING_DEVICE_PATH,
      MSG_SATA_DP,
...
typedef struct {
  SCSI_DEVICE_PATH               Node;
  EFI_DEVICE_PATH_PROTOCOL       End;
} HII_TEMP_SCSI_DEVICE_PATH;

HII_TEMP_SCSI_DEVICE_PATH  mHiiTempScsiDevicePath = {
  {
    {
      MESSAGING_DEVICE_PATH,
      MSG_SCSI_DP,
...
typedef struct {
  ...
  EFI_DEVICE_PATH_PROTOCOL       End;
} HII_TEMP_HARDDRIVE_DEVICE_PATH;

HII_TEMP_HARDDRIVE_DEVICE_PATH  mHiiTempHarddriveDevicePath = {
  {
    {
      MEDIA_DEVICE_PATH,
      MEDIA_HARDDRIVE_DP,
      (UINT8) (sizeof (HARDDRIVE_DEVICE_PATH)),
      (UINT8) ((sizeof (HARDDRIVE_DEVICE_PATH)) >> 8)
    },
    0,
    0,
    0,
...
typedef struct {
  ...
  EFI_DEVICE_PATH_PROTOCOL       End;
} HII_TEMP_ATAPI_DEVICE_PATH;

HII_TEMP_ATAPI_DEVICE_PATH  mHiiTempAtapiDevicePath = {
  {
    {
      MESSAGING_DEVICE_PATH,
      MSG_ATAPI_DP,
...
typedef struct {
  IPv4_DEVICE_PATH               Node;
  EFI_DEVICE_PATH_PROTOCOL       End;
} HII_TEMP_IPV4_DEVICE_PATH;

HII_TEMP_IPV4_DEVICE_PATH  mHiiTempIpv4DevicePath = {
  {
    {
      MESSAGING_DEVICE_PATH,
      MSG_IPv4_DP,
      (UINT8) (sizeof (IPv4_DEVICE_PATH)),
      (UINT8) ((sizeof (IPv4_DEVICE_PATH)) >> 8)
    },
    {0},
    {0},
    0,
...
VOID
CreateFakeBootOptions (
  VOID
  )
{
  BdsLibRegisterNewOption (NULL, (EFI_DEVICE_PATH_PROTOCOL *) &mHiiTempHarddriveDevicePath, L"EFI OS"   , L"BootOrder");
  BdsLibRegisterNewOption (NULL, (EFI_DEVICE_PATH_PROTOCOL *) &mHiiTempUsbDevicePath      , L"EFI USB"  , L"BootOrder");
  BdsLibRegisterNewOption (NULL, (EFI_DEVICE_PATH_PROTOCOL *) &mHiiTempSataDevicePath     , L"EFI SATA" , L"BootOrder");
  BdsLibRegisterNewOption (NULL, (EFI_DEVICE_PATH_PROTOCOL *) &mHiiTempScsiDevicePath     , L"EFI SCSI" , L"BootOrder");
  BdsLibRegisterNewOption (NULL, (EFI_DEVICE_PATH_PROTOCOL *) &mHiiTempAtapiDevicePath    , L"EFI Atapi", L"BootOrder");
  BdsLibRegisterNewOption (NULL, (EFI_DEVICE_PATH_PROTOCOL *) &mHiiTempIpv4DevicePath     , L"EFI IPV4" , L"BootOrder");
}
...
#else
  Fmt = L"%s %d";
  UnicodeSPrint (BootString, BufSize, Fmt, Type, Index);
#endif
}
