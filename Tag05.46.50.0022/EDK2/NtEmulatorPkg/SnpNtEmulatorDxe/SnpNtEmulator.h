...
#ifndef _SNP_NTEMULATOR_H_
#define _SNP_NTEMULATOR_H_
...
typedef struct _SNPNTEMULATOR_GLOBAL_DATA  SNPNTEMULATOR_GLOBAL_DATA;
typedef struct _SNPNTEMULATOR_INSTANCE_DATA SNPNTEMULATOR_INSTANCE_DATA;

#define NETWORK_LIBRARY_NAME_U          L"SnpNtEmulatorIo.dll"
...
typedef
EFI_STATUS
(*SNPNTEMULATOR_INITIALIZE_GLOBAL_DATA) (
  IN SNPNTEMULATOR_GLOBAL_DATA * This
  );

typedef
EFI_STATUS
(*SNPNTEMULATOR_INITIALIZE_INSTANCE_DATA) (
  IN SNPNTEMULATOR_GLOBAL_DATA    * This,
  IN SNPNTEMULATOR_INSTANCE_DATA  * Instance
  );

typedef
EFI_STATUS
(*SNPNTEMULATOR_CLOSE_INSTANCE) (
  IN SNPNTEMULATOR_GLOBAL_DATA    * This,
  IN SNPNTEMULATOR_INSTANCE_DATA  * Instance
  );
...
//
#define SNP_NTEMULATOR_DRIVER_SIGNATURE SIGNATURE_32 ('W', 'S', 'N', 'P')

struct _SNPNTEMULATOR_GLOBAL_DATA {
  UINT32                            Signature;
  ...
  //  Private functions
  //
  SNPNTEMULATOR_INITIALIZE_GLOBAL_DATA    InitializeGlobalData;
  SNPNTEMULATOR_INITIALIZE_INSTANCE_DATA  InitializeInstanceData;
  SNPNTEMULATOR_CLOSE_INSTANCE            CloseInstance;
};

//
//  Instance data for each fake SNP instance
//
#define SNP_NTEMULATOR_INSTANCE_SIGNATURE SIGNATURE_32 ('w', 'S', 'N', 'P')

struct _SNPNTEMULATOR_INSTANCE_DATA {
  UINT32                      Signature;
...
#define SNP_NTEMULATOR_INSTANCE_DATA_FROM_SNP_THIS(a) \
  CR ( \
  a, \
  SNPNTEMULATOR_INSTANCE_DATA, \
  Snp, \
  SNP_NTEMULATOR_INSTANCE_SIGNATURE \
  )

extern EFI_DRIVER_BINDING_PROTOCOL    gSnpNtEmulatorDriverBinding;
extern EFI_COMPONENT_NAME_PROTOCOL    gSnpNtEmulatorDriverComponentName;
extern EFI_COMPONENT_NAME2_PROTOCOL   gSnpNtEmulatorDriverComponentName2;
