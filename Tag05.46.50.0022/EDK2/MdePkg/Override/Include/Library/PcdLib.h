...
#define EX_PcdToken(TokenName)  EX_##TokenName

#ifndef NEW_PCD_DEPRECATED_INTERFACE

  #ifndef DYNAMIC_TO_DYNAMICEX

#define NEW_PCD_DEPRECATED_INTERFACE(func)  func

  #else

    #if defined (__GNUC__) || defined (__clang__)
      #if defined (MDE_CPU_ARM) || defined (MDE_CPU_AARCH64)
#define NEW_PCD_DEPRECATED_INTERFACE(func)  func __attribute__ ((deprecated))
      #else
#define NEW_PCD_DEPRECATED_INTERFACE(func)  func __attribute__ ((deprecated("Dynamic PCDs are deprecated when using --Dynamic-to-DynamicEx flag. Change LibPcdGetXXXX to PcdGetXXXX.")))
      #endif
    #elif defined (_MSC_VER)
#define NEW_PCD_DEPRECATED_INTERFACE(func)  __declspec(deprecated("Dynamic PCDs are deprecated when using --Dynamic-to-DynamicEx flag. Change LibPcdGetXXXX to PcdGetXXXX.")) func
    #else
#define NEW_PCD_DEPRECATED_INTERFACE(func)  func
      #pragma message("WARNING: You need to implement NEW_PCD_DEPRECATED_INTERFACE for this compiler")
    #endif
  #endif
