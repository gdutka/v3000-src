  ...
  )
{
  ...
  SecurityEvent.Event.StatusCodeValue    = EFI_SOFTWARE_X64_EXCEPTION;
  SecurityEvent.Event.ErrorCode          = (UINT32)SystemContext.SystemContextX64->ExceptionData;
  SecurityEvent.Event.CodeIp             = SystemContext.SystemContextX64->Rip;
  SecurityEvent.Event.CodeSel            = (UINT16)SystemContext.SystemContextX64->Cs;
  ...
  )
{
  ...
  if (FeaturePcdGet (PcdH2OBaseCpCpuExceptionSupported)) {
    ...
    if (TriggerExceptionCP (ExceptionType)) {
      ...
      CpuExceptionData.ErrorCode = (UINT32)SystemContext.SystemContextX64->ExceptionData;
      CpuExceptionData.CodeIp    = SystemContext.SystemContextX64->Rip;
      CpuExceptionData.CodeSel   = (UINT16)SystemContext.SystemContextX64->Cs;
      if (ExceptionType == EXCEPT_IA32_PAGE_FAULT) {
        CpuExceptionData.Data = SystemContext.SystemContextX64->Cr2;
      } else {
