## @file
# This is the ARM QEMU DSC file which is modified by ArmVirtQemu.dsc.
#
#******************************************************************************
...
[Defines]
  ...
  !errif ($(NETWORK_SNP_ENABLE) == TRUE), "NETWORK_SNP_ENABLE is IA32/X64/EBC only"
...
!endif
  !errif ($(NETWORK_ENABLE) == TRUE) AND ($(NETWORK_IP4_ENABLE) == FALSE) AND ($(NETWORK_IP6_ENABLE) == FALSE), "Must enable at least IP4 or IP6 stack if NETWORK_ENABLE is set to TRUE!"
  !errif ($(NETWORK_ENABLE) == TRUE) AND (($(NETWORK_HTTP_BOOT_ENABLE) == TRUE) OR ($(NETWORK_HTTP_ENABLE) == TRUE)) AND ($(NETWORK_TLS_ENABLE) == FALSE) AND ($(NETWORK_ALLOW_HTTP_CONNECTIONS) == FALSE), "Must enable at least IP4 or IP6 stack if NETWORK_ENABLE is set to TRUE!"
...
# MdeModulePkg/Universal/SetupBrowserDxe/SetupBrowserDxe.inf
  MdeModulePkg/Universal/DriverHealthManagerDxe/DriverHealthManagerDxe.inf {
    <SOURCE_OVERRIDE_PATH>
      MdeModulePkg/Override/Universal/DriverHealthManagerDxe
  }
...
!include NetworkPkg/NetworkComponents.dsc.inc
  !disable NetworkPkg/UefiPxeBcDxe/UefiPxeBcDxe.inf
