...
REM ---------------------------------------------------------------------------------------------
REM Set ARCH environment variable to switch ARM or AARCH64 QEMU.
REM ---------------------------------------------------------------------------------------------
if not defined ARCH set ARCH=AARCH64
if '%ARCH%'=='AARCH64' (
  set TOOL_CHAIN=DEVTLS_ARM64GCC
) else if '%ARCH%'=='ARM' (
  set TOOL_CHAIN=DEVTLS_ARMGCC
)
