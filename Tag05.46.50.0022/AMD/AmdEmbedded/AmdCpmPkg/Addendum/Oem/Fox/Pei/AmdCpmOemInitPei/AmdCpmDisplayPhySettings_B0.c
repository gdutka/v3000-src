...
/****************************************************************************\
*
*  File Name: displayphySettings.c
*  Projects:  ALL APUS
*
*  Description: This is a data file which stores the display Phy tuning settings.
*               The initial data will be privided by the Vbios team based on the PHY golden settings from the PHY team.
*               The customers can modify, add, or delete the data entries manually or by a tool, update this file after fine tuned their settings.
*               then send the file to Agesa team.
*               Agesa team will rebuild the Sbios once this file is updated.
*               GOP or CSM will copy the data into the Frame Buffer for DMCUB FW use.

*               Source file only compilied by SBIOS code
\****************************************************************************/
//New data table on July 12 
//Added a comma for HBR3 SW1 PE2  (12,                       //uint8_t tx_eq_post;)
//Updated DP2.0 UHBR10 P14 EQ (Pre from 8 to 10, main from 46 to 51, Post from 8 to 0) on Oct. 12, 2021 
...
ATOM_N6_DISPLAY_PHY_TUNING_SET display_phy_tuning_info_b0[] = {
...
// hbr2, 5.4G, PE0_VS0_0x0(PreEmphasis=0 and VolateSwing=0)
{
    ...
    0,                        //uint8_t tx_slew_en;
    0,                        //uint8_t tx_eq_pre;
    29,                       //uint8_t tx_eq_main; Ricky Chen changed it from 30 to 29
    0,                        //uint8_t tx_eq_post;
    0,                        //uint8_t tx_en_inv_pre;
    0,                        //uint8_t tx_en_inv_post;
    0,                        //uint8_t reserved3;
...
ATOM_COMMON_TABLE_HEADER table_header_b0 = {
  sizeof (display_phy_tuning_info_b0) + sizeof (ATOM_COMMON_TABLE_HEADER),    //uint16_t structuresize;
