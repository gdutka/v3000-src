...
ATOM_N6_DISPLAY_PHY_TUNING_SET display_phy_tuning_info_a0[] = {
...
ATOM_COMMON_TABLE_HEADER table_header_a0 = {
  sizeof (display_phy_tuning_info_a0) + sizeof (ATOM_COMMON_TABLE_HEADER),    //uint16_t structuresize;
