...
//     *BusClockHertz = HS_SPEED;
  ...
  //PLAT-42040 -  Set hcnt and lcnt same 0x580(for fox) for 50% duty cycle
  hcnt = 0x580;  // 0x1E8 for Standard Speed
  lcnt = 0x580;
  ...
  lcnt = i2c_dw_scl_lcnt(configI2C_CLOCK_HZ,
   ...
   //PLAT-42040 -  Set hcnt and lcnt same 0x117(for fox) for 50% duty cycle
  hcnt = 0x117;  // 0x72 for high Speed
  lcnt = 0x117;
