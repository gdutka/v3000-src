...
#!endif
  ...
  #
  # VariableName = CBS_SYSTEM_CONFIGURATION_NAME L"AmdSetup"
  # VendorGuid   = gCbsSystemConfigurationGuid
  #
  gAmdCpmPkgTokenSpaceGuid.PcdAmdVariableProtectionTable.ItemList[1].VariableName|L"AmdSetup"
  gAmdCpmPkgTokenSpaceGuid.PcdAmdVariableProtectionTable.ItemList[1].VendorGuid|{GUID({0x3A997502, 0x647A, 0x4c82, {0x99, 0x8E, 0x52, 0xEF, 0x94, 0x86, 0xA2, 0x47}})}

  #
  #
  # VariableName = AOD_SETUP_VARIABLE_NAME
  # VendorGuid   = gAodSystemConfigurationGuid
  #
  gAmdCpmPkgTokenSpaceGuid.PcdAmdVariableProtectionTable.ItemList[2].VariableName|L"AodSetup"
  gAmdCpmPkgTokenSpaceGuid.PcdAmdVariableProtectionTable.ItemList[2].VendorGuid|{GUID({0x5ed15dc0, 0xedef, 0x4161, {0x91, 0x51, 0x60, 0x14, 0xc4, 0xcc, 0x63, 0xc}})}

  #
  #
  # VariableName = AodCoreInfo
  # VendorGuid   = gAodSystemConfigurationGuid
  #
  gAmdCpmPkgTokenSpaceGuid.PcdAmdVariableProtectionTable.ItemList[3].VariableName|L"AodCoreInfo"
  gAmdCpmPkgTokenSpaceGuid.PcdAmdVariableProtectionTable.ItemList[3].VendorGuid|{GUID({0x5ed15dc0, 0xedef, 0x4161, {0x91, 0x51, 0x60, 0x14, 0xc4, 0xcc, 0x63, 0xc}})}

  #
  #
  # VariableName = AodCoreInfoTemp
  # VendorGuid   = gAodSystemConfigurationGuid
  #
  gAmdCpmPkgTokenSpaceGuid.PcdAmdVariableProtectionTable.ItemList[4].VariableName|L"AodCoreInfoTemp"
  gAmdCpmPkgTokenSpaceGuid.PcdAmdVariableProtectionTable.ItemList[4].VendorGuid|{GUID({0x5ed15dc0, 0xedef, 0x4161, {0x91, 0x51, 0x60, 0x14, 0xc4, 0xcc, 0x63, 0xc}})}
