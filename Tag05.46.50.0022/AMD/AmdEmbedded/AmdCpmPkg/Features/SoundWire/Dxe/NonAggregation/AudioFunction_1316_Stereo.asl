				...
				Name(BUF0, Buffer()
				{
					...
					0x04, 0x30, 0x00, 0x00, 0xA0,  // 0x0000_3004 A0
					0x05, 0x30, 0x00, 0x00, 0xB1,  // 0x0000_3005 B1
					...
					0x02, 0xD0, 0x00, 0x00, 0x9F,  // 0x0000_D002 9F
					0x03, 0xD0, 0x00, 0x00, 0x03,  // 0x0000_D003 03
					0x04, 0xD0, 0x00, 0x00, 0x9F,  // 0x0000_D004 9F
					0x0F, 0xC6, 0x00, 0x00, 0x01,  // 0x0000_C60F 01
					0x9E, 0xC0, 0x00, 0x00, 0x01,  // 0x0000_C09E 01
				}) //End AF04.BUF0

				Name(BUF1, Buffer()
				{
					0x0, 0x00,  // NotRotated, 0x01 = Left/Right
					0x1, 0x09,  // 90DegreesCounterClockwise, 0x09 = Derived Center
					0x2, 0x04,  // 180DegreesCounterClockwise, 0x04 = Right/Lefft
