	Name(_DSD, Package() 
	{
		...
		Package () 
		{
			...
			Package (2) {"mipi-sdw-source-port-list", 4}, // Integer, DP2/4/6
			Package (2) {"mipi-sdw-sink-port-list", 8}, // Integer,
			Package (2) {"mipi-sdw-dp-0-supported", 1} // Integer Boolean
		},
		ToUUID("dbb8e3e6-5886-4ba6-8795-1319f52a966b"), // Hierarchical Extension
		Package () 
		{
			//  Package (2) {"mipi-sdw-dp-0-subproperties", "DP0S"}, // this part is for DP0 which ALC711 Jack topology will not need
	...
	Name(BRA0, Package() 
	{
		...
		Package () 
		{
			Package (2) {"mipi-sdw-bra-mode-bus-frequency-configs",
	...
	Name(DP2S, Package() 
	{
		...
		Package () 
		{
			...
			Package (2) {"mipi-sdw-port-min-wordlength", 8},
			Package (2) {" mipi-sdw-port-wordlength-configs",           
