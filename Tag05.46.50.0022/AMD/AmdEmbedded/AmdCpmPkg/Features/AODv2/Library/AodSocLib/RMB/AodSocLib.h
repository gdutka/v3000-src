...
#include AOD_SOC_SETUP_DEFINITION(Rmb)

///
/// RMB ComboFalg
///
#define AOD_RMB_AM5_COMBO_FLAG    1
#define AOD_RMB_FP7R2_COMBO_FLAG  2
#define AOD_RMB_FP7_COMBO_FLAG    3
#define AOD_RMB_DISPATCH_INIT_DDR5_FLAG 1
#define AOD_RMB_DISPATCH_INIT_LDDR5_FLAG 2
///
/// RMB AOD Core Information
///
...
#define SMC_MSG_GetOverclockCap_RMB       0x5E
///
/// RMB AOD Memory UMC Information
///
...
#define PSTATE_INDEX(a)             (a * 0x100)
#define DRAM_CONFIGURATION(a)       (0x00000200 + PSTATE_INDEX(a))
#define DRAM_TIMING1(a)             (0x00000204 + PSTATE_INDEX(a))
#define DRAM_TIMING2(a)             (0x00000208 + PSTATE_INDEX(a))
#define DRAM_TIMING3(a)             (0x0000020C + PSTATE_INDEX(a))
#define DRAM_TIMING4(a)             (0x00000210 + PSTATE_INDEX(a))
#define DRAM_TIMING5(a)             (0x00000214 + PSTATE_INDEX(a))
#define DRAM_TIMING6(a)             (0x00000218 + PSTATE_INDEX(a))
#define DRAM_TIMING7(a)             (0x0000021C + PSTATE_INDEX(a))
#define DRAM_TIMING8(a)             (0x00000220 + PSTATE_INDEX(a))
#define DRAM_TIMING9(a)             (0x00000224 + PSTATE_INDEX(a))
#define DRAM_TIMING10(a)            (0x00000228 + PSTATE_INDEX(a))
#define DRAM_TIMING11(a)            (0x0000022C + PSTATE_INDEX(a))
#define DRAM_TIMING12(a)            (0x00000230 + PSTATE_INDEX(a))
#define DRAM_TIMING13(a)            (0x00000234 + PSTATE_INDEX(a))
#define DRAM_TIMING14(a)            (0x00000238 + PSTATE_INDEX(a))
#define DRAM_TIMING15(a)            (0x0000023C + PSTATE_INDEX(a))
#define DRAM_TIMING17(a)            (0x00000244 + PSTATE_INDEX(a))
#define DRAM_TIMING20(a)            (0x00000250 + PSTATE_INDEX(a))
#define DRAM_TIMING21(a)            (0x00000254 + PSTATE_INDEX(a))
#define DRAM_TIMING22(a)            (0x00000258 + PSTATE_INDEX(a))
#define DRAM_TIMING23(a)            (0x0000025C + PSTATE_INDEX(a))
#define DRAM_TRFC_TIMING_DIMM0(a)   (0x00000260 + PSTATE_INDEX(a))
#define DRAM_TRFC_TIMING_DIMM1(a)   (0x00000264 + PSTATE_INDEX(a))
#define DRAM_ODT_TIMING(a)          (0x00000280 + PSTATE_INDEX(a))
#define DRAM_REF_TIMING(a)          (0x000002C0 + PSTATE_INDEX(a))
...
#define SETUP_MANUAL_IGPU_OVERCLOCKING_LABLE                                    0x102
#define SETUP_DDR_AND_INFINITY_FABRIC_FREQUENCY_TIMINGS_LABLE                   0x103
#define SETUP_PRECISION_BOOST_OVERDRIVE_LABLE                                   0x104
#define SETUP_SOC_UNCORE_OC_MODE_LABLE                                          0x105
#define SETUP_SOC_VOLTAGE_LABLE                                                 0x106
#define SETUP_LN2_MODE_LABLE                                                    0x107
#define SETUP_ONBOARD_VOLTAGE_CONTROL_LABLE                                     0x108
#define SETUP_CPU_CORE_COUNT_CONTROL_LABLE                                      0x109
#define SETUP_DDR_OPTIONS_LABLE                                                 0x110
#define SETUP_INFINITY_FABRIC_FREQUENCY_AND_DIVIDERS_LABLE                      0x111
#define SETUP_DDR_TIMING_CONFIGURATION_LABLE                                    0x112
#define SETUP_DDR_BUS_CONFIGURATION_LABLE                                       0x113
#define SETUP_DDR_CONTROLLER_CONFIGURATION_LABLE                                0x114
#define SETUP_DDR_SPD_TIMING_LABLE                                              0x115
#define SETUP_DDR_NON_SPD_TIMING_LABLE                                          0x116


#define SETUP_DDR_POWER_OPTIONS_LABLE                                           0x119
#define SETUP_CURVE_OPTIMIZER_LABLE                                             0x11A
#define SETUP_GFX_CURVE_OPTIMIZER_LABLE                                         0x11B
#define SETUP_VDDIO_VOLTAGE_CONTROL_LABLE                                       0x11F
#define SETUP_VPP_VOLTAGE_CONTROL_LABLE                                         0x120
#define SETUP_VDDP_VOLTAGE_CONTROL_LABLE                                        0x121
#define SETUP_LCLK_FREQUENCY_CONTROL_LABLE                                      0x122
#define SETUP_VDD_MEM_VOLTAGE_CONTROL_LABLE                                     0x123
#define SETUP_VDD_MISC_LABLE                                                    0x124
// KEY function ID
...
#define KEY_AOD_VDD_MEM_ADJUST                                                  0x1017  //AodVddMemAdjust
#define KEY_AOD_RMP_PROFILE                                                     0x1018  //AodExpoProfile
#define KEY_AOD_RMP_MODE                                                        0x1019  //AodExpo
#define KEY_AOD_MEMORY_TARGET_SPEED                                             0x1020  //AodMemTargetSpeedDdr
// Label CBS ID
#define LABEL_CBS_AOD_DOWN_CORE_DYNAMIC_START                                   0x10B  //AodDownCoreDynamic Start Label
#define LABEL_CBS_AOD_DOWN_CORE_DYNAMIC_END                                     0x10C  //AodDownCoreDynamic End Label
#define LABEL_CBS_AOD_DOWN_CCD_DYNAMIC_START                                    0x10E  //AodDownCcdDynamic Start Label
#define LABEL_CBS_AOD_DOWN_CCD_DYNAMIC_END                                      0x10F  //AodDownCcdDynamic End Label
#define LABEL_CBS_AOD_PER_CORE_CURVE_OPTIMIZER_DYNAMIC_START                    0x11D  //AodPerCoreCurveOptimizerDynamic Start Label
#define LABEL_CBS_AOD_PER_CORE_CURVE_OPTIMIZER_DYNAMIC_END                      0x11E  //AodPerCoreCurveOptimizerDynamic End Label
#define LABEL_CBS_AOD_APU_VDD_IO_DYNAMIC_START                                  0x11F  //AodApuVddIo Start Label
#define LABEL_CBS_AOD_APU_VDD_IO_DYNAMIC_END                                    0x120  //AodApuVddIo End Label
#define LABEL_CBS_AOD_VDD_MEM_ADJUST_START                                      0x121  //AodVddMemAdjust Start Label
#define LABEL_CBS_AOD_VDD_MEM_ADJUST_END                                        0x122  //AodVddMemAdjust End Label
#define LABEL_CBS_AOD_RMP_START                                                0x123   //AodRMP Start Label
#define LABEL_CBS_AOD_RMP_END                                                  0x124   //AodRMP End Label

  /*Cmdid           ,   Name           ,     Property, Data Count, Data*/
#define AOD_WMI_LIST_RMB\
  ...
  {SET_TRCD                      , "Set Trcd"                    , 1   , 3   , {0x8, 0x3E, 0x1,}}, \
  {SET_TRP                       , "Set Trp"                     , 1   , 3   , {0x8, 0x3E, 0x1,}}, \
  {SET_TRAS                      , "Set Tras"                    , 1   , 3   , {0x1E, 0x7E, 0x1,}}, \
  {SET_TRC                       , "Set Trc"                     , 1   , 3   , {0x20, 0xFF, 0x1,}}, \
  {SET_TWR                       , "Set Twr"                     , 1   , 3   , {0x30, 0x60, 0x6,}}, \
  ...
  {SET_CADBUSADDRCMDDRVSTREN     , "Set CadBusAddrCmdDrvStren"   , 0   , 4   , {120,60,40,30,}},\
  {SET_PROCDATADRIVESTRENGTH     , "Set ProcDataDriveStrength"   , 0   , 8   , {0,2,4,6,0xc,0xe,0x1c,0x1e}}, \
  {SET_PROCODT                   , "Set ProcODT"                 , 0   , 20  , {3,0,5,0xe,0x3e,6,0x3d,7,0x3f,0x3c,0xf,\
    0x1e,0xd,0x1d,2,0x1c,0x1f,1,0xc,4,}}, \
  {SET_DRAMDATADRIVESTRENGTH     , "Set DRAMDataDriveStrength"   , 0   , 3   , {0,1,2,}}, \
  ...
  {SET_SCALAR                    , "Set Scalar"                  , 0   , 10  , \
    {500,700,600,900,400,100,300,200,800,1000,}}, \
  {SET_CCLK_FMAX                 , "Set CCLK Fmax"               , 1   , 3   , {0xFFFFFC18, 200, 25}}, \
  {SET_GFXCCLK_FMAX              , "Set GFXCCLK Fmax"            , 0   , 9   , {125,25,200,75,50,150,0,100,175,}}, \
  ...
  {SET_DIMM_VDDQ                 , "Set DIMM VDDQ"               , 1   , 3  , { 800, 1430, 10,}},\
  ...
  {SET_VDD_MEM                   , "Set VDD_MEM"                 , 1   , 3  , {530, 1030, 2,}},\
  {SET_VDD_MISC                  , "Set VDD_MISC"                , 1   , 3  , {500, 5600, 10,}},\
  {SET_UCLK_DIV1                 , "Set UCLK DIV1"               , 0   , 2  , {0, 1,}},\
  {SET_RMP_MODE                  , "Set RMP Mode"                , 0   , 2  , {0, 1,}},\
  {SET_RMP_PROFILE               , "Set RMP Profile"             , 0   , 2  , {0, 1,}},\
  {SET_RMP_PSTATE                , "Set RMP PState"              , 0   , 4  , {0, 1, 2, 3,}}

  /*Cmdid           ,   Name           ,     Property, Data Count, Data*/
#define AOD_WMI_LIST_RMB_FP7\
  {GET_INTERLEVAVINGCAP          , "Get Interlevaing Cap"        , 1   , 3   , {0, 0xffffffff, 1,}},\
  {SET_SOFTWARE_DOWN_CORE        , "Software Downcore Config"    , 1   , 3   , {0, 0xffffffff, 1,}},\
  {SET_CURVE_OPT                 , "Set Curve Optimizer"         , 1   , 3   , {0, 30, 1,}},\
  {SET_GFX_CURVE_OPT             , "Set GFX Curve Optimizer"     , 1   , 3   , {0, 30, 1,}},\
  ...
  {SET_FCLK_FREQUENCY            , "Set FCLK Frequency"          , 0   , 50  , {1533,2550,1633,2950,2850,1933,2267,\
    ...
    800,1500, 1967,2367,1433,1333,2100,2500,1600,1400,1667,1367,1800,2700,1200,1767,2033,2300, 2133,2233,}},\
  {SET_SOCVID                    , "Set SOC VID"                 , 1   , 3   , {0, 0x1FF, 1,}},\
  {SET_INTERLEAVEMODE            , "Set Interleave Mode"         , 0   , 2   , {0, 1}},\
  {SET_INTERLEAVESIZE            , "Set Interleave Size"         , 0   , 4   , {0, 1, 2, 3,}},\
  {SET_MEM_CLOCK                 , "Set Mem Clock"               , 0   , 4   , {3200, 1600, 2133, 2750,}}, \
  {SET_TRCPAGE                   , "Set Trcpage"                 , 1   , 3   , {0, 0x3ff, 1,}},\
  {SET_TCWL                      , "Set Tcwl"                    , 0   , 8   , {9, 0xa, 0xb, 0xc, 0xe, 0x10, 0x12, 0x14,}},\
  {SET_TCL                       , "Set Tcl"                     , 1   , 3   , {0x8, 0x21, 0x1,}}, \
  {SET_TRCDRD                    , "Set Trcdrd"                  , 1   , 3   , {0x8, 0x1b, 1,}},\
  {SET_TRCDWR                    , "Set Trcdwr"                  , 1   , 3   , {0x8, 0x1b, 1,}},\
  {SET_TRP                       , "Set Trp"                     , 1   , 3   , {0x8, 0x1b, 1,}}, \
  {SET_TRFC1                     , "Set Trfc1"                   , 1   , 3   , {0x3c, 0x3de, 0x1,}}, \
  {SET_TRAS                      , "Set Tras"                    , 1   , 3   , {0x15, 0x3a, 0x1,}}, \
  {SET_TRC                       , "Set Trc"                     , 1   , 3   , {0x1d, 0x87, 0x1,}}, \
  {SET_TRRDL                     , "Set TrrdL"                   , 1   , 3   , {0x4, 0xc, 0x1,}}, \
  {SET_TRRDS                     , "Set TrrdS"                   , 1   , 3   , {0x4, 0xc, 0x1,}}, \
  {SET_TFAW                      , "Set Tfaw"                    , 1   , 3   , {0x6, 0x36, 0x1,}}, \
  {SET_TWTRL                     , "Set TwtrL"                   , 1   , 3   , {0x2, 0xE, 0x1,}}, \
  {SET_TWTRS                     , "Set TwtrS"                   , 1   , 3   , {0x2, 0xE, 0x1,}}, \
  {SET_TWR                       , "Set Twr"                     , 1   , 3   , {0xA, 0x51, 0x1,}}, \
  {SET_TRDRDSCL                  , "Set TrdrdScL"                , 1   , 3   , {0x1, 0xF, 0x1,}}, \
  {SET_TWRWRSCL                  , "Set TwrwrScL"                , 1   , 3   , {0x1, 0x3F, 0x1,}}, \
  {SET_TRTP                      , "Set Trtp"                    , 1   , 3   , {0x5, 0xE, 0x1,}}, \
  {SET_TCKE                      , "Set Tcke"                    , 1   , 3   , {0x1, 0x1f, 0x1,}}, \
  {SET_TRDRDSC                   , "Set TrdrdSc"                 , 1   , 3   , {0x1, 0xF, 0x1,}}, \
  {SET_TRDRDDD                   , "Set TrdrdDd"                 , 1   , 3   , {0x1, 0xF, 0x1,}}, \
  {SET_TRDRDSD                   , "Set TrdrdSd"                 , 1   , 3   , {0x1, 0xF, 0x1,}}, \
  {SET_TWRWRSC                   , "Set TwrwrSc"                 , 1   , 3   , {0x1, 0xF, 0x1,}}, \
  ...
  {SET_TRDWR                     , "Set Trdwr"                   , 1   , 3   , {0x1, 0x1F, 0x1,}}, \
  {SET_POWERDWONEN               , "Set PowerDwonEn"             , 0   , 2   , {1,0,}}, \
  {SET_ADDRCMDSETUP              , "Set AddrCmdSetup"            , 1   , 3   , {0, 0x3f, 1, }}, \
  {SET_CSODTSETUP                , "Set CsOdtSetup"              , 1   , 3   , {0, 0x3f, 1, }}, \
  {SET_LCLK_FREQ                 , "Set LCLK Freq"               , 1   , 3   , {150, 2500, 1,}}
...
#endif
#ifndef APCB_TOKEN_UID_MEM_OC_VDDQ
/// @brief VDDQ Override
/// @details Type:UINT16
/// @li 800~1435
  #define APCB_TOKEN_UID_MEM_OC_VDDQ                                        0x814A6C32
#endif
#endif