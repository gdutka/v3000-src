 ...
 ******************************************************************************
 */
#ifndef _AOD_CONFIG_RPL_H_
#define _AOD_CONFIG_RPL_H_
#include <Features/AODv2/Include/AodSetup.h>
#define AOD_MAX_CCD_COUNT 2
...
typedef struct __AOD_CONFIG
{
  ...
  UINT8         AodMemDataBusCfgCtlDdr;                            /* Data Bus Configuration User Controls */
  UINT8         AodMemDataBusCfgRttNomWrDdr;                       /* RttNom_Wr */
  UINT8         AodMemDataBusCfgRttNomRdDdr;                       /* RttNom_Rd */
  UINT8         AodMemDataBusCfgRttWrDdr;                          /* RttWr */
  UINT8         AodMemDataBusCfgRttParkDdr;                        /* RttPark */
  UINT8         AodMemDataBusCfgRttParkDqsDdr;                     /* RttPark_Dqs */
  UINT8         AodMemDataBusCfgProcOdtDdr;                        /* ProcODT */
  UINT8         AodMemDataBusCfgProcDataDrvStrenDdr;               /* Proc Data Drive Strength */
  UINT8         AodMemDataBusCfgDramDataDrvStrenDdr;               /* DRAM Data Drive Strength */
  ...
  UINT8         AodCcdOptimizerFreqCtrl;                           /* CCD Frequency Optimizer Ctrl*/
  UINT16        AodCcdOptimizerFreq[AOD_MAX_CCD_COUNT];            /* CCD Frequency Optimizer */
  ...
  UINT8         AodVddgCtrl;                                       /* VDDG Voltage Control */
  UINT16        AodGlobalVddgCcdVoltage;                           /* Global VDDG CCD Voltage */
  UINT16        AodGlobalVddgIodVoltage;                           /* Global VDDG IOD Voltage */
  UINT16        AodPerCcdVddgVoltage[AOD_MAX_CCD_COUNT];           /* Per CCD VDDG CCD Voltage */
  UINT16        AodPerCcdVddgIODVoltage[AOD_MAX_CCD_COUNT];        /* Per CCD VDDG IOD Voltage */
