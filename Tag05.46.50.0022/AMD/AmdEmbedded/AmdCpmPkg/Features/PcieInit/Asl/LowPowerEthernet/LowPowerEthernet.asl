  ...
  )
{
  ...
  Scope(\_SB.PCI0.LPC0.EC0) {
    ...
    Method(CpmLowPowerEthernetCablePlugOutMethod, 0x0, Serialized) {
      ...
      Store (CpmReadTable32 (CpmLowPowerEthernetTable, CpmLowPowerEthernetLanLowPowerPin), Local2)
      If (LEqual (CpmReadGpio (Local2), 0x0)) {
    ...
    Method(CpmLowPowerEthernetCablePlugInMethod, 0x0, Serialized) {
      ...
      If (LEqual (CpmReadGpio (Local2), 0x1)) {
        CpmWriteGpio (Local2, 0x0)
        Sleep (300)
