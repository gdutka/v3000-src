...
#define CPM_CALLBACK_VAR_NAME
  ...
  #define CPM_SIGNATURE_64                EFI_SIGNATURE_64
  ...
  #define CFG_CPM_SWSMICMD_SETUMASIZEID   CPM_SWSMICMD_SETUMASIZEID
  ...
  #define CPM_SIGNATURE_64                SIGNATURE_64
  ...
  #define CFG_CPM_SWSMICMD_SETUMASIZEID   PcdGet8 (SwSmiCmdSetUmaSizeId)
