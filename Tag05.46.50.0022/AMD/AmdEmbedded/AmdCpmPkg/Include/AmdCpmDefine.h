...
#define CPM_PLATFORM_ID_OVERRIDE                  0xFFFF
  ...
  #define AMD_PLATFORM_ID_TABLE_SIZE              0x10
#endif
...
#ifndef AMD_CPM_NVME_D3C_CONFIG_SIZE
  #define AMD_CPM_NVME_D3C_CONFIG_SIZE            0x04
#endif

#ifndef UCSI_PORT_NUMBER
  #define UCSI_PORT_NUMBER                        0x3
#endif
...
#ifndef AMD_RES_RES_SIZE
  #define AMD_RES_RES_SIZE                        0x20
#endif

#ifndef EXPANDER_NUMBER
  #define EXPANDER_NUMBER                         0x4
#endif
  ...
  #define AMD_GPIO_DEVICE_POWER_SIZE              0x40
#endif
  ...
  #define AMD_DXIO_DDI_DESCRIPTOR_SIZE            0x05
#endif
...
#ifndef AMD_SMM_SYNC_FUNC_LIST_ITEM_SIZE
  #define AMD_SMM_SYNC_FUNC_LIST_ITEM_SIZE        0x40
#endif
...
#endif
#ifndef AMD_CPM_PCIE_GP19_NAME_4
  #define AMD_CPM_PCIE_GP19_NAME_4                '91PG'          // GP19
#endif
#ifndef AMD_CPM_PCIE_GP11_NAME_4
  #define AMD_CPM_PCIE_GP11_NAME_4                '11PG'          // GP11
#endif
#ifndef AMD_CPM_PCIE_GP12_NAME_4
  #define AMD_CPM_PCIE_GP12_NAME_4                '21PG'          // GP12
#endif
...
{(UINT16)gpio, (UINT16)((function <= 3 ? 0x800 : 0) + (function << 8) + (output < 3 ? (output < 2 ? output : 0x02) : 0x08) + \
((sticky == 1) || (pullup < 4) ? ((sticky == 1 ? 0x10 : 0) + (pullup == 0 ? 0x40 : 0) + \
(pullup == 1 ? 0x20 : 0) + (pullup == 3 ? 0x24 : 0) + 0x80) : 0)), 0}

//
// Multi Socket/Die GPIO Definition
//
#define GPIO_DEF_V2(socket, die, gpio, function, output, pullup) \
{(UINT16)gpio, (UINT16)((function <= 3 ? 0x800 : 0) + (function << 8) + \
(output < 3 ? (output < 2 ? output : 0x02) : 0x08) + \
(pullup == 0 ? 0x40 : 0) + (pullup == 1 ? 0x20 : 0) + (pullup == 3 ? 0x24 : 0) + 0x80), \
(UINT16)((socket << 7) + (die << 5) + (0 << 3))}

#define GPIO_DEF_V3(socket, die, bridge, gpio, function, output, pullup) \
{(UINT16)gpio, (UINT16)((function <= 3 ? 0x800 : 0) + (function << 8) + \
(output < 3 ? (output < 2 ? output : 0x02) : 0x08) + \
(pullup == 0 ? 0x40 : 0) + (pullup == 1 ? 0x20 : 0) + (pullup == 3 ? 0x24 : 0) + 0x80), \
(UINT16)((socket << 7) + (die << 5) + (bridge << 3))}

#define EC_GPIO_DEFINITION(gpio, output) \
{(UINT16)gpio, (UINT16)output, 0}

#define EC_GPIO_DEF_V2(gpio, output) \
{(UINT16)(0x200 + gpio), (UINT16)output, 0}

#define SMBUS_GPIO_DEF(smbusselect, smbus3bitaddress, gpio, output) \
{(UINT16)(0x600 + gpio), (UINT16)output, (UINT16)((smbusselect << 7) + 0x20 + smbus3bitaddress)}

#define SMBUS_GPIO_DEF_V2(smbusselect, slaveaddress, chip, port, gpio, output) \
{(UINT16)(0x600 + (chip << 6) + (port << 4) + gpio), (UINT16)output, (UINT16)((smbusselect << 7) + slaveaddress)}

#define I2C_GPIO_DEF_V2(i2cselect, slaveaddress , chip, port, gpio, output) \
{(UINT16)(0x700 + (chip << 6) + (port << 4) + gpio), (UINT16)output, (UINT16)((i2cselect << 13) + slaveaddress)}

//
// PROMONTORY GPIO DEFINITION
//
#define PT_GPIO_DEFINITION(gpio, OutEnB, Out, intEnb, intLevelTrigType, intType, intMask ) \
{(UINT16)gpio, (UINT16)(OutEnB + (Out << 1) + (intEnb << 2) + (intLevelTrigType << 3) + (intType << 4) + (intMask << 6))}

//
// GEVENT DEFINITION
//
#define GEVENT_DEFINITION(gevent, enable, scitrig, scilevel, smisci, scis0, scimap, smitrig, smicontrol) \
{(UINT16)gevent, (UINT16)(enable + (scitrig <= 1 ? scitrig << 1 : 1 << 10) + (scilevel << 2) + (smisci << 3) + (scis0 << 4) + (scimap << 5) + \
...
{(UINT8)deviceid, (UINT8)(enable + (assert << 2) + (deassert << 3) + (hotplug << 4))}

#define GPIO_DEVICE_CONFIG(deviceid, enable, assert, deassert) \
{(UINT8)deviceid, (UINT8)(enable + (assert << 2) + (deassert << 3))}

//
// GPIO DEVICE DETECTION DEFINITION
//
#define GPIO_DETECTION_TYPE0(deviceid, pin, value, misc) \
{(UINT8)deviceid, 0, (UINT16)pin, (UINT8)value, (UINT8)misc, 0, 0, 0, 0, 0, 0}
#define GPIO_DETECTION_TYPE1(deviceid, pin1, value1, misc1, pin2, value2, misc2) \
{(UINT8)deviceid, 1, (UINT16)pin1, (UINT8)value1, (UINT8)misc1, (UINT16)pin2, (UINT8)value2, (UINT8)misc2, 0, 0, 0}
#define GPIO_DETECTION_TYPE2(deviceid, pin1, value1, misc1, pin2, value2, misc2, pin3, value3, misc3) \
{(UINT8)deviceid, 2, (UINT16)pin1, (UINT8)value1, (UINT8)misc1, (UINT16)pin2, (UINT8)value2, (UINT8)misc2, (UINT16)pin3, (UINT8)value3, (UINT8)misc3}

//
// Internal Clock Request Definition
//
#define PCIE_INCLK(socket, die, clkid, clkreq, devid, devnum, funnum, slotchk) \
{(UINT8)clkid, (UINT8)clkreq, 0, 0, (UINT8)devid, (UINT8)devnum, (UINT8)funnum, (UINT8)slotchk, (UINT32)((socket << 24) + (die << 20) + (0 << 16) + (0 << 28))}

#define PCIE_CLKV2(socket, die, bridge, clkid, clkreq, devid, devnum, funnum, slotchk) \
{(UINT8)clkid, (UINT8)clkreq, 0, 0, (UINT8)devid, (UINT8)devnum, (UINT8)funnum, (UINT8)slotchk, (UINT32)((socket << 24) + (die << 20) + (bridge << 16) + (0 << 28))}

#define PCIE_CLKV3(socket, die, bridge, miscid, clkid, clkreq, devid, devnum, funnum, slotchk) \
{(UINT8)clkid, (UINT8)clkreq, 0, 0, (UINT8)devid, (UINT8)devnum, (UINT8)funnum, (UINT8)slotchk, (UINT32)((socket << 24) + (die << 20) + (bridge << 16) + (miscid << 28))}
...
#define CPM_GPIO_PIN(pin, value)    ((UINT32)(pin + (value << 16)))
#define CPM_GPIO_PIN_V2(socket, die, pin, value) \
((UINT32)(pin + (value << 16) + (socket << 31) + (die << 29)))
#define CPM_GPIO_PIN_V3(socket, die, bridge, pin, value) \
((UINT32)(pin + (value << 16) + (socket << 31) + (die << 29) + (bridge << 27)))

#define CPM_ECRAM_GPIO_PIN(pin, value) ((UINT32)((pin | 0x200) + (value << 16)))

#define CPM_SMBUS_GPIO_PIN(smbusselect, smbus3bitaddress, pin, value) \
((UINT32)(0x600 + (smbusselect << 31) + (0x20 << 24) + (smbus3bitaddress << 24) + pin + (value << 16)))

#define CPM_SMBUS_GPIO_V2(smbusselect, slaveaddress, chip, port, pin, value) \
((UINT32)(0x600 + (smbusselect << 31) + (slaveaddress << 24) + (chip << 6) + (port << 4) + pin + (value << 16)))

#define CPM_I2C_GPIO_V2(i2cselect, slaveaddress, chip, port, pin, value) \
((UINT32)(0x700 + (i2cselect << 21) + (slaveaddress << 24) + (chip << 6) + (port << 4) + pin + (value << 16)))
...
#define CPM_RESET_GPIO                          0     ///<   0: Set GPIO.
#define CPM_RESET_GPIO_CHECK                    1     ///<   1: Set GPIO and read back to check it's set. Max. time out is 100ms. when Mode = 0 or 1.
...
#ifndef CPM_SWSMICMD_SETUMASIZEID
  #define CPM_SWSMICMD_SETUMASIZEID             0xDE
#endif
...
#define  KB032                                  0x8000
#define  KB048                                  0xC000
#define  KB064                                  0x00010000
#define  KB128                                  0x00020000
#define  KB192                                  0x00030000
#define  KB256                                  0x00040000
#define  KB512                                  0x00080000
#define  KB768                                  0x000C0000

#define  MB000                                  0x00000000
#define  MB001                                  0x00100000
#define  MB002                                  0x00200000
#define  MB003                                  0x00300000
#define  MB004                                  0x00400000
#define  MB008                                  0x00800000
#define  MB012                                  0x00C00000
#define  MB016                                  0x01000000
#define  MB032                                  0x02000000
#define  MB048                                  0x03000000
#define  MB064                                  0x04000000
#define  MB128                                  0x08000000
#define  MB192                                  0x0C000000
#define  MB256                                  0x10000000
#define  MB512                                  0x20000000
#define  MB768                                  0x30000000
#define  GB001                                  0x40000000
#define  GB002                                  0x80000000
#define  GB003                                  0xC0000000
