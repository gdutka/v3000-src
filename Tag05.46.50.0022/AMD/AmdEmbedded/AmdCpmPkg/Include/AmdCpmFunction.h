...
typedef UINT8 (EFIAPI *AMD_CPM_GETBXBBUSNUMBER_FN) (
  IN       VOID                        *This
  );

typedef VOID (EFIAPI *AMD_CPM_CLEARBRBUSNUMBER_FN) (
  IN       VOID                        *This,
  IN       UINT8                       Bus
  );
...
typedef enum {
  AMD_CPM_SYNC_SMM_CPM_TABLE_CHECK_RUNTIME                                        = 0x00,
  AMD_CPM_SYNC_SMM_CPM_TABLE_FROM_RUNTIME                                         = 0x01,
  AMD_CPM_SYNC_SMM_CPM_TABLE_TO_RUNTIME                                           = 0x02
} AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_FLOW;

typedef enum {
  AMD_CPM_SYNC_SMM_CPM_TABLE_ALL                                                  = 0x0000,

  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_ADAPTIVE_S4_SMM_CALLBACK                        = 0x0101,


  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_DISCRETE_USB4_S3_BEFORE_PCI_RESTORE             = 0x0201,
  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_DISCRETE_USB4_S3_AFTER_PCI_RESTORE              = 0x0202,
  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_DISCRETE_USB4_S3_CALLBACK                       = 0x0203,
  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_DISCRETE_USB4_S4_CALLBACK                       = 0x0204,

  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_DISPLAY_FEATURE_RESTORE_SMM                     = 0x0301,
  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_DISABLE_DGPU_AUDIO_SW_SMI_SMM                   = 0x0302,
  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_DISPLAY_FEATURE_SET_AUTO_UMA_MODE_CALLBACK_SMM  = 0x0303,
  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_DISPLAY_FEATURE_SET_UMA_SIZE_ID_CALLBACK_SMM    = 0x0304,

  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_GPIO_INIT_S3_RESOTRE_CALLBACK                   = 0x0401,

  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_MEM_EYE_TOOL_SMM_DISPATCHER                     = 0x0501,

  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_THUNDERBOLT_RESTORE_SMM                         = 0x0601,
  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_THUNDERBOLT_SMM_CALLBACK                        = 0x0601,

  AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_OEM_USE_BASE                                    = 0x4000,

} AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_ID;


typedef EFI_STATUS (EFIAPI *AMD_CPM_SYNC_SMM_CPM_TABLE_FN) (
  IN       VOID                                    *This,
  IN       AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_ID      SyncId
  );

typedef EFI_STATUS (EFIAPI *AMD_CPM_SYNC_SMM_CPM_TABLE_CALLBACK_FN) (
  IN       VOID                                    *This,
  IN       AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_ID      SyncId,
  IN       AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_FLOW    SyncFlow
  );

typedef EFI_STATUS (EFIAPI *AMD_CPM_SYNC_SMM_REGISTER_SYNC_FN) (
  IN       VOID                                    *This,
  IN       AMD_CPM_SYNC_SMM_CPM_TABLE_SYNC_ID      SyncId,
...
typedef struct _AMD_CPM_COMMON_FUNCTION {
  ...
  AMD_CPM_PCIANDTHENOR32_FN           PciAndThenOr32;       ///< Read PCI register dword, perform a bitwise AND
                                                            ///<   followed by a bitwise inclusive OR, and writes
                                                            ///<   the result back to the PCI register
  AMD_CPM_SMNREAD8_FN                 SmnBxbRead8;          ///< Read Bixby SMN register byte
  AMD_CPM_SMNREAD16_FN                SmnBxbRead16;         ///< Read Bixby SMN register word
  AMD_CPM_SMNREAD32_FN                SmnBxbRead32;         ///< Read Bixby SMN register dword
  AMD_CPM_SMNWRITE8_FN                SmnBxbWrite8;         ///< Write Bixby SMN register byte
  AMD_CPM_SMNWRITE16_FN               SmnBxbWrite16;        ///< Write Bixby SMN register word
  AMD_CPM_SMNWRITE32_FN               SmnBxbWrite32;        ///< Write Bixby SMN register dword
  AMD_CPM_SMNREAD8_FN                 SmnRead8;             ///< Read SMN register byte
  AMD_CPM_SMNREAD16_FN                SmnRead16;            ///< Read SMN register word
  AMD_CPM_SMNREAD32_FN                SmnRead32;            ///< Read SMN register dword
  AMD_CPM_SMNWRITE8_FN                SmnWrite8;            ///< Write SMN register byte
  AMD_CPM_SMNWRITE16_FN               SmnWrite16;           ///< Write SMN register word
  ...
  AMD_CPM_SMNAND16_FN                 SmnAnd16;             ///< Read SMN register word, perform a bitwise AND
                                                            ///<   and write the result back to SMN register
  AMD_CPM_SMNAND32_FN                 SmnAnd32;             ///< Read SMN register dword, perform a bitwise AND
                                                            ///<   and write the result back to SMN register
  AMD_CPM_SMNOR8_FN                   SmnOr8;               ///< Read SMN register byte, perform a bitwise OR
                                                            ///<   and write the result back to SMN register
  AMD_CPM_SMNOR16_FN                  SmnOr16;              ///< Read SMN register word, perform a bitwise OR
                                                            ///<   and write the result back to SMN register
  AMD_CPM_SMNOR32_FN                  SmnOr32;              ///< Read SMN register dword, perform a bitwise OR
                                                            ///<   and write the result back to SMN register
  AMD_CPM_SMNANDTHENOR8_FN            SmnAndThenOr8;        ///< Read SMN register byte, perform a bitwise AND
                                                            ///<   followed by a bitwise inclusive OR, and writes
                                                            ///<   the result back to the SMN register
  AMD_CPM_SMNANDTHENOR16_FN           SmnAndThenOr16;       ///< Read SMN register word, perform a bitwise AND
                                                            ///<   followed by a bitwise inclusive OR, and writes
                                                            ///<   the result back to the SMN register
  AMD_CPM_SMNANDTHENOR32_FN           SmnAndThenOr32;       ///< Read SMN register dword, perform a bitwise AND
                                                            ///<   followed by a bitwise inclusive OR, and writes
                                                            ///<   the result back to the SMN register
  ...
  AMD_CPM_GETBXBBUSNUMBER_FN          GetBxbBusNumber;      ///< Get Bixby Upstream Bridge Bus Number
  AMD_CPM_CLEARBRBUSNUMBER_FN         ClearBrBusNumber;     ///< Clear Pcie Bridge Bus Number
  ...
  AMD_CPM_GETPTBRDEVADDR_FN           GetPtBrDevAddr;       ///< Get Promontory Pcie Bridge Bus/Device/Function Address
  ...
  AMD_CPM_SMBUSREAD_FN                ReadSmbus;            ///< Read byte/word/block from a device on SMBUS
  AMD_CPM_SMBUSWRITE_FN               WriteSmbus;           ///< Write byte/word/block to a device on SMBUS
  AMD_CPM_SMBUSREAD_FN                ReadI2C;              ///< Read bytes from a device on I2C
  AMD_CPM_SMBUSWRITE_FN               WriteI2C;             ///< Write bytes to a device on I2C
...
typedef struct _AMD_CPM_SMM_PUBLIC_FUNCTION {
  AMD_CPM_GETTABLEPTR_FN                 GetClonedRuntimeTablePtr;   ///< Get cloned Runtime CPM table
  AMD_CPM_GETTABLEPTR_FN                 GetRuntimeTablePtr;         ///< Get Runtime CPM table
  AMD_CPM_SYNC_SMM_CPM_TABLE_FN          SyncSmmCpmTableFromRuntime; ///< Sync SMM CPM table from Runtime
  AMD_CPM_SYNC_SMM_CPM_TABLE_FN          SyncSmmCpmTableToRuntime;   ///< Sync SMM CPM table to Runtime
  AMD_CPM_SYNC_SMM_REGISTER_SYNC_FN      RegisterSyncFunction;       ///< Register Sync Function
} AMD_CPM_SMM_PUBLIC_FUNCTION;
