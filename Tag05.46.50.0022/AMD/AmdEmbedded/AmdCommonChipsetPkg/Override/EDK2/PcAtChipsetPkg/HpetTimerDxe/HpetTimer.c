  ...
  )
{
  ...
  if (mTimerNotifyFunction != NULL) {
    ...
    //
//[-start-221207-IB14740272-modify]//
    if (MainCounter >= mPreviousMainCounter) {
//[-end-221207-IB14740272-modify]//
      //
...
//[-start-240515-IB20840056-modify]//
    //
...
//[-start-230821-IB20840018-modify]//
  SizeOfUintn = sizeof (UINTN);
  if (mTimerConfiguration.Bits.CounterSizeEnable == 1 && (SizeOfUintn == sizeof (UINT64))) {
