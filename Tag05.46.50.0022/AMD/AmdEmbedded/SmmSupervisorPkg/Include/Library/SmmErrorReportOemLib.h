/** @file
  Provides function interface for OEM to perform error report operation.
...
/**
  Interface open to OEM to conduct platform specific error logging when policy is violated.
...
/**
  ...
  @retval  SMM_SV_SET_OF_POLICY_VIOLATION_ACTION_DEFAULT    System will hang in debug or reset in release.
