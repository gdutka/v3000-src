...
(EFIAPI * AMD_NBIO_PCIE_TOPOLOGY_REMOVE_ENTRY) (
  IN  DXIO_COMPLEX_DESCRIPTOR         **TablePointer,                 ///< Get table pointer
  IN  UINT64                          EntryHandle,                    ///< Get entry handle
  OUT BOOLEAN                         *RemoveEntrySuccess             ///< ptr
  );
...
(EFIAPI * AMD_NBIO_PCIE_TOPOLOGY_INCREASE_TABLE_SIZE) (
  IN  DXIO_COMPLEX_DESCRIPTOR         **TablePointer,               ///< table ptr
  IN  UINTN                           NewSize,                      ///< new size
  OUT BOOLEAN                         *IncreaseSuccess              ///< increase ptr
  );
...
typedef struct _PEI_AMD_NBIO_PCIE_TOPOLOGY_PPI {
  ...
  AMD_NBIO_PCIE_TOPOLOGY_CREATE_TABLE         CreateTopologyTable;        ///< Topology table creation
  AMD_NBIO_PCIE_TOPOLOGY_INITIALIZE_ENTRY     InitializeTopologyEntry;    ///< Get ptr to initialized topology entry
  AMD_NBIO_PCIE_TOPOLOGY_ADD_PARAMETER        AddParameter;               ///< Adding parameters
  AMD_NBIO_PCIE_TOPOLOGY_REMOVE_ENTRY         RemoveEntry;                ///<  Removing entry
  AMD_NBIO_PCIE_TOPOLOGY_INCREASE_TABLE_SIZE  IncreaseTableSize;          ///<  Increasing the table size
