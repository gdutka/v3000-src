...
#ifndef _AMD_RAS_SMMGN_PROTOCOL_H_
#define _AMD_RAS_SMMGN_PROTOCOL_H_

#include "AmdRas.h"

extern EFI_GUID gAmdRasSmmGnProtocolGuid;
 ...
 *----------------------------------------------------------------------------------------
 */
typedef struct _AMD_RAS_SMMGN_PROTOCOL AMD_RAS_SMMGN_PROTOCOL;
...
(EFIAPI *MAP_SYMBOL_TO_DRAM_DEVICE) (
  IN       AMD_RAS_SMMGN_PROTOCOL *This,
...
/// Protocol Structure
struct _AMD_RAS_SMMGN_PROTOCOL {
...
#endif //_AMD_RAS_SMMGN_PROTOCOL_H_
