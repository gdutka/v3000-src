...
#ifndef _AMD_RAS_APEIRMB_PROTOCOL_H_
#define _AMD_RAS_APEIRMB_PROTOCOL_H_

#include "AmdRas.h"

extern EFI_GUID gAmdRasApeiRmbProtocolGuid;
 ...
 *----------------------------------------------------------------------------------------
 */
typedef struct _AMD_RAS_APEIRMB_PROTOCOL AMD_RAS_APEIRMB_PROTOCOL;
...
struct _AMD_RAS_APEIRMB_PROTOCOL {
...
#endif //_AMD_RAS_APEIRMB_PROTOCOL_H_
