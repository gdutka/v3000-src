...
#ifndef MAX_SOCKETS
  #define MAX_SOCKETS    FixedPcdGet8(PcdAmdMemMaxSocketSupportedV2)  ///< Max number of sockets in system
#endif

#ifndef MAX_DIES_PER_SOCKET
  #define MAX_DIES_PER_SOCKET    FixedPcdGet8(PcdAmdMemMaxDiePerSocketV2)  ///< Max number of dies per socket
#endif

#ifndef MAX_CHANNELS_PER_DIE
  #define MAX_CHANNELS_PER_DIE    FixedPcdGet8(PcdAmdMemMaxChannelPerDieV2)  ///< Max number of channels per die
#endif
...
#ifdef MAX_DIES_PER_SOCKET
  #undef MAX_DIES_PER_SOCKET
  #define MAX_DIES_PER_SOCKET    1
#endif
...
#ifdef MAX_CHIPSELECT_PER_CHANNEL
  #undef MAX_CHIPSELECT_PER_CHANNEL
