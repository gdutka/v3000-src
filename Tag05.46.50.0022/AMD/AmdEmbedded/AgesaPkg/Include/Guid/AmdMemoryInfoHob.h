...
/* $NoKeywords:$ */
/**
 * @file   AmdMemoryInfoHob.h
 * Amd Memory Info Hob definitionD.
 *
 */
...
/**
 * @brief  List constant used in the Memory Info HOB
 *
 */
typedef enum {
  // General
...
typedef struct _AMD_MEM_CFG_INFO_HOB {
  ...
  UINT16 MemCtrllerProcOdtDddr4Offset;                ///< Offset of MemCtrllerProcOdtDddr4 in the struct
  UINT16 MemCtrllerRttNomDddr4Offset;                 ///< Offset of MemCtrllerRttNomDddr4 in the struct
  UINT16 MemCtrllerRttWrDddr4Offset;                  ///< Offset of MemCtrllerRttWrDddr4 in the struct
  UINT16 MemCtrllerRttParkDddr4Offset;                ///< Offset of MemCtrllerRttParkDddr4 in the struct
  UINT16 MemCtrllerAddrCmdSetupDddr4Offset;           ///< Offset of MemCtrllerAddrCmdSetupDddr4 in the struct
  UINT16 MemCtrllerCsOdtSetupDddr4Offset;             ///< Offset of MemCtrllerCsOdtSetupDddr4 in the struct
  UINT16 MemCtrllerCkeSetupDddr4Offset;               ///< Offset of MemCtrllerCkeSetupDddr4 in the struct
  UINT16 MemCtrllerCadBusClkDrvStrenDddr4Offset;      ///< Offset of MemCtrllerCadBusClkDrvStrenDddr4 in the struct
  UINT16 MemCtrllerCadBusAddrCmdDrvStrenDddr4Offset;  ///< Offset of MemCtrllerCadBusAddrCmdDrvStrenDddr4 in the struct
  UINT16 MemCtrllerCsOdtCmdDrvStrenDddr4Offset;       ///< Offset of MemCtrllerCsOdtCmdDrvStrenDddr4 in the struct
  UINT16 MemCtrllerCkeDrvStrenDddr4Offset;            ///< Offset of MemCtrllerCkeDrvStrenDddr4Offset in the struct
...
///< Memory attribute in the memory descriptor
