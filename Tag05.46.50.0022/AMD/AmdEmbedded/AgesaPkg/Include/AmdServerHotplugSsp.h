...
#ifndef _AMD_SERVER_HOTPLUGSSP_H_
#define _AMD_SERVER_HOTPLUGSSP_H_
...
typedef struct  {
  IN      UINT32                    HotPlugFormat          :3;  /**< Hotplug Format
                                                                 ...
                                                                 */
  IN      UINT32                    Reserved0              :2;  ///< GPIO Descriptor revision
  ...
  IN      UINT32                    MasterSlaveAPU         :1;  /**< this bit indicates the APU (Master or Slave die) the PCIe device, that is
                                                                 ...
                                                                 */
  IN      UINT32                    DieID                  :1;  ///< Indicates the Die number in the system
  IN      UINT32                    PciePortInstance       :3;  ///< Indicates port number on the core
  IN      UINT32                    PcieTileInstance       :3;  /**< Indicates the Aperture ID assigned to the PCIe tile on the SMN network.
                                                                 ...
                                                                 */
  IN      UINT32                    BridgeOffset           :5;  //Logical bridge ID
  IN      UINT32                    Reserved1              :4;
  IN      UINT32                    AltSlotNum             :6;  /**< When the descriptor is used for an Enterprise SSD form-factor, and the slot
                                                                 ...
                                                                 */
  IN      UINT32                    SecondaryLink          :1;  /**< When the descriptor is used for an Enterprise SSD form-factor, this bit specifies whether the
                                                                 ...
                                                                 */
  IN      UINT32                    Reserved2              :1;  ///< Reserved for future use
} PCIE_HOTPLUG_MAPPING;
...
typedef struct  {
  ...
  IN      UINT32                    I2CGpioByteMapping     :3;  /**< I2C GPIO IO Byte Mapping : indicates which IO byte of the I2C GPIO device is used for the
                                                                 ...
                                                                 */
  IN      UINT32                    I2CGpioDeviceAddress   :5;  /**< I2C GPIO Device Address : indicates the I2C address for the I2C GPIO device 
  ...
  IN      UINT32                    I2CDeviceType          :2;  /**< I2C Device Type : indicates which of three I2C GPIO devices is used to host the hot-plug
                                                                 ...
                                                                 */
  IN      UINT32                    I2CBusSegment          :5;  /**< I2C Bus Segment :  in the context of an I2C subsystem constructed with PCA9545 I2C switches,
  ...
  IN      UINT32                    FunctionMask           :8;  /**< Function Mask : when the descriptor is used for a multi-bit hot-plug functional format,
                                                                 ...
                                                                 */
  IN      UINT32                    Reserved1              :6;  ///< Reserved for future use
...
typedef struct  {
  ...
  IN      UINT32                    I2CGpioByteSelect      :3;  /**< I2C GPIO IO Byte Mapping : indicates which IO byte of the I2C GPIO device is used for the
                                                                 *   hot-plug signals associated with this descriptor.
                                                                 */
  IN      UINT32                    I2CGpioDeviceAddress   :5;  /**< I2C GPIO Device Mapping : indicates the I2C address for the I2C GPIO device
                                                                 *   that is used to host the hot-plug signals associated with this descriptor.
                                                                 */
  IN      UINT32                    I2CDeviceType          :2;  /**< I2C Device Type : indicates which of three I2C GPIO devices is used to host the hot-plug
                                                                 *   signals associated with this descriptor.
...
#define  PCIE_HOTPLUG_INITIALIZER_MAPPING(mHotPlugFormat, mGpioDescriptorValid, mResetDescriptorValid, mPortActive, mMasterSlaveAPU, mDieNumber, \
                                         ...
                                         {mHotPlugFormat, 0, mResetDescriptorValid, mPortActive, mMasterSlaveAPU, mDieNumber, \
                                          0, 0, 0, 0, mAlternateSlotNumber, mPrimarySecondaryLink, 0},

#define  PCIE_HOTPLUG_INITIALIZER_FUNCTION(mI2CGpioBitSelector, mI2CGpioByteMapping, mI2CGpioDeviceMapping, mI2CDeviceType, mI2CBusSegment, mFunctionMask) \
                                          {mI2CGpioBitSelector, mI2CGpioByteMapping, mI2CGpioDeviceMapping, mI2CDeviceType, mI2CBusSegment & 7, mFunctionMask, 0},
...
#define  PCIE_HOTPLUG_INITIALIZER_NO_RESET() {0, 0, 0, 0, 0, 0, 0}
