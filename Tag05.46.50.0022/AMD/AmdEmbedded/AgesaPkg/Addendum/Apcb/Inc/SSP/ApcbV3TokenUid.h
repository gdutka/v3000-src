...
/// @DESC: DFE Read Training
/// @RANGE: BOOLEAN_ENABLE_1_DISABLE_0_AUTO_FF_VALIDVAL_INTERNAL
  #define APCB_TOKEN_UID_MEM_CTRLLER_PMU_TRAIN_DFE_DDR4                     0x36A4BB5B  //bool

/// @DESC: FFE Write Training
/// @RANGE: BOOLEAN_ENABLE_1_DISABLE_0_AUTO_FF_VALIDVAL_INTERNAL
...
/// @DESC: Disable Pcs CG
/// @RANGE: BOOLEAN_TRUE_FALSE_VALIDVAL
  #define APCB_TOKEN_UID_CBS_DF_CMN_DISABLE_PCS_CG                          0xB03D5AF9

/// @DESC: DF Watchdog Timer Control
/// @RANGE: BOOLEAN_ENABLE_1_DISABLE_0_AUTO_3_VALIDVAL_INTERNAL
  #define APCB_TOKEN_UID_DF_WDT_CTRL                                        0x5BBFF3D9  //uint8  //ToDo: Auto:3
...
/// @DESC: CCX_CPB
  #define APCB_TOKEN_UID_CCX_CPB                                            0x9DA294C2  //uint8

/// @DESC: CBS_CMN_CCX_SMT_CTRL
  #define APCB_TOKEN_UID_CCX_SMT_CTRL                                       0xB0A37D17  //uint8

/// @DESC: CBS_CCX_CCD_CTRL
  #define APCB_TOKEN_UID_CCX_CCD_CTRL                                       0x01B7B701  //uint8

/// @DESC: CBS_CCX_CORE_CTRL
...
/// @DESC: AOD_CCD1_CORE_CTRL
  #define APCB_TOKEN_UID_AOD_CCD1_CORE_CTRL                                 0xB31AFD41

/// @DESC: AOD_CCD2_CORE_CTRL
  #define APCB_TOKEN_UID_AOD_CCD2_CORE_CTRL                                 0xA13EA756

/// @DESC: AOD_CCD3_CORE_CTRL
  #define APCB_TOKEN_UID_AOD_CCD3_CORE_CTRL                                 0x79016F87

/// @DESC: AOD_CCD4_CORE_CTRL
  #define APCB_TOKEN_UID_AOD_CCD4_CORE_CTRL                                 0x4756B308

/// @DESC: AOD_CCD5_CORE_CTRL
  #define APCB_TOKEN_UID_AOD_CCD5_CORE_CTRL                                 0x3CE441F8

/// @DESC: AOD_CCD6_CORE_CTRL
  #define APCB_TOKEN_UID_AOD_CCD6_CORE_CTRL                                 0x47D5B872

/// @DESC: AOD_CCD7_CORE_CTRL
  #define APCB_TOKEN_UID_AOD_CCD7_CORE_CTRL                                 0x97E5A97A
...
/// @RANGE: 0~0xFF = UITN8 Valid Range
  #define APCB_TOKEN_UID_DIMMSENSORRESOLUTION                               0x831AF313  // uint8 //Obsolete.
...
/// @DESC: UMAMODE
/// @RANGE: 0~0xFF = UITN8 Valid Range
  #define APCB_TOKEN_UID_UMAMODE                                            0x1FB35295  // uint8 //Obsolete.
...
/// @RANGE: MEM_CTRLLER_DRAM_ECC_SYMBOL_SIZE_DDR4_VALIDVAL
...
/// @DESC: MEM_CTRLLER_MR6_VREF_DQ_CTRL_DDR4
/// @RANGE: UINT8_MANUAL_AUTO_0XFF_VALIDVAL_INTERNAL
...
/// @DESC: MEM_CTRLLER_CPU_VREF_TRAINING_SEED_CTR
/// @RANGE: UINT8_MANUAL_AUTO_0XFF_VALIDVAL_INTERNAL
...
/// @DESC: MEM_DFI_MRL_MARGIN_CTL_DDR4
/// @RANGE: UINT8_MANUAL_AUTO_0XFF_VALIDVAL_INTERNAL
  #define APCB_TOKEN_UID_CBS_CMN_MEM_DFI_MRL_MARGIN_CTL_DDR4                0xDC84BF34  // uint8
...
/// @DESC: MEM_TIMING_A_RD_PTR_MP0_CTL_DDR4
/// @RANGE: UINT8_MANUAL_AUTO_0XFF_VALIDVAL_INTERNAL
  #define APCB_TOKEN_UID_CBS_CMN_MEM_TIMING_A_RD_PTR_MP0_CTL_DDR4           0x5EE1C406  // uint8
...
/// @DESC: MEM_TIMING_A_RD_PTR_MP1_CTL_DDR4
/// @RANGE: UINT8_MANUAL_AUTO_0XFF_VALIDVAL_INTERNAL
  #define APCB_TOKEN_UID_CBS_CMN_MEM_TIMING_A_RD_PTR_MP1_CTL_DDR4           0x5935020F  // uint8
...
/// @DESC: OVERCLOCK_IOD_VDDG_VOLTAGE1
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_IOD_VDDG_VOLTAGE1                  0x74BB23EF  // uint16
/// @DESC: OVERCLOCK_IOD_VDDG_VOLTAGE2
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_IOD_VDDG_VOLTAGE2                  0xA077FA23  // uint16
/// @DESC: OVERCLOCK_IOD_VDDG_VOLTAGE3
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_IOD_VDDG_VOLTAGE3                  0x75935FAD  // uint16
/// @DESC: OVERCLOCK_IOD_VDDG_VOLTAGE4
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_IOD_VDDG_VOLTAGE4                  0xE2258E05  // uint16
/// @DESC: OVERCLOCK_IOD_VDDG_VOLTAGE5
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_IOD_VDDG_VOLTAGE5                  0xC92794C8  // uint16
/// @DESC: OVERCLOCK_IOD_VDDG_VOLTAGE6
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_IOD_VDDG_VOLTAGE6                  0x670BF162  // uint16
/// @DESC: OVERCLOCK_IOD_VDDG_VOLTAGE7
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_IOD_VDDG_VOLTAGE7                  0x7427C2E8  // uint16

/// @DESC: OVERCLOCK_CCD_VDDG_VOLTAGE
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_CCD_VDDG_VOLTAGE                   0xC286E57A  // uint16
/// @DESC: OVERCLOCK_CCD_VDDG_VOLTAGE1
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_CCD_VDDG_VOLTAGE1                  0xC74D6F5B  // uint16
/// @DESC: OVERCLOCK_CCD_VDDG_VOLTAGE2
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_CCD_VDDG_VOLTAGE2                  0xD824441F  // uint16
/// @DESC: OVERCLOCK_CCD_VDDG_VOLTAGE3
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_CCD_VDDG_VOLTAGE3                  0x872D6C3E  // uint16
/// @DESC: OVERCLOCK_CCD_VDDG_VOLTAGE4
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_CCD_VDDG_VOLTAGE4                  0xF92D51DE  // uint16
/// @DESC: OVERCLOCK_CCD_VDDG_VOLTAGE5
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_CCD_VDDG_VOLTAGE5                  0x6359F304  // uint16
/// @DESC: OVERCLOCK_CCD_VDDG_VOLTAGE6
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_CCD_VDDG_VOLTAGE6                  0xDC487FB9  // uint16
/// @DESC: OVERCLOCK_CCD_VDDG_VOLTAGE7
/// @RANGE: 0x0000~0x07FF = UITN16 Valid Range
  #define APCB_TOKEN_UID_CBS_CMN_GNB_SMU_CCD_VDDG_VOLTAGE7                  0x6F0A213D  // uint16
...
/// @DESC: FCH spread spectrum
/// @RANGE: 0x00~0x01 = UINT8 Valid Range
  #define APCB_TOKEN_UID_FCH_ACPI_SPREAD_SPECTRUM                           0x4367CBD2  // uint8
