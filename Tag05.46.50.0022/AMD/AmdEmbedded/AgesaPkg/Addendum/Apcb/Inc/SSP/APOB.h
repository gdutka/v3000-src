...
#define APOB_VERSION          0x0017      ///< AP0B Version
...
typedef struct {
  ...
  UINT32   MemPmuSmbOffset;               ///< Memory PMU SMB Offset
  ...
  UINT32   CcdLogToPhysMapOffset;         ///< CCD Map Offset
  ...
  UINT32   SysNpsOffset;                  ///< System NPS Offset
  UINT32   SysSLinkOffset;                ///< System S-Link Offset
  UINT32   DfDxioPhyFwOverrideInfoOffset; ///< DF DXIO Phy FW Override Table Offset
  UINT32   MemSpdDataOffset;              ///< Memory SPD Data OFfset
  UINT32   DdrPhyReplayBuffPhaseOffset[APOB_MEM_S3_DDR_PHY_REPLAY_MAX_ENTRIES]; ///< DDR Phy Replay Buffer Type Offset
...
#define MAX_APOB_MEM_DCT_BLOCK_SIZE  560
...
typedef struct {
  APOB_TYPE_HEADER     ApobTypeHeader;      ///< APOB Type Header
  SLINK_ADDR_MAP_INFO  SLinkInfo[4];        ///< S-Link address map information
...
#define MAX_GEN_REPLAY_BUFFER_ENTRIES 0x770ul
