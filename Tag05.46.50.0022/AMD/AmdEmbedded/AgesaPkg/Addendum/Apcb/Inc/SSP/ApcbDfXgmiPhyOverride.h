...
*    @TYPEID: APCB_DF_TYPE_XGMI_PHY_OVERRIDE
*    This data structure is used to pass xGMI override parameters to DXIO PHY FW
*/
typedef struct _XGMI_PHY_OVERRIDE_TABLE {
  XGMI_PHY_OVERRIDE_HEADER        Header;
  XGMI_PHY_OVERRIDE_LINK_ENTRY    LinkEntry[];
} XGMI_PHY_OVERRIDE_TABLE;
