...
#define APCB_BP_UMC_BEFORE_RRW                              BP_SHIFT (20) // Before RRW test
...
#define ABL_DBG_CMD_SCRIPT_SET_RRW_MEM_TEST 0xC001BB15    // Command from script to set RRW Memory Test
...
//
// Set RRW Memory Test Message Structure Definition
//
typedef union {
  struct {
    UINT32 RrwMemTest           : 1;
