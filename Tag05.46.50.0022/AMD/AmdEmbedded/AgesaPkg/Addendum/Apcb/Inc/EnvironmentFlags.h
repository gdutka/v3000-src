...
//
//  C2PMSG_99 (SMN address 0x3810A8C) will replace port 80 for ABL verbose messaging.
//  It is much faster, and in a 2P model, MP0 logging from the 2nd socket should be able to be retrieved.
