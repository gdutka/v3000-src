...
#if !APCB_TOKEN_BOOL_AUTOGEN_EMPTY
...
//  APCB_TOKEN_VAL_BOOL(APCB_TOKEN_UID_NAME), // Expand to use APCB_TOKEN_UID_NAME_VALUE
  ...
  //
  // CBS generated macro can expend here
  //
  APCB_CMN_TOKEN_BOOL_AUTOGEN
  APCB_DBG_TOKEN_BOOL_AUTOGEN
};

#endif // APCB_TOKEN_BOOL_AUTOGEN_EMPTY
