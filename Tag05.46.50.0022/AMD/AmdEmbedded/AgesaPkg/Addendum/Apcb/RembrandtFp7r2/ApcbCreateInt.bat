...
REM ============================================================================
SET APCB_VER=V3
SET APCB_BUILD_MODE_C_FLAGS=/D APCB_INTERNAL_BUILD=1
REM SET APCB_BIN_LIST_CUSTOM=ApcbDataDefaultRecovery ApcbDataUpdatable ApcbDataEventLog
SET APCB_BIN_LIST_CUSTOM=ApcbDataDefaultRecovery ApcbDataUpdatable ApcbDataUpdatable_68
SET APCB_BIN_FILE_BASE_NAME_SOC_VARIANT=FP7r2
...
REM ----------------------------------------------------------------------------
SET APCB_BIN_FILE_BASE_NAME=APCB_%APCB_BIN_FILE_BASE_NAME_SOC_VARIANT%_DefaultRecovery
SET APCB_BIN_FILE_CLONE_BASE_NAME=APCB_%APCB_BIN_FILE_BASE_NAME_SOC_VARIANT%
...
REM Set board list
REM ----------------------------------------
SET APCB_BOARD_LIST_SETUP_BAT=SetApcbBoardListInternal.bat
...
REM ----------------------------------------
SET APCB_DATA_FILE_LIST_SETUP_BAT=SetApcbDataFileListInternal.bat
...
REM Target APCB binary will be put in RELEASE_DIR
REM ----------------------------------------------------------------------------
SET APCB_BIN_FILE_BASE_NAME=APCB_%APCB_BIN_FILE_BASE_NAME_SOC_VARIANT%_Updatable
SET APCB_DATA_PREPROCESS_OUTPUT=1
...
REM Debug Instance
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\ApcbData_FP7r2_GID_0x3000_Type_TokenBooleanDebug
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\ApcbData_FP7r2_GID_0x3000_Type_Token1ByteDebug
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\ApcbData_FP7r2_GID_0x3000_Type_Token2BytesDebug
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\ApcbData_FP7r2_GID_0x3000_Type_Token4BytesDebug
...
REM Customize the APCB binary for boot time and runtime update binary
REM ============================================================================
IF NOT "%APCB_DATA_BIN_IN_BUILD%" == "ApcbDataUpdatable_68" GOTO END_ApcbDataUpdatable_68
IF NOT "!APCB_VER!" == "V3" GOTO SKIP_V3_UPDATABLE_68_TOKEN_FILES
ECHO APCB Data File setup for ApcbDataUpdatable_68 binary
REM ----------------------------------------------------------------------------
REM Target APCB binary will be put in RELEASE_DIR
REM ----------------------------------------------------------------------------
SET APCB_BIN_FILE_BASE_NAME=APCB_%APCB_BIN_FILE_BASE_NAME_SOC_VARIANT%_Updatable_68
SET APCB_DATA_PREPROCESS_OUTPUT=1
SET APCB_DATA_DIR=ApcbDataUpdatable_68
SET BOARD_NAME=.
SET APCB_DATA_TYPE_FILE_LIST=
REM APCB V3 Tokens
SET APCB_FILE_NAME=ApcbData_FP7r2_GID_0x3000_Type_TokenBoolean
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7r2_GID_0x3000_Type_Token1Byte
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7r2_GID_0x3000_Type_Token2Bytes
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7r2_GID_0x3000_Type_Token4Bytes
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7r2_GID_0x3000_Type_TokenBooleanDebug
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7r2_GID_0x3000_Type_Token1ByteDebug
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7r2_GID_0x3000_Type_Token2BytesDebug
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7r2_GID_0x3000_Type_Token4BytesDebug
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!

:SKIP_V3_UPDATABLE_68_TOKEN_FILES
EXIT /B 0
:END_ApcbDataUpdatable_68
REM ============================================================================
...
REM Target APCB binary will be put in RELEASE_DIR
REM ----------------------------------------------------------------------------
SET APCB_BIN_FILE_BASE_NAME=APCB_%APCB_BIN_FILE_BASE_NAME_SOC_VARIANT%_EventLog
SET APCB_DATA_PREPROCESS_OUTPUT=1
SET APCB_DATA_DIR=ApcbDataEventLog
SET BOARD_NAME=.
SET APCB_DATA_TYPE_FILE_LIST=
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\ApcbData_FP7r2_GID_0x1704_Type_DdrPostPackageRepair
...
REM ============================================================================
:START_BUILDING
IF NOT DEFINED APCB_BIN_LIST_CUSTOM SET APCB_BIN_LIST=ApcbDataDefaultRecovery ApcbDataUpdatable ApcbDataUpdatable_68 ApcbDataEventLog
...
:BUILD_ALL_C_SOURCES
  ...
  SET C_INCLUDE_PATH_FLAG=/I Include /I ..\Inc\RMB /I ..\Inc\Common
