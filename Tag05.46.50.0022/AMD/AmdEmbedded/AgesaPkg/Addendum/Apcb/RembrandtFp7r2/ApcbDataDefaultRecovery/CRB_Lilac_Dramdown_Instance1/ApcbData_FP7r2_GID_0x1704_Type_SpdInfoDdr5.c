...
#define  MAKE_SPD_INFO_REVISION(Revision)  {{0,sizeof(SPD_INFO_REVISION_S)},Revision},
...
#define  MAKE_SPD_DATA_BLOCK(Socket, Channel, Dimm, Block, Data)  {{2,sizeof(SPD_INFO_SPD_BLOCK_S)},MAKE_ID(Socket, Channel, Dimm, Block),0,{Data}},
...
typedef struct _SPD_INFO_BLOBS_S {
  SPD_INFO_REVISION_S       Revision;
  SPD_INFO_SPD_BLOCK_S      SpdBlock[];
} SPD_INFO_BLOBS_S;
