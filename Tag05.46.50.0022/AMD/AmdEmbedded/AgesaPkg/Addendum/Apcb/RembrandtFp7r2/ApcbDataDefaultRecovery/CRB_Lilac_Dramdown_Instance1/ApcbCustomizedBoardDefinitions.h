...
*/
#define BLDCFG_APCB_DATA_BOARD_MASK     APCB_BOARD_INSTANCE_1
...
#include <ApcbDdr5Spd_MT48B1G16_1R.h>

#define BLDCFG_SPD_INFO_DATA_BLOB_0  MAKE_SPD_INFO_REVISION(0)

#define BLDCFG_SPD_INFO_DATA_BLOB_2  MAKE_SPD_DATA_BLOCK(SOCKET_0,CHANNEL_A,DIMM_0,BLOCK_0,MT48B1G16_1R_BLOCK_0)
#define BLDCFG_SPD_INFO_DATA_BLOB_3  MAKE_SPD_DATA_BLOCK(SOCKET_0,CHANNEL_A,DIMM_0,BLOCK_1,MT48B1G16_1R_BLOCK_1)
#define BLDCFG_SPD_INFO_DATA_BLOB_4  MAKE_SPD_DATA_BLOCK(SOCKET_0,CHANNEL_A,DIMM_0,BLOCK_3,MT48B1G16_1R_BLOCK_3)
#define BLDCFG_SPD_INFO_DATA_BLOB_5  MAKE_SPD_DATA_BLOCK(SOCKET_0,CHANNEL_A,DIMM_0,BLOCK_8,MT48B1G16_1R_BLOCK_8)
#define BLDCFG_SPD_INFO_DATA_BLOB_6  MAKE_SPD_DATA_BLOCK(SOCKET_0,CHANNEL_B,DIMM_0,BLOCK_0,MT48B1G16_1R_BLOCK_0)
#define BLDCFG_SPD_INFO_DATA_BLOB_7  MAKE_SPD_DATA_BLOCK(SOCKET_0,CHANNEL_B,DIMM_0,BLOCK_1,MT48B1G16_1R_BLOCK_1)
#define BLDCFG_SPD_INFO_DATA_BLOB_8  MAKE_SPD_DATA_BLOCK(SOCKET_0,CHANNEL_B,DIMM_0,BLOCK_3,MT48B1G16_1R_BLOCK_3)
#define BLDCFG_SPD_INFO_DATA_BLOB_9  MAKE_SPD_DATA_BLOCK(SOCKET_0,CHANNEL_B,DIMM_0,BLOCK_8,MT48B1G16_1R_BLOCK_8)
