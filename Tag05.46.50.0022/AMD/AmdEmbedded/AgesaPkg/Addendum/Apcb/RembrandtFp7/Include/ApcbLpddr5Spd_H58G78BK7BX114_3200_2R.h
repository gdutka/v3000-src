...
#ifndef _APCB_LPDDR5_SPD_H58G78BK7BX114_3200_2R_H_
#define _APCB_LPDDR5_SPD_H58G78BK7BX114_3200_2R_H_

#define H58G78BK7BX114_3200_2R_BLOCK_0/*  //< [0-63] Base Configuration and DRAM Paramters                                       */ \
  ...
  0x15,                    /*  //< 2 Key Byte / DRAM Device  See DRAM Configuration Tab                                          */ \
  0x0E,                    /*  //< 3 Module Type Not Hybrid // Not Hybrid // Non Dimm solution                                   */ \
  0x26,                    /*  //< 4 SDRAM Density and Banks See DRAM Configuration Tab                                          */ \
  0x29,                    /*  //< 5 SDRAM Addressing See DRAM Configuration Tab                                                 */ \
  0xF5,                    /*  //< 6 SDRAM Packing Type See DRAM Configuration Tab                                               */ \
  ...
  0x00,                    /*  //< 11 Module Nominal Voltage, VDD VDD2 Voltage Supply (for MR13 OP[7])                           */ \
  0x49,                    /*  //< 12 Module Organization See DRAM Configuration Tab                                             */ \
  ...
  0x51,                    /*  //< 16 Signal Loading See DRAM Configuration Tab                                                  */ \
  0x00,                    /*  //< 17 Timebases MTB = 125ps FTB = 1ps                                                            */ \
  0x05,                    /*  //< 18 SDRAM Minimum Cycle time(tckAVGmin) See DRAM Configuration Tab                             */ \
  ...
  0xC8,                    /*  //< 24 Minimum CAS Latency Time (t AA min) See DRAM Configuration Tab                             */ \
  ...
  0xC0,                    /*  //< 29 Minimum Refresh Recovery Delay Time (t RFCab min), LSB See DRAM Configuration Tab          */ \
  0x08,                    /*  //< 30 Minimum Refresh Recovery Delay Time (t RFCab min), MSB See DRAM Configuration Tab          */ \
  0x60,                    /*  //< 31 Minimum Refresh Recovery Delay Time (t RFCpb min), LSB See DRAM Configuration Tab          */ \
  0x04,                    /*  //< 32 Minimum Refresh Recovery Delay Time (t RFCpb min), MSB See DRAM Configuration Tab          */ \
...
#define H58G78BK7BX114_3200_2R_BLOCK_1/*  //< [64-127] Base Configuration and DRAM Paramters                                     */ \
  ...
  0x00,                    /*  //< 123 Fine Offset for Minimum CAS Latency Time (t AA min) See DRAM Configuration Tab            */ \
  0xE7,                    /*  //< 124 Fine Offset for SDRAM Maximum Cycle Time (t CKAVG max) See DRAM Configuration Tab         */ \
  0x00,                    /*  //< 125 Fine Offset for SDRAM Minimum Cycle Time (t CKAVG min) See DRAM Configuration Tab         */ \
...
#define H58G78BK7BX114_3200_2R_BLOCK_2/*  //< [128-191] Module Specific Parameters                                               */ \
...
#define H58G78BK7BX114_3200_2R_BLOCK_3/*  //< [192-255] Module Specific Parameters                                               */ \
...
#define H58G78BK7BX114_3200_2R_BLOCK_4/*  //< [256-319] Hybrid Memory Parameters                                                 */ \
...
#define H58G78BK7BX114_3200_2R_BLOCK_5/*  //< [320-383] Module Manufaturing Information                                          */ \
  ...
  0x48,                    /*  //< 329 Module Part Number H                                                                      */ \
  0x35,                    /*  //< 330 Module Part Number 5                                                                      */ \
  0x38,                    /*  //< 331 Module Part Number 8                                                                      */ \
  0x47,                    /*  //< 332 Module Part Number G                                                                      */ \
  0x37,                    /*  //< 333 Module Part Number 7                                                                      */ \
  0x38,                    /*  //< 334 Module Part Number 8                                                                      */ \
  0x42,                    /*  //< 335 Module Part Number B                                                                      */ \
  0x4B,                    /*  //< 336 Module Part Number K                                                                      */ \
  0x37,                    /*  //< 337 Module Part Number 7                                                                      */ \
  0x42,                    /*  //< 338 Module Part Number B                                                                      */ \
  0x58,                    /*  //< 339 Module Part Number X                                                                      */ \
  0x31, 0x31,              /*  //< [340-341] Module Part Number 1                                                                */ \
  0x34,                    /*  //< 342 Module Part Number 4                                                                      */ \
  0x20, 0x20, 0x20, 0x20,  /*  //< [343-346] Module Part Number None                                                             */ \
  0x20, 0x20,              /*  //< [347-348] Module Part Number None                                                             */ \
  0x00,                    /*  //< 349 Module Revision Code None                                                                 */ \
  0x80,                    /*  //< 350 DRAM Manufacturer ID Code, LSB # continuation codes                                       */ \
  0xAD,                    /*  //< 351 DRAM Manufacturer ID Code, MSB SK Hynix                                                   */ \
  0x20,                    /*  //< 352 DRAM Stepping -Die                                                                        */ \
...
#define H58G78BK7BX114_3200_2R_BLOCK_6/*  //< [384-447] End User Programable                                                     */ \
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,\
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,\
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,\
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,\

#define H58G78BK7BX114_3200_2R_BLOCK_7/*  //< [448-511] End User Programable                                                     */ \
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,\
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,\
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,\
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,\

#define H58G78BK7BX114_3200_2R_SPD_DATA \
  H58G78BK7BX114_3200_2R_BLOCK_0 \
  H58G78BK7BX114_3200_2R_BLOCK_1 \
  H58G78BK7BX114_3200_2R_BLOCK_2 \
  H58G78BK7BX114_3200_2R_BLOCK_3 \
  H58G78BK7BX114_3200_2R_BLOCK_4 \
  H58G78BK7BX114_3200_2R_BLOCK_5 \
  H58G78BK7BX114_3200_2R_BLOCK_6 \
  H58G78BK7BX114_3200_2R_BLOCK_7 \

#endif  //_APCB_LPDDR5_SPD_H58G78BK7BX114_3200_2R_H_
