...
SET APCB_BIN_FILE_BASE_NAME_SOC_VARIANT=FP7
...
REM Debug Instance
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\ApcbData_FP7_GID_0x3000_Type_TokenBooleanDebug
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\ApcbData_FP7_GID_0x3000_Type_Token1ByteDebug
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\ApcbData_FP7_GID_0x3000_Type_Token2BytesDebug
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\ApcbData_FP7_GID_0x3000_Type_Token4BytesDebug
...
SET APCB_DATA_TYPE_FILE_LIST=
REM APCB V3 Tokens
SET APCB_FILE_NAME=ApcbData_FP7_GID_0x3000_Type_TokenBoolean
...
SET APCB_FILE_NAME=ApcbData_FP7_GID_0x3000_Type_Token1Byte
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7_GID_0x3000_Type_Token2Bytes
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7_GID_0x3000_Type_Token4Bytes
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7_GID_0x3000_Type_TokenBooleanDebug
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7_GID_0x3000_Type_Token1ByteDebug
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7_GID_0x3000_Type_Token2BytesDebug
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
SET APCB_FILE_NAME=ApcbData_FP7_GID_0x3000_Type_Token4BytesDebug
COPY /Y .\ApcbDataUpdatable\!APCB_FILE_NAME!.c .\ApcbDataUpdatable_68\!APCB_FILE_NAME!.c
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\!APCB_FILE_NAME!
...
SET BOARD_NAME=.
SET APCB_DATA_TYPE_FILE_LIST=
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% %BOARD_NAME%\ApcbData_FP7_GID_0x1704_Type_DdrPostPackageRepair
