...
#if (!APCB_TOKEN_U32_AUTOGEN_EMPTY) || (BUILD_BINARY_ENTRY == 0x68) || (BUILD_BINARY_ENTRY == 0x60)
...
//  APCB_TOKEN_VAL_U32(APCB_TOKEN_UID_NAME),  // Expand to use APCB_TOKEN_UID_NAME_VALUE
  ...
  // CBS Token Macros
  //
  APCB_CMN_TOKEN_U32_AUTOGEN
  APCB_DBG_TOKEN_U32_AUTOGEN
#if (BUILD_BINARY_ENTRY == 0x68)
  APCB_TOKEN_U32 (APCB_TOKEN_UID_CBS_SYNC_SIGNATURE, APCB_TOKEN_UID_CBS_SYNC_SIGNATURE_VALUE),
#elif (BUILD_BINARY_ENTRY == 0x60)
  APCB_TOKEN_U32 (APCB_TOKEN_UID_CBS_SYNC_SIGNATURE, 0),
#endif
};
