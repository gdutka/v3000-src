...
APCB_V3_TYPE_HEADER       ApcbTypeHeader = {
  ...
  APCB_MEM_TYPE_PS_DRAMDOWN_LPDDR4_MAX_FREQ,  // TypeId
...
PSCFG_MAXFREQ_ENTRY MaxFeqUDIMMDdr4 [] = {
	...
	//
	{ _1DIMM, 1, 1, 0, 0, DDR3733_FREQUENCY, UNSUPPORTED_DDR_FREQUENCY, UNSUPPORTED_DDR_FREQUENCY },
	{ _1DIMM, 1, 0, 1, 0, DDR3733_FREQUENCY, UNSUPPORTED_DDR_FREQUENCY, UNSUPPORTED_DDR_FREQUENCY },
};
