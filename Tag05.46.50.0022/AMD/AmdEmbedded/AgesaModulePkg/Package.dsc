...
[LibraryClasses]
  ...
  ## Ras Lib
  RasRmbBaseLib|AgesaModulePkg/Library/RasRmbBaseLib/RasRmbBaseLib.inf
...
!endif
  ...
  ## Ras Dxe Drivers
  AgesaModulePkg/Ras/AmdRasRmbApeiDxe/AmdRasRmbApeiDxe.inf
  AgesaModulePkg/Ras/AmdRasRmbDxe/AmdRasRmbDxe.inf

#[-start-220308-IB14740223-add]#
  AgesaModulePkg/Psp/AmdPspRomArmor3Smm/AmdPspRomArmor3Smm.inf
#[-end-220308-IB14740223-add]#

[PcdsFixedAtBuild]
  # AMD AGESA PI Name & Version string
  gEfiAmdAgesaModulePkgTokenSpaceGuid.PcdAmdPackageString|"AGESA!V9\0EmbeddedPI-FP7r2 1.0.0.C"
...
[PcdsDynamicDefault]
  ...
  gEfiAmdAgesaPkgTokenSpaceGuid.PcdPcieEcrcEnablement|TRUE
