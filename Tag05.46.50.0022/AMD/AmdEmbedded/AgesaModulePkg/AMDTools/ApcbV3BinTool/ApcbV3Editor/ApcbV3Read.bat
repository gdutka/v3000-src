...
echo ApcbV3Editor.bat -r %PROGRAM% %SRC_BIN_PATH% "!INPUT_HEADER_FILE!" %OUTXML_NAME% %SUBPROGRAM%

call ApcbV3Editor.bat -r %PROGRAM% %SRC_BIN_PATH% "!INPUT_HEADER_FILE!" %OUTXML_NAME% %SUBPROGRAM%
