...
echo ApcbV3Editor.bat -w %SRC_BIN_PATH% %OUT_BIN_PATH% "!INPUT_HEADER_FILE!" %INPUTXML_NAME% %SUBPROGRAM%

call ApcbV3Editor.bat -w %SRC_BIN_PATH% %OUT_BIN_PATH% "!INPUT_HEADER_FILE!" %INPUTXML_NAME% %SUBPROGRAM%
