...
typedef enum {
  ...
  TpAbl3DfMemClearTimeout                    = 0xE1C2, ///< ABL 3 DF Mem clear operation timeout
  ...
  // PMU test points
  TpProcMCRPmuFailed                         = 0xE0F8, ///< Failed MCR PMU training.
  ...
  TpAblErrorAbsenceAcPowerOrWlanApcbData              = 0xE332,  ///< ABL Error Absence of either or both AC-Power GPIO or WLAN GPIO Apcb Data
