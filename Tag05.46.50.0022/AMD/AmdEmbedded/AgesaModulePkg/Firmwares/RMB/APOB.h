...
#define ABL_APOB_MAX_CHANNELS_PER_DIE    4   ///< Max channels per die
#define ABL_APOB_MAX_DIMMS_PER_CHANNEL   2   ///< Max dimms per die
#define ABL_APOB_MAX_CS_PER_CHANNEL      4   ///< Max CS per channel
#define MAX_PMU_SMB_SIZE  0x4000   ///< Max PMU SMB size

#define MAX_DDR_PHY_ENTRY_SIZE  4

// Agesa Persistent Memory Status and Clear Reason
  #define MEM_CLEAR_RSN_COLDRESET          (0x1)
  #define MEM_CLEAR_RSN_MEMCLR_REQUESTED   (0x2)
  #define MEM_CLEAR_RSN_MEMCLR_UcERROR     (0x4)
  #define MEM_CLEAR_RSN_PMEM_DISABLED      (0x8)
  #define MEM_CLEAR_RSN_PMEM_CONF_INVALID  (0x10)
  #define MEM_CLEAR_RSN_PMEM_CTX_INVALID   (0x20)
  #define MEM_CLEAR_RSN_PMU_TRNG_DONE      (0x40)
  #define MEM_CLEAR_RSN_SYNCFLOOD          (0x80)
  #define MEM_CLEAR_RSN_S3ENTRY_TIMEOUT    (0x100)
  #define MEM_CLEAR_RSN_HWERR              (0x200)
  #define MEM_CLEAR_MP_EXRECOVERY          (0x400)
  #define MEM_CLEAR_STATE_CLEARED          (0x8000)
  #define MEM_CLEAR_STATE_NOTCLEARED       (0x4000)
  #define MEM_CLEAR_STATE_CLRDISABLED      (0x2000)

//Mcr context Validity Status (Higher Nibble - Reason; Lower Nibble - Validity 0/1)
  #define McrCtxInv_PartMismatch           (0x10)
  #define McrCtxInv_DateCodeIsInvalid      (0x20)
  #define McrCtxInv_DIMM_ConfIsUpdated     (0x30)
  #define McrCtxInv_APCB_Upated            (0x40)
  #define McrCtxInv_LoadApobToMp2SramFail0 (0x50)
  #define McrCtxInv_LoadApobToMp2SramFail1 (0x60)
  #define McrCtxInv_BootModeIsCold         (0x70)
  #define McrCtxInv_GetBootModeFail        (0x80)
  #define McrCtxInv_GetDataFromApobFail    (0x90)
  #define McrCtxInv_MemRestoreCtlDisable   (0xA0)
  #define McrCtxInv_SyncFloodBitDetected   (0xB0) //Indicates SyncFlood
  #define McrCtxInv_HwAssertDetected       (0xC0)
  #define McrCtxInv_S3EntryTimeOutDetected (0xD0)
  #define McrCtxInv_MPxExpRecoveryDetected (0xE0)

  #define McrCtxVal_InGuardBand            (0x11)
  #define McrCtxVal_InMaxValidRange        (0x21)
  #define McrCtxVal_BootModeIsNotCold      (0x31)

//PMem related HW Error Masks (Syncflood, Hw Asserts, S3 Entry Timeout, MPx Exp Recovery)
  #define PMEM_HWERR_SYNCFLOOD_MASK         (0x01)
  #define PMEM_HWERR_HW_ASSERT_MASK         (0x02)
  #define PMEM_HWERR_S3ENTRY_TIMEOUT_MASK   (0x04)
  #define PMEM_HWERR_MPx_EXP_RECOVERY_MASK  (0x08)
...
// Agesa APOB Defintions
  ...
  #define ABL_MEM_SOC_INIT_CONFIG_SIZE sizeof (APOB_MEM_SOC_INIT_CONFIG_STRUCT)
  #define ABL_MEM_RMP_INFO_SIZE  sizeof (APOB_MEM_RMP_INFO_STRUCT)
  #define ABL_MEM_GEN_CONFIG_SIZE sizeof (APOB_MEM_GENERAL_CONFIGURATION_INFO_TYPE_STRUCT)
  #define ABL_MEM_SYS_CONFIG_SIZE sizeof (APOB_MEM_SYSTEM_CONFIGURATION_INFO_TYPE_STRUCT)
  ...
  #define ABL_SYS_NPS_INFO_SIZE sizeof (APOB_SYSTEM_NPS_INFO_TYPE_STRUCT)
  #define ABL_SYS_SLINK_INFO_SIZE sizeof (APOB_SYSTEM_SLINK_INFO_TYPE_STRUCT)
  #define ABL_DF_DXIO_PHY_FW_OVERRIDE_TABLE_SIZE sizeof (APOB_DF_DXIO_PHY_FW_OVERRIDE_TABLE_STRUCT)
  #define ABL_CCX_LOGICAL_TO_PHYSICAL_MAP_SIZE (sizeof (APOB_CCX_LOGICAL_TO_PHYSICAL_MAP_TYPE_STRUCT))
  #define ABL_CCD_LOGICAL_TO_PHYSICAL_MAP_SIZE (sizeof (APOB_CCD_LOGICAL_TO_PHYSICAL_MAP_TYPE_STRUCT))
  ...
  #define MAX_MASTER_APOB_SIZE ABL_APOB_HEADER_SIZE + ABL_MEM_GEN_ERROR_SIZE + ABL_MEM_GEN_CONFIG_SIZE + ABL_MEM_SYS_CONFIG_SIZE + ABL_GEN_INFO_SIZE + ABL_S3_RESTORE_DATA_SIZE + ABL_MEM_PMU_SMB_SIZE + ABL_CCX_LOGICAL_TO_PHYSICAL_MAP_SIZE + ABL_EVENT_LOG_SIZE + ABL_MEM_SMBIOS_INFO_SIZE + ABL_S3_PHY_RESTORE_DATA_SIZE + ABL_MEM_NVDIMM_INFO_SIZE + ABL_MEM_RMP_INFO_SIZE
  ...
  #define ABL_MEM_PMU_TRAINING_FAILURE_INFO_SIZE  (sizeof (PMU_TRAINING_FAILURE_INFO_STRUCT))


#define APOB_SYS_MAP_STRUCT_SIZE sizeof (SYSTEM_MEMORY_MAP) + (17 * sizeof (MEMORY_HOLE_DESCRIPTOR))
...
typedef struct {
  ...
  UINT32   SysCxlOffset;              ///< System CXL Info [Master Only]
  UINT32   DfDxioPhyFwOverrideInfoOffset; ///< DF DXIO Phy FW Override Info [Master Only]
  UINT32   EnvFlagOffset;             ///< Environment Flags gotten from C2P 97/98
  ...
  UINT32   MemDdr5DimmHubRegOffset[ABL_APOB_MAX_SOCKETS_SUPPORTED*ABL_APOB_MAX_DIES_PER_SOCKET];      ///< Memory DDR5 DIMM hub register contents
...
typedef struct DPPRCL_REPAIR_REPORT_ENTRY {
  ...
  UINT32 Type:1;                      ///< [9:9] Repair Type 0 - Soft, 1 - Hard
  UINT32 DpprPresent:1;               ///< [10:10] DPPR Present
  UINT32 SpprPresent:1;               ///< [11:11] SPPR Present
  UINT32 Socket:1;                    ///< [12:12] SocketId
  UINT32 Channel:3;                   ///< [15:13] Channel Id
  UINT32 ChipSelect:2;                ///< [17:16] Chipselect 0 to 3
  UINT32 BankAddress:5;               ///< [22:18] Bank Address
...
typedef struct {
  ...
  UINT8    RttNomRd;         ///< RTT_NOM_RD
  UINT8    RttNomWr;         ///< RTT_NOM_WR
  UINT8    RttWr;            ///< RTT_WR
  UINT8    RttPark;          ///< RTT_PARK
  UINT8    DqsRttPark;       ///< DQS_RTT_PARK
  UINT8    DramDrv;          ///< DRAM_DRV
  UINT8    CkOdtA;           ///< CK_ODT Group A
  UINT8    CsOdtA;           ///< CS_ODT Group A
  UINT8    CaOdtA;           ///< CA_ODT Group A
  UINT8    CkOdtB;           ///< CK_ODT Group B
  UINT8    CsOdtB;           ///< CS_ODT Group B
  UINT8    CaOdtB;           ///< CA_ODT Group B
  UINT8    POdt;             ///< PODT
  UINT8    DqDrv;            ///< DQ Drv
  UINT8    AlertPu;          ///< Alert Pullup
  UINT8    CaDrv;            ///< CA Drv
...
typedef struct {
  ...
  UINT8 MemCtrllerProcOdtDddr4Current[ABL_APOB_MAX_CHANNELS_PER_DIE];     ///< Proc ODT current value set by APCB
  UINT8 MemCtrllerRttNomDddr4Current[ABL_APOB_MAX_CHANNELS_PER_DIE];      ///< RTT NOM current value set by APCB
  UINT8 MemCtrllerRttWrDddr4Current[ABL_APOB_MAX_CHANNELS_PER_DIE];       ///< RTT WR current value set by APCB
  UINT8 MemCtrllerRttParkDddr4Current[ABL_APOB_MAX_CHANNELS_PER_DIE];     ///< RTT PARK current value set by APCB
  UINT8 MemCtrllerAddrCmdSetupDddr4Current[ABL_APOB_MAX_CHANNELS_PER_DIE];   ///< Addr Cmd Setup current value set by APCB
  UINT8 MemCtrllerCsOdtSetupDddr4Current[ABL_APOB_MAX_CHANNELS_PER_DIE];     ///< Cs ODT Setup current value set by APCB
  UINT8 MemCtrllerCkeSetupDddr4Current[ABL_APOB_MAX_CHANNELS_PER_DIE];       ///< Cke Setup current value set by APCB
  UINT8 MemCtrllerCadBusClkDrvStrenDddr4Current[ABL_APOB_MAX_CHANNELS_PER_DIE];     ///< CAD Bus Clk Drv Strength current value set by APCB
  UINT8 MemCtrllerCadBusAddrCmdDrvStrenDddr4Current[ABL_APOB_MAX_CHANNELS_PER_DIE]; ///< CAD Bus Addr Cmd Drv Strength current value set by APCB
  UINT8 MemCtrllerCsOdtCmdDrvStrenDddr4Current[ABL_APOB_MAX_CHANNELS_PER_DIE];      ///< Cs Odt Drv Strength current value set by APCB
  UINT8 MemCtrllerCkeDrvStrenDddr4Current[ABL_APOB_MAX_CHANNELS_PER_DIE];           ///< Cke Drv Strength current value set by APCB
  OUT
  ...
  UINT32 DimmSize[ABL_APOB_MAX_CHANNELS_PER_DIE][ABL_APOB_MAX_DIMMS_PER_CHANNEL];
  APOB_MEM_CFG_INFO ChipselIntlv[ABL_APOB_MAX_CHANNELS_PER_DIE];
  APOB_MEM_CFG_INFO DramEcc;
  APOB_MEM_CFG_INFO DramParity;
  APOB_MEM_CFG_INFO AutoRefFineGranMode;
  APOB_MEM_CFG_INFO MbistTestEnable;
  APOB_MEM_CFG_INFO MbistAggressorEnable;
  APOB_MEM_CFG_INFO MbistPerBitSlaveDieReport;
  APOB_MEM_CFG_INFO DramTempControlledRefreshEn;
  APOB_MEM_CFG_INFO UserTimingMode;
  APOB_MEM_CFG_INFO UserTimingValue;
  APOB_MEM_CFG_INFO MemBusFreqLimit;
  APOB_MEM_CFG_INFO EnablePowerDown;
  APOB_MEM_CFG_INFO DramDoubleRefreshRate;
  APOB_MEM_CFG_INFO PmuTrainMode;
  APOB_MEM_CFG_INFO EccSymbolSize;
  APOB_MEM_CFG_INFO UEccRetry;
  APOB_MEM_CFG_INFO IgnoreSpdChecksum;
  APOB_MEM_CFG_INFO EnableBankGroupSwapAlt;
  APOB_MEM_CFG_INFO EnableBankGroupSwap;
  APOB_MEM_CFG_INFO DdrRouteBalancedTee;
  APOB_MEM_CFG_INFO NvdimmPowerSource;
  APOB_MEM_CFG_INFO OdtsCmdThrotEn;
  APOB_MEM_CFG_INFO OdtsCmdThrotCyc;
} APOB_MEM_GENERAL_CONFIGURATION_INFO_TYPE_STRUCT;

typedef struct {
  APOB_TYPE_HEADER  ApobTypeHeader;
  APOB_MEM_D5_BUS_CFG_INFO ChannelBusCfgInfo[ABL_APOB_MAX_CHANNELS_PER_DIE];
...
#define MAX_APOB_MEM_NB_BLOCK_SIZE 1532
#define MAX_APOB_MEM_DCT_BLOCK_SIZE  1116
...
#define MAX_APOB_MEM_MEM_INIT_DATA_BLOCK_SIZE 0x1000
#define MAX_APOB_MEM_PARAMETER_DATA_BLOCK_SIZE 0x1000
/// AMD APOB_GEN_CONFIGURATION_INFO Header
typedef struct {
  APOB_TYPE_HEADER  ApobTypeHeader;    ///< APOB Type Header
  OUT
...
typedef struct {
  ...
  UINT8 MemParameterBlock[MAX_APOB_MEM_PARAMETER_DATA_BLOCK_SIZE];
...
typedef struct {
  ...
  BOOLEAN           MemPsateEn;             ///< MemPstateEn
  BOOLEAN           IsRmpOcEnabled;        ///< IsRmpOcEnabled
  UINT32            RmpOcMemClk;           ///< RmpOcMemClk
  UINT32            RmpOcVdd;              ///< RmpOcVdd
...
#define CCD_MAX_COMPLEXES_PER_CCD  2  // Program dependent
#if defined(BUILD_TARGET_IS_RS) && (BUILD_TARGET_IS_RS == TRUE)
#define CCD_MAX_CCDS_PER_DIE       12  // Program dependent
#else
...
typedef struct {
  UINT8                 PhysCcdNumber;
  LOGICAL_COMPLEX_INFO  ComplexMap[CCD_MAX_COMPLEXES_PER_CCD];
} LOGICAL_CCD_INFO;

/// AMD APOB_CCD_LOGICAL_TO_PHYSICAL_MAP_TYPE Header
typedef struct {
  APOB_TYPE_HEADER  ApobTypeHeader;    ///< APOB Type Header
  LOGICAL_CCD_INFO  CcdMap[CCD_MAX_CCDS_PER_DIE];
...
typedef struct {
  ...
  MEMORY_HOLE_DESCRIPTOR  AdditionalHoleInfo[17];
} APOB_SYSTEM_MEMORY_MAP_TYPE_STRUCT;

typedef struct {
  BOOLEAN  Capable;
  BOOLEAN  Enabled;
  UINT32   CumulativeSize;
} INTERLEAVING_INFO;

typedef struct {
  INTERLEAVING_INFO  Socket;
  INTERLEAVING_INFO  EightWay[2];
  INTERLEAVING_INFO  SixWay[2];
  INTERLEAVING_INFO  FourWaySpecialCase[2];
  INTERLEAVING_INFO  FourWaySymmetric[2][2];
  INTERLEAVING_INFO  TwoWay[2][4];
  INTERLEAVING_INFO  None[2][8];
} SYSTEM_INTERLEAVING;
...
typedef struct {
  ...
  SYSTEM_INTERLEAVING  SystemInterleaving;  ///< System Interleaving Info
...
// DF DXIO
#define MAX_DF_DXIO_PHY_FW_OVERRIDE_TABLE_SIZE 0x100  // Max size should be 150 bytes, but allocate more just in case
...
#define MAX_GEN_REPLAY_BUFFER_ENTRIES 0x800ul
#define MAX_PHY_REPLAY_BUFFER_ENTRIES 0x500ul

/// Entry for the S3 replay buffer (direct register access).
typedef struct {
  _4BYTE_ALIGN UINT32 Address;    ///< Register address
  _4BYTE_ALIGN UINT32 Value;      ///< Register value
} GEN_REPLAY_BUFFER_ENTRY;

/// Entry for the S3 replay buffer (indirect register access).
typedef struct {
...
typedef struct {
  APOB_TYPE_HEADER  ApobTypeHeader;                     ///< APOB Type Header
  UINT32 nextEmptyEntry;
  PMU_TRAINING_FAILURE_INFO_ENTRY  FailureEntry[40];
} PMU_TRAINING_FAILURE_INFO_STRUCT;

/**
 * @brief Jedec_DDR5_SPD5xx8_Hub_1v0.pdf, DIMM hub register contents
 *
 */
typedef struct {
  uint8_t  MR12;      ///< DIMM Hub MR12
  uint8_t  MR13;      ///< DIMM Hub MR13
} APOB_D5_HUB_REG_STRUCT;

/**
 * @brief APOB struct for DDR5 DIMM hub register contents
 *
 */
typedef struct {
  APOB_TYPE_HEADER        ApobTypeHeader;                                                              ///< APOB Type Header
  APOB_D5_HUB_REG_STRUCT  DimmHubReg[ABL_APOB_MAX_CHANNELS_PER_DIE * ABL_APOB_MAX_DIMMS_PER_CHANNEL];  ///< DDR5 hub register contents
} APOB_MEM_D5_HUB_REG_STRUCT;
...
typedef struct {
  ...
  APOB_MEM_SYSTEM_CONFIGURATION_INFO_TYPE_STRUCT   MemSystemCfg;
  APOB_MEM_GENERAL_ERRORS_TYPE_STRUCT              MemGeneralErrors;
  APOB_GEN_INFO_TYPE_STRUCT                        GeneralInfo;
  APOB_MEM_SOC_INIT_CONFIG_STRUCT                  MemSocInitConfig;
  APOB_MEM_RMP_INFO_STRUCT                         MemRmpInfo;
  ...
  APOB_CCD_LOGICAL_TO_PHYSICAL_MAP_TYPE_STRUCT     CcdMap;
  EVENT_LOG_STRUCT                                 EventLog;
  APOB_MEM_DIMM_SPD_DATA_UNION_STRUCT              SpdData;
  PMU_TRAINING_FAILURE_INFO_STRUCT                 PmuTrainingFailure;
  APOB_MEM_D5_HUB_REG_STRUCT                       MemDdr5HubReg;
  APOB_REPLAY_BUFFER_PHY_TYPE_STRUCT               S3ReplayPhyData[APOB_MEM_S3_DDR_PHY_REPLAY_MAX_ENTRIES];
...
typedef struct {
  ...
  UINT8     WorkloadProfile;             ///< Workload Profile
...
typedef struct {
  APOB_ENV_FLAGS_STRUCT                     EnvFlags;
  APOB_AGESA_CONFIG_DB_STRUCT               ConfigData;
  ...
  APOB_SYSTEM_CXL_INFO_TYPE_STRUCT          SystemCxlInfo;
  APOB_DF_DXIO_PHY_FW_OVERRIDE_TABLE_STRUCT DfDxioPhyFwOverrideInfo;
  APOB_SYSTEM_NPS_INFO_TYPE_STRUCT          SystemNpsInfo;  //Code is assuming this entry always be the last element of the structure.
} APOB_GLOBAL_DATA;

typedef struct {
  APOB_HEADER                 Header;
  APOB_GLOBAL_DATA            GlobalData;
  APOB_COMMON_DIE_DATA        CommonDieData[ABL_APOB_MAX_SOCKETS_SUPPORTED];
  } APOB_DATA;
