...
#include "Filecode.h"
#define FILECODE FCH_KEITH_FCHKEITHCORE_KEITH_KTXGBE_KTXGBELIB_FILECODE
...
/**
 * FchKtXgbePortClockGate - Clock Gate xGbE port
 *
 *
 ...
 */
VOID
FchKtXgbePortClockGate (
  IN  UINT32   DieBusNum,
  IN  UINT8    Port
  )
{
  FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_CLK_GATE + Port * 4, ~(UINT32)BIT0, BIT0, NULL);
}

/**
 * FchKtXgbePortPlatformConfig - Initialize xGbE port
 *
 *
 * @param[in] DieBusNum  Bus Number of current Die
...
//<Embedded_Override_End>
  ...
  SystemPort &= 0xFF;
  FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_PROPERTY0 + PortNum * 0x20, 0xFFFFFF00, SystemPort, NULL);

  XgbePortProperty = (UINT32) (FchXgbePort->XgbePortPlatformConfig) << 8;
  XgbePortProperty |= (UINT32) (FchXgbePort->XgbePortSupportedSpeed) << 22  ;
  XgbePortProperty |= (UINT32) (FchXgbePort->XgbePortConnectedType) << 28;
  FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_PROPERTY0 + PortNum * 0x20, 0x0870F0FF, XgbePortProperty, NULL);
//<Embedded_Override_Start>
  //FCH_KT_XGBE_PORT0_PROPERTY1
  /// -  0000: 1 DMA Rx Channel
  /// -  0001: 2 DMA Rx Channels
  /// -  ..
  /// -  1111: 16 DMA Rx
  ...
  FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_PROPERTY1 + PortNum * 0x20, 0x0, XgbePortProperty, NULL);

  //FCH_KT_XGBE_PORT0_PROPERTY2
  ...
  FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_PROPERTY2 + PortNum * 0x20, 0x0, XgbePortProperty, NULL);
//<Embedded_Override_End>
  ...
  if (FchXgbePort->XgbePortConnectedType == 1) {
    ...
    FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_PROPERTY3 + PortNum * 0x20, 0x000008FF, XgbePortProperty, NULL);
    ...
    FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_PROPERTY4 + PortNum * 0x20, 0x000008FF, XgbePortProperty, NULL);
    ...
    FchSmnRW (
      DieBusNum,
      FCH_KT_XGBE_PAD_MUX0,
      ~(UINT32)(0x0F << (PortNum * 8)),
      (UINT32) (FchXgbePort->XgbaPortPadI2C) << (PortNum * 8),
      NULL
      );
    ...
    FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_PROPERTY0 + PortNum * 0x20, 0xFFF0FFFF, XgbePortProperty, NULL);
    ...
    if (FchXgbePort->XgbePortMdioResetType == 1) {
      ...
      FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_PROPERTY3 + PortNum * 0x20, 0xFFFF08FC, XgbePortProperty, NULL);
      ...
      FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_PROPERTY3 + PortNum * 0x20, 0xFFFFFFCC, XgbePortProperty, NULL);

      // GPIO PAD
      FchSmnRW (
        DieBusNum,
        FCH_KT_XGBE_PAD_MUX1,
        ~(UINT32)(0x0F << (PortNum * 8)),
        (UINT32) (FchXgbePort->XgbaPortPadGpio) << (PortNum * 8),
        NULL
        );
    }
    ...
    FchSmnRW (
      DieBusNum,
      FCH_KT_XGBE_PAD_MUX0,
      ~(UINT32)(0xF0 << (PortNum * 8)),
      (UINT32) (FchXgbePort->XgbaPortPadMdio) << (PortNum * 8 + 4),
      NULL
      );
  }
  ...
  if (FchXgbePort->XgbaPortRedriverPresent) {
    ...
    FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_PROPERTY4 + PortNum * 0x20, 0x0000FFFF, XgbePortProperty, NULL);
  }
}

/**
 * FchKtXgbePortMacAddress - Initialize xGbE port
 *
 *
 * @param[in] DieBusNum  Bus Number of current Die
 * @param[in] PortNum    Port Number in current Die
  ...
  )
{
  ...
  FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_MAC_ADDR_LOW + PortNum * 0x8, 0x00, FchXgbeMacAddress, NULL);

  FchXgbeMacAddress = FchXgbePortMac->XgbePortMacAddressHigh;
  FchXgbeMacAddress &= 0xFFFF;
  FchXgbeMacAddress |= BIT31;
  FchSmnRW (DieBusNum, FCH_KT_XGBE_PORT0_MAC_ADDR_HIGH + PortNum * 0x8, 0x00, FchXgbeMacAddress, NULL);
}

/**
 * FchKtXgbePortPtpInit - Initialize xGbE port
 *
 *
 * @param[in] DieBusNum  Bus Number of current Die
 * @param[in] PortNum    Port Number in current Die
