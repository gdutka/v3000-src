...
#define FILECODE LIBRARY_MEMSMBIOSV2RMBLPD5LIB_MEMSMBIOSV2LIB_FILECODE
/*----------------------------------------------------------------------------
...
//  UINT32 ManufacturerIdCode;
  ...
  if (PhysicalDimm->DimmPresent) {
    ...
    case DEVICE_TYPE_LPDDR4:
    case DEVICE_TYPE_LPDDR4X:
  ...
  InitSmbios33Type17 (PhysicalDimm->DimmPresent, DimmSpd, T17);
