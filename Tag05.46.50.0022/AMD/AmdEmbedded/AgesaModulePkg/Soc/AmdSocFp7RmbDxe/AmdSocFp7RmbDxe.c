...
#include "AmdSocFp7RmbDxe.h"

#define FILECODE SOC_AMDSOCFP7RMBDXE_AMDSOCFP7RMBDXE_FILECODE
...
/*********************************************************************************
 * Name: AmdSocFp7RmbDxeInit
 *
 * Description
 *   Entry point of the AMD SOC Cezanne FP7 DXE driver
  ...
  )
{
  ...
  DEBUG ((EFI_D_ERROR, "*****************************DXE SOC FP7 RMB Driver Entry*********************\n"));
  ...
  DEBUG ((EFI_D_ERROR, "*****************************DXE SOC FP7 RMB Driver Exit*********************\n"));
  return (Status);
}
