...
#define BLDCFG_SPD_CH_A_DIMM1_ADDRESS      0xA2

#define BLDCFG_SPD_CH_B_DIMM0_ADDRESS      0xA4
#define BLDCFG_SPD_CH_B_DIMM1_ADDRESS      0xA6

#define BLDCFG_SPD_CH_C_DIMM0_ADDRESS      0xA8
#define BLDCFG_SPD_CH_C_DIMM1_ADDRESS      0xAA

#define BLDCFG_SPD_CH_D_DIMM0_ADDRESS      0xAC
#define BLDCFG_SPD_CH_D_DIMM1_ADDRESS      0xAE

#define BLDCFG_SPD_CH_E_DIMM0_ADDRESS      0xA0
#define BLDCFG_SPD_CH_E_DIMM1_ADDRESS      0xA2

#define BLDCFG_SPD_CH_F_DIMM0_ADDRESS      0xA4
#define BLDCFG_SPD_CH_F_DIMM1_ADDRESS      0xA6

#define BLDCFG_SPD_CH_G_DIMM0_ADDRESS      0xA8
#define BLDCFG_SPD_CH_G_DIMM1_ADDRESS      0xAA

#define BLDCFG_SPD_CH_H_DIMM0_ADDRESS      0xAC
