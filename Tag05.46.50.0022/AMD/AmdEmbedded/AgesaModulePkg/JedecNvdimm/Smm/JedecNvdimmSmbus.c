...
#include <Addendum/Apcb/Inc/SSP/ApcbMemDimmInfoSmbus.h>
 ...
 *----------------------------------------------------------------------------------------
 */
#define FILECODE JEDECNVDIMM_SMM_JEDECNVDIMMSMBUS_FILECODE

// There are conflicts between APCB related include files and AGEAS.h
// So, directly define here
#define APCB_GROUP_MEMORY                              0x1704
#define APCB_MEM_TYPE_DIMM_INFO_SMBUS               0x0031
#define MAX_NUM_DIMM_INFO_ENTRIES sizeof (DimmInfoSmbus) / sizeof (DimmInfoSmbus[0])
...
//DIMM_INFO_SMBUS DimmInfoSmbus[32] = {0};
DIMM_INFO_SMBUS  DimmInfoSmbus[] =
{
  {TRUE, 0, 0, 0, BLDCFG_SPD_CH_A_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x80},
  {TRUE, 0, 0, 1, BLDCFG_SPD_CH_A_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x80},

  {TRUE, 0, 1, 0, BLDCFG_SPD_CH_B_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x80},
  {TRUE, 0, 1, 1, BLDCFG_SPD_CH_B_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x80},

  {TRUE, 0, 2, 0, BLDCFG_SPD_CH_C_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x80},
  {TRUE, 0, 2, 1, BLDCFG_SPD_CH_C_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x80},

  {TRUE, 0, 3, 0, BLDCFG_SPD_CH_D_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x80},
  {TRUE, 0, 3, 1, BLDCFG_SPD_CH_D_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x80},

  {TRUE, 0, 4, 0, BLDCFG_SPD_CH_E_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x40},
  {TRUE, 0, 4, 1, BLDCFG_SPD_CH_E_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x40},

  {TRUE, 0, 5, 0, BLDCFG_SPD_CH_F_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x40},
  {TRUE, 0, 5, 1, BLDCFG_SPD_CH_F_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x40},

  {TRUE, 0, 6, 0, BLDCFG_SPD_CH_G_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x40},
  {TRUE, 0, 6, 1, BLDCFG_SPD_CH_G_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x40},

  {TRUE, 0, 7, 0, BLDCFG_SPD_CH_H_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x40},
  {TRUE, 0, 7, 1, BLDCFG_SPD_CH_H_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x40},

  {TRUE, 1, 0, 0, BLDCFG_SPD_CH_A_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x20},
  {TRUE, 1, 0, 1, BLDCFG_SPD_CH_A_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x20},

  {TRUE, 1, 1, 0, BLDCFG_SPD_CH_B_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x20},
  {TRUE, 1, 1, 1, BLDCFG_SPD_CH_B_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x20},

  {TRUE, 1, 2, 0, BLDCFG_SPD_CH_C_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x20},
  {TRUE, 1, 2, 1, BLDCFG_SPD_CH_C_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x20},

  {TRUE, 1, 3, 0, BLDCFG_SPD_CH_D_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x20},
  {TRUE, 1, 3, 1, BLDCFG_SPD_CH_D_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x20},

  {TRUE, 1, 4, 0, BLDCFG_SPD_CH_E_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x10},
  {TRUE, 1, 4, 1, BLDCFG_SPD_CH_E_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x10},

  {TRUE, 1, 5, 0, BLDCFG_SPD_CH_F_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x10},
  {TRUE, 1, 5, 1, BLDCFG_SPD_CH_F_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x10},

  {TRUE, 1, 6, 0, BLDCFG_SPD_CH_G_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x10},
  {TRUE, 1, 6, 1, BLDCFG_SPD_CH_G_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x10},

  {TRUE, 1, 7, 0, BLDCFG_SPD_CH_H_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x10},
  {TRUE, 1, 7, 1, BLDCFG_SPD_CH_H_DIMM1_ADDRESS, BLDCFG_I2C_MUX_ADRRESS, 0x03, 0x10}
};
UINT32 mNumOfDimmInfoSmbusEntry = MAX_NUM_DIMM_INFO_ENTRIES;

EFI_STATUS
ObtainApcbSmbusInfo (
   IN  AMD_APCB_SERVICE_PROTOCOL *ApcbService
 )
{
   EFI_STATUS Status;
   UINT8 Purpose;
   ...
   Status = ApcbService->ApcbGetType (ApcbService, &Purpose, APCB_GROUP_MEMORY, APCB_MEM_TYPE_DIMM_INFO_SMBUS, 0, &DataBuffer, &DataSize);
   if (EFI_ERROR (Status)) return Status;

   mNumOfDimmInfoSmbusEntry = DataSize / sizeof (DIMM_INFO_SMBUS);
   DEBUG ((EFI_D_INFO, "mNumOfDimmInfoSmbusEntry = %d\n", mNumOfDimmInfoSmbusEntry));
   if (mNumOfDimmInfoSmbusEntry > MAX_NUM_DIMM_INFO_ENTRIES) {
     ASSERT_EFI_ERROR(EFI_OUT_OF_RESOURCES);
     return EFI_OUT_OF_RESOURCES;
   }

   // Zero pool
   ZeroMem ((VOID *)&DimmInfoSmbus, sizeof (DimmInfoSmbus));

   // Copy data
   CopyMem ((VOID *)&DimmInfoSmbus, (VOID *)DataBuffer, (UINTN) DataSize);

   return EFI_SUCCESS;
}

EFI_STATUS
ApcbServiceReadyCallBack (
  IN CONST EFI_GUID  *Protocol,
  IN VOID *Interface,
  IN EFI_HANDLE Handle
 )
{
  AMD_APCB_SERVICE_PROTOCOL *ApcbService;
  EFI_STATUS Status;

  Status = gSmst->SmmLocateProtocol (&gAmdApcbSmmServiceProtocolGuid, NULL, (VOID **)&ApcbService);
  if (EFI_ERROR(Status)) {
    DEBUG ((EFI_D_ERROR, "Fail to locate AmdApcbSmmServiceProtocol (%r)\n", Status));
    goto EndApcbServiceReadyCallBack;
  }

  Status = ObtainApcbSmbusInfo (ApcbService);
  if (EFI_ERROR (Status)) {
    DEBUG ((EFI_D_ERROR, "Fail to obtain APCB Smbus info. (%r)\n", Status));
    //goto EndApcbServiceReadyCallBack;
  }

EndApcbServiceReadyCallBack:
...
)
{
    ...
    for (Index = 0; Index < mNumOfDimmInfoSmbusEntry; Index++) {
      if ((Socket == DimmInfoSmbus[Index].SocketId) && (Channel == DimmInfoSmbus[Index].ChannelId)
           && (Dimm == DimmInfoSmbus[Index].DimmId)) {
        Status = EFI_SUCCESS;
        break;
      }
    }
    if (Index == mNumOfDimmInfoSmbusEntry) {
      DEBUG ((EFI_D_ERROR, "Dimm Smbus Info. not found\n"));
      return EFI_NOT_FOUND;
    }

    //DEBUG ((EFI_D_INFO, "Mux address = 0x%02x(::0x%02x::0x%02x), Smbus address = 0x%02x\n",
    //    DimmInfoSmbus[Index].I2CMuxAddress,
    //    DimmInfoSmbus[Index].MuxControlAddress,
    //    DimmInfoSmbus[Index].MuxChannel,
    //    DimmInfoSmbus[Index].DimmSmbusAdderess));
    // Get SPD address
    SmbusAddress = DimmInfoSmbus[Index].DimmSmbusAdderess;
    // Switch SPD channel
    SmbusI2CMuxSelection (
       DimmInfoSmbus[Index].I2CMuxAddress,
       DimmInfoSmbus[Index].MuxControlAddress,
    ...
    )
{
    ...
    if (!EFI_ERROR (Status)) {
      ...
      // Register protocol notify if Apcb Service protocol is not ready yet
      Status = gSmst->SmmRegisterProtocolNotify (&gAmdApcbSmmServiceProtocolGuid, ApcbServiceReadyCallBack, &Registration);
      if (EFI_ERROR (Status)) {
        DEBUG ((EFI_D_ERROR, "Fail toregister AmdApcbSmmServiceProtocol notification (%r)\n", Status));
      }
    }
