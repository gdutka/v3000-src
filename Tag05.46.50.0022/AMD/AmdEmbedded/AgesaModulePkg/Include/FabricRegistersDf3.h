...
#define PHYCOREENABLE0_FUNC 0x1
#define PHYCOREENABLE0_REG  0x300
#define PHYCOREENABLE0_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, PHYCOREENABLE0_FUNC, PHYCOREENABLE0_REG))

#define PHYCOREENABLE1_FUNC 0x1
#define PHYCOREENABLE1_REG  0x304
#define PHYCOREENABLE1_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, PHYCOREENABLE1_FUNC, PHYCOREENABLE1_REG))
