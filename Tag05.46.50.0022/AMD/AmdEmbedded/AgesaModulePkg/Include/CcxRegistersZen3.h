 ...
 * @file
 *
 * AMD Zen3 CPU Register definition
 *
 * Contains the definition of the CPU CPUID MSRs
 *
...
#ifndef _CCX_REGISTERS_ZEN3_H_
#define _CCX_REGISTERS_ZEN3_H_
#pragma pack (push, 1)

#define ZEN3_MAX_NUMBER_OF_APS 255

/* CPUID_Fn80000001_EBX[PkgType] definitions */
#define  ZEN3_SOCKET_AM4    2
#define  ZEN3_SOCKET_SP3    4
#define  BA_SOCKET_SP3r4    5
#define  ZEN3_SOCKET_SP3r4  5
#define  ZEN3_SOCKET_SP3r2  7
...
typedef union {
  struct {                             ///< Bitfields of P-state MSR
    UINT64 CpuFid:8;                   ///< CpuFid[7:0]
    UINT64 CpuDfsId:6;                 ///< CpuDfsId
    UINT64 CpuVid:8;                   ///< CpuVid[7:0]
...
typedef union {
  struct {                             ///< Bitfields of CPU Watchdog Timer MSR Register
    UINT64 CpuWdTmrCfgEn:1;            ///< CPU watchdog timer enable
    UINT64 CpuWdTmrTimebaseSel:2;      ///< CPU watchdog timer time base
    UINT64 CpuWdTmrCfgCount:4;         ///< CPU watchdog timer count select
...
/* MCA LS Machine Check Control Mask Register 0xC0010400 */
#define MCA_CTL_MASK_LS_ADDRESS  0xC0010400UL

/* MCA LS IP Identification Register 0xC0002005 */
#define MCA_IPID_LS_ADDRESS  0xC0002005UL

/// MCA LS IP Identification MSR
typedef union {
  struct {
    UINT32  InstanceIdLo:32;
    UINT32  HardwareID:12;
    UINT32  InstanceIdHi:4;
    UINT32  McaType:16;
  } Field;
  UINT64 Value;
} MCA_IPID_LS_STRUCT;

/// MCA CS Machine Check Control Mask
typedef union {
  struct {
    UINT32  FTI_ILL_REQ:1;
    UINT32  FTI_ADDR_VIOL:1;
    UINT32  FTI_SEC_VIOL:1;
    UINT32  FTI_ILL_RSP:1;
    UINT32  FTI_RSP_NO_MTCH:1;
    UINT32  FTI_PAR_ERR:1;
    UINT32  SDP_PAR_ERR:1;
    UINT32  ATM_PAR_ERR:1;
    UINT32  SDP_RSP_NO_MTCH:1;
    UINT32  SPF_PRT_ERR:1;
    UINT32  SPF_ECC_ERR:1;
    UINT32  SDP_UNEXP_RETRY:1;
    UINT32  CNTR_OVFL:1;
    UINT32  CNTR_UNFL:1;
    UINT64  Reserved_63_14:50;
  } Field;
  UINT64 Value;
} MCA_CTL_MASK_CS_STRUCT;

/// MCA L3 Machine Check Control Mask
typedef union {
  struct {
    UINT32  ShadowTag:1;
    UINT32  MultiHitShadowTag:1;
    UINT32  Tag:1;
    UINT32  MultiHitTag:1;
    UINT32  DataArray:1;
    UINT32  SdpParity:1;
    UINT32  XiVictimQueue:1;
    UINT32  Hwa:1;
    UINT64  Reserved_63_8:56;
  } Field;
  UINT64 Value;
...
typedef union {
  struct {
    UINT32  :16;                                   ///< Reserved
    UINT32  NumOfCores:4;                          ///< Number of logical cores in a complex
    UINT32  :1;                                    ///< Reserved
    UINT32  NumOfCcds:4;                           ///< Number of logical die in a socket
    UINT32  NumOfSockets:2;                        ///< Number of sockets in a system
    UINT32  :5;                                    ///< Reserved
  } Field;
  UINT32  Value;
} PMREG_INITPKG7_STRUCT;

/* Register Name FUSE_CCD_DATA_453 */
#define SMN_FUSE_CCD_DATA_453_ADDRESS      0x30081F14UL

#pragma pack (pop)
#endif      // _CCX_REGISTERS_ZEN3_H_
