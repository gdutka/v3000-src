...
///
typedef struct {
  IN         UINT8   SpiReadMode;                ///< Spi Read Mode 5-Qual 4-Dual 7-Single
  IN         UINT8   SpiSpeed;                   ///< Spi Speed 0-66Mhz 1-33Mhz 2-22Mhz 3-17.6Mhz 4-100Mz 5-800Khz 6-Spi_sp6 7-Spi_sp7
  IN         UINT8   Spi_spd6;                   ///< Speed = 200Mhz/Spi_spd6
  IN         UINT8   Spi_spd7;                   ///< Speed = 200Mhz/Spi_spd7
} HID_CONTROL;
...
/// PCIe link initialization
typedef enum {
  AmdPortDisabled,                                           ///< Disable
  AmdPortEnabled                                             ///< Enable
} PCIE_PORT_ENABLE;
...
typedef enum {
  ...
  UMA_AUTO = 2,              ///< UMA Auto
  UMA_GAME_OPTIMIZED = 3     ///< UMA Game Optimized mode
} UMA_MODE;
...
typedef struct _DCT_STRUCT {
  ...
  /* DIMM Seletive flag*/
  OUT BOOLEAN DataMaskCapability; ///< Data Mask Capability
} DCT_STRUCT;
...
#define MEM_EVENT_POST_PACKAGE_REPAIR 0x04012A00ul             ///< Post Package Repair
