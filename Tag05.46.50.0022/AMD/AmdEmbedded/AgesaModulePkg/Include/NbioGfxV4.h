...
#ifndef _NBIOGFXV3_H_
#define _NBIOGFXV3_H_
...
typedef enum  {
    ...
    Tx_FFE2                   = 2,
    Tx_FFE3                   = 3,
    Tx_FFE_De_Emphasis_Only   = 4,
    Tx_FFE_Pre_Shoot_Only     = 5,
    Tx_FFE_No_FFE             = 6,
} ATOM_TXFFE;
...
typedef enum {
  ...
  VOLTAGE_TYPE_VDDUSR = 0x23,
  VOLTAGE_TYPE_INP_CUR_WARN_FAULT = 0x31,
  VOLTAGE_TYPE_INP_CUR_WARN_FAULT_1 = 0x31,
  VOLTAGE_TYPE_INP_CUR_WARN_FAULT_2 = 0x32,
  VOLTAGE_TYPE_INP_CUR_AND_VOLT_TELEMETRY = 0x33,
  VOLTAGE_TYPE_VDDGFX_2 = 0x34,
  VOLTAGE_TYPE_VDDIO_XGMI = 0x35,
} ATOM_VOLTAGE_TYPE;
...
typedef struct _atom_rom_header_v2_3
{
  ATOM_COMMON_TABLE_HEADER table_header;
  uint8_t  atom_bios_string[4];        //enum atom_string_def atom_bios_string;     //Signature to distinguish between Atombios and non-atombios,
  uint16_t bios_segment_address;
  ...
  uint8_t  gop_min_ver;
  uint8_t  gop_maj_ver;
  uint8_t  gop_reserved;
} ATOM_ROM_HEADER_V2_3;
/*==============================hw function portion======================================================================*/
...
typedef enum {
  ...
  ATOM_FIRMWARE_CAP_DISABLE_HYBRID_GOP  = 0x00000800,
  ATOM_FIRMWARE_CAP_INPUT_POWER_SWITCH_CAPABLE = 0x0001000,
  ATOM_FIRMWARE_CAP_USB_COMPLIANCE = 0x0002000,
  ATOM_FIRMWARE_CAP_ENABLE_2STAGE_BOMACO = 0x0004000,
#ifndef _H2INC
  ATOM_FIRMWARE_CAP_ENABLE_2ND_USB20PORT = 0x0008000,
  ATOM_FIRMWARE_CAP_DISABLE_USBPORT = 0x0010000,
  ATOM_FIRMWARE_CAP_DYNAMIC_BOOT_CFG_ENABLE = 0x0020000,
  ATOM_FIRMWARE_CAP_GPIO_DETECT_BOMACO_ENABLE = 0x0040000,
  ATOM_FIRMWARE_CAP_SW_INPUT_POWER_SWITCHING_DISABLE = 0x0080000,
#endif
...
typedef enum {
  HW_BLT_DMA_PIO_MODE = 0,
  HW_BLT_LITE_SDMA_MODE = 1,
  HW_BLT_PCI_IO_MODE = 2
} ATOM_HW_BLT_MODE_DEF;

typedef struct _atom_firmware_info_v3_4
{
  ATOM_COMMON_TABLE_HEADER table_header;
  uint32_t firmware_revision;
  uint32_t bootup_sclk_in10khz;
...
typedef struct _edp_info_table
{
 ...
 // modify  lcd_info definition to support dual eDP feature on VG and forward APUs
typedef struct _lcd_info_v3_1
{
  ATOM_COMMON_TABLE_HEADER table_header;
...
typedef struct _atom_connector_caps_record
{
  ATOM_COMMON_RECORD_HEADER record_header;  //record_type = ATOM_CONN_CAP_RECORD_TYPE
  uint8_t  connector_caps;              //01b if internal display is checked; 10b if internal BL is checked; 0 of Not
} ATOM_CONNECTOR_CAPS_RECORD;

typedef struct _atom_connector_speed_record
{
  ATOM_COMMON_RECORD_HEADER record_header;  //record_type = ATOM_CONN_SPEED_UPTO
...
typedef enum _atom_encoder_caps_def {
  ...
  ATOM_ENCODER_CAP_RECORD_HDMI_FRL              =0x200,        // HDMI FRL supported by ASIC/board.
  ATOM_ENCODER_CAP_RECORD_HDMI_FRL_8GbEn        =0x400,        // HDMI FRL 8Gb support
  ATOM_ENCODER_CAP_RECORD_HDMI_FRL_10GbEn       =0x800,        // HDMI FRL 10Gb support
  ATOM_ENCODER_CAP_RECORD_HDMI_FRL_12GbEn       =0x1000,       // HDMI FRL 12Gb support
  ATOM_ENCODER_CAP_RECORD_USB4_DPIA_EN          =0x2000,       // the DP connector is a USB-C type with USB4 DPIA capability.
...
typedef struct _atom_bracket_layout_record_v2
{
  ATOM_COMMON_RECORD_HEADER record_header;  //record_type =  ATOM_BRACKET_LAYOUT_RECORD_TYPE
...
typedef struct _atom_nova_link_record
{
  ATOM_COMMON_RECORD_HEADER record_header;  //record_type = ATOM_NOVA_LINK_RECORD_TYPE
  uint8_t i2c_id;                                  //i2c id come from communcation attribute
  uint8_t i2c_slave_addr;
} ATOM_NOVA_LINK_RECORD;
...
typedef enum {
  ...
  ATOM_DISPLAY_LCD2_SUPPORT         = 0x0020, //add second edp device tag 0x0020 for backward compability
...
typedef struct _atom_display_object_path_v3
{
  uint16_t display_objid;      //Connector Object ID or Misc Object ID
  uint16_t disp_recordoffset;
  uint16_t encoderobjid;       //first encoder closer to the connector, could be either an external or intenal encoder
...
typedef struct _display_object_info_table_v1_5
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  uint16_t  supporteddevices;
  uint8_t   number_of_path;
  ...
  ATOM_DISPLAY_OBJECT_PATH_V3 display_path[8];
...
typedef struct _atom_display_controller_info_v4_4
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  uint32_t display_caps;
  uint32_t bootup_dispclk_10khz;
...
typedef struct _atom_dc_golden_table_v1
{
...
typedef enum {
  ...
  // only for VBIOS
  DCE_INFO_CAPS_DISABLE_DMUB_HPD_INT     =0x10,
  // only for DAL to enable LTTPR
  DCE_INFO_CAPS_LTTPR_SUPPORT_ENABLE     =0x20,
  // only for VBIOS to enable LTTPR
  DCE_INFO_CAPS_VBIOS_LTTPR_TRANSPARENT_ENABLE = 0x40,
  // only for VBIOS to check HPD before I2C read EDID
  DCE_INFO_CAPS_CHECK_HPD_BEFORE_I2C_EDID = 0x80,
} DCE_INFO_CAPS_DEF;

typedef struct _atom_display_controller_info_v4_5
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  uint32_t display_caps;
  uint32_t bootup_dispclk_10khz;
...
typedef enum {
  ...
  EXT_DISPLAY_PATH_CAPS__DFPx_INTERNAL_DISP_EN      =0x400,         // External Display DFPx set it as "internal" display
#ifndef _H2INC
  EXT_DISPLAY_PATH_CAPS__DP2                        =0x100000,      // HDMI2.0 6GBPS disable
  EXT_DISPLAY_PATH_CAPS__UHBR10_EN                  =0x200000,      // DP2.0 UHBR10 settings is supported by board
  EXT_DISPLAY_PATH_CAPS__UHBR13_5_EN                =0x400000,      // DP2.0 UHBR13.5 settings is supported by board
  EXT_DISPLAY_PATH_CAPS__RECORD_UHBR20_EN           =0x800000,      // DP2.0 UHBR20 settings is supported by board
  EXT_DISPLAY_PATH_CAPS__HDMI_FRL                   =0x2000000,     // HDMI FRL supported by ASIC/board.
  EXT_DISPLAY_PATH_CAPS__HDMI_FRL_8GbEn             =0x4000000,     // HDMI FRL 8Gb support
  EXT_DISPLAY_PATH_CAPS__HDMI_FRL_10GbEn            =0x8000000,     // HDMI FRL 10Gb support
  EXT_DISPLAY_PATH_CAPS__HDMI_FRL_12GbEn            =0x10000000,    // HDMI FRL 12Gb support
  EXT_DISPLAY_PATH_CAPS__USB4_DPIA_ENABLE           =0x20000000,    // the DP connector is a USB4-C type
#endif
...
/*
  ***************************************************************************
    Nova card data structure
  ***************************************************************************
*/

typedef struct _display_nova_module {
  uint8_t    major_rev;
  uint8_t    minor_rev;
  uint16_t   connector_type;  //See the enum  display_nova_module_connector_type_def, can add more
  uint32_t   Speed_upto;      //The max speed this Nova module can support, in units of Mhz
  uint8_t    attribute;       //an Enum to indicate Nova card HW difference, 0-no redriver, 1- redriver config 1, 2- redriver config2
  uint8_t    reserved0;
  uint16_t   reserved1;
  uint32_t   reserved2;
} DISPLAY_NOVA_MODULE;

typedef enum _display_nova_module_connector_type_def {
    NOVA_CONNECTOR_TYPE_DISPLAYPORT     = 0x13,
    NOVA_CONNECTOR_TYPE_HDMI            = 0x0C,
    NOVA_CONNECTOR_TYPE_USBC            = 0x17,
    NOVA_CONNECTOR_TYPE_eDP             = 0x14,
} DISPLAY_NOVA_MODULE_CONNECTOR_TYPE_DEF;

typedef enum _display_nova_module_attribute_def {
    NO_REDRIVER                    = 0x0,
    REDRIVER_CONFIG_1              = 0x1,
    REDRIVER_CONFIG_2              = 0x2,
} DISPLAY_NOVA_MODULE_ATTRIBUTE_DEF;
...
typedef struct _atom_integrated_system_info_v1_11 {
  ...
  ATOM_14NM_DPPHY_DP_TUNINGSET dp_tuningset;        // rbr 1.62G dp tuning set
  ATOM_14NM_DPPHY_DP_TUNINGSET dp_hbr3_tuningset;   // HBR3 dp tuning set
...
typedef struct _atom_integrated_system_info_v1_12 {
  ATOM_COMMON_TABLE_HEADER  table_header;
  uint32_t  vbios_misc;                       //enum of atom_system_vbiosmisc_def
  uint32_t  gpucapinfo;                       //enum of atom_system_gpucapinf_def
  uint32_t  system_config;
  ...
  ATOM_DCN_DPPHY_DP_TUNINGSET rbr_tuningset;        // rbr 1.62G dp tuning set
...
// add dual eDP support on VG and forward APUs
typedef struct _atom_integrated_system_info_v2_1
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  uint32_t  vbios_misc;                       //enum of atom_system_vbiosmisc_def
  uint32_t  gpucapinfo;                       //enum of atom_system_gpucapinf_def
  ...
  ATOM_EXTERNAL_DISPLAY_CONNECTION_INFO extdispconninfo;
  ATOM_DCN_DPPHY_DVIHDMI_TUNINGSET  TMDS_tuningset;
  ATOM_DCN_DPPHY_DVIHDMI_TUNINGSET  hdmiCLK5_tuningset; //add clk6
  ATOM_DCN_DPPHY_DVIHDMI_TUNINGSET  hdmiCLK6_tuningset;
  ATOM_DCN_DPPHY_DVIHDMI_TUNINGSET  hdmiCLK8_tuningset;
  uint32_t reserved4[6];//reserve 2*sizeof(atom_DCN_dpphy_dvihdmi_tuningset)
  ATOM_DCN_DPPHY_DP_TUNINGSET rbr_tuningset;        // rbr 1.62G dp tuning set
  ATOM_DCN_DPPHY_DP_TUNINGSET hbr_tuningset;    //hbr 2.7G dp tuning set
  ATOM_DCN_DPPHY_DP_TUNINGSET hbr2_tuningset;   //hbr2 5.4G dp turnig set
  ATOM_DCN_DPPHY_DP_TUNINGSET hbr3_tuningset;   // HBR3 dp tuning set
  ATOM_DCN_DPPHY_DP_TUNINGSET edp_tunings;       //edp tuning set
...
typedef struct _atom_integrated_system_info_v2_2
{
  ...
  uint32_t  UMACarveoutIndexMax;      // Indicates maximum index selectable for carveout options.
                                      // UMACarveoutIndexMax = 0 means feature is disabled.
                                      // Should be 0 if custom size selected in SBIOS
  uint32_t  UMACarveoutIndexDefault;          // Default mode in SBIOS
  uint32_t  UMACarveoutIndex;                 // Current value selected in SBIOS
                                              // 0 means Default
                                              // 1 means Gaming
  uint8_t   UMACarveoutID[4];                 // Names to be provided to UI
                                              // UMACarveoutID [0] = 1 (UMAMODEIDENTIFIER__PRODUCTIVITY)
                                              // UMACarveoutID [1] = 2 (UMAMODEIDENTIFIER__GAMING      )
                                              // UMACarveoutID [2] = 0 (UMAMODEIDENTIFIER__INVALID     )
                                              // UMACarveoutID [3] = 0 (UMAMODEIDENTIFIER__INVALID     )
...
typedef struct {
  ATOM_INTEGRATED_SYSTEM_INFO_V1_12   sIntegratedSysInfo;
  uint32_t   powerplayinfo[256];                                // Reserve 1024 bytes space for PowerPlayInfoTable
} ATOM_FUSION_SYSTEM_INFO_V4;


typedef struct {
  ATOM_INTEGRATED_SYSTEM_INFO_V2_1   sIntegratedSysInfo;
  uint32_t   powerplayinfo[256];                                // Reserve 1024 bytes space for PowerPlayInfoTable
...
typedef struct  _atom_gfx_info_v2_6
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  uint8_t gfxip_min_ver;
  uint8_t gfxip_max_ver;
  ...
  uint32_t gc_config;
  uint8_t inactive_wgp[8];
  uint32_t reserved[4];
} ATOM_GFX_INFO_V2_6;

// gc_config
enum gc_config_def {
  GC_CONFIG__ENABLE_CU_PER_SA_OVERRIDE = 0x01,
  GC_CONFIG__ENABLE_MGCG = 0x02,
  GC_CONFIG__DISABLE_FORCE_WGP_DOWNGRADE = 0x04,
  GC_CONFIG__DISABLE_IMU_GC_INIT = 0x08,
  GC_CONFIG__ENABLE_RB_PER_SA_OVERRIDE = 0x10,
};

typedef struct  _atom_gfx_info_v2_7 //For mi200
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  uint8_t gfxip_min_ver;
  uint8_t gfxip_max_ver;
  ...
  uint32_t sram_custom_rm_fuses_val;
  uint8_t cut_cu;
  uint8_t cu_reserved[3];
  uint32_t reserved2[6];
} ATOM_GFX_INFO_V2_7;

// for NV3x
typedef struct  _atom_gfx_info_v3_0
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  uint8_t gfxip_min_ver;
  uint8_t gfxip_max_ver;
  ...
  uint8_t max_backends_per_se;
  uint8_t max_texture_channel_caches;
  uint32_t regaddr_lsdma_src_addr;
  uint32_t regaddr_lsdma_src_addr_hi;
  uint32_t regaddr_lsdma_dst_addr;
  uint32_t regaddr_lsdma_dst_addr_hi;
...
typedef enum {
  ...
  SMU_INFO_V3_3_CAPS_VDDGFX_VOTF_WA_EN    =0x08,
...
typedef struct _atom_smu_info_v3_5
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  uint8_t  smuip_min_ver;
  uint8_t  smuip_max_ver;
...
{
  // only for VBIOS
  SMU_INFO_V3_5_CAPS_GFXCLK_AFLL_MODE_EN  =0x01,
  SMU_INFO_V3_5_CAPS_HWCTF_HOTSPOT_EN     =0x02,
  SMU_INFO_V3_5_CAPS_PCC_SQR              =0x04,
  SMU_INFO_V3_5_CAPS_VDDGFX_VOTF_WA_EN    =0x08,
  SMU_INFO_V3_5_CAPS_FIX_FCLK_DFS_DID     =0x10,
  SMU_INFO_V3_5_CAPS_OVERRIDE_TMON_EFUSE  =0x20,
  SMU_INFO_V3_5_CAPS_BOOTUP_CLK_VDD_FROM_PPTABLE = 0x40,
  SMU_INFO_V3_5_CAPS_ENABLE_UCLK_SS       = 0x80
} SMU_INFO_V3_5_CAPS_DEF;

//used for MI200
typedef struct atom_smu_info_v3_6
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  uint8_t  smuip_min_ver;
  uint8_t  smuip_max_ver;
...
typedef enum {
  // only for VBIOS
  SMU_INFO_V3_6_CAPS_GFXCLK_AFLL_MODE_EN  =0x01,
  SMU_INFO_V3_6_CAPS_HWCTF_HOTSPOT_EN     =0x02,
  SMU_INFO_V3_6_CAPS_PCC_SQR              =0x04,
  SMU_INFO_V3_6_CAPS_VDDGFX_VOTF_WA_EN    =0x08,
  SMU_INFO_V3_6_CAPS_FIX_FCLK_DFS_DID     =0x10,
  SMU_INFO_V3_6_CAPS_OVERRIDE_TMON_EFUSE  =0x20,
  SMU_INFO_V3_6_CAPS_BOOTUP_CLK_VDD_FROM_PPTABLE = 0x40,
  SMU_INFO_V3_6_CAPS_ENABLE_UCLK_SS = 0x80,
} SMU_INFO_V3_6_CAPS_DEF;

// for NV3x
typedef struct _atom_smu_info_v4_0 {
  ATOM_COMMON_TABLE_HEADER table_header;
...
enum smu_info_v4_0_caps_def {
  // only for VBIOS
  SMU_INFO_V4_0_CAPS_GFXCLK_AFLL_MODE_EN = 0x01,
  SMU_INFO_V4_0_CAPS_HWCTF_HOTSPOT_EN = 0x02,
  SMU_INFO_V4_0_CAPS_PCC_SQR = 0x04,
  SMU_INFO_V4_0_CAPS_VDDGFX_VOTF_WA_EN = 0x08,
  SMU_INFO_V4_0_CAPS_FIX_FCLK_DFS_DID = 0x10,
  SMU_INFO_V4_0_CAPS_OVERRIDE_TMON_EFUSE = 0x20,
  SMU_INFO_V4_0_CAPS_BOOTUP_CLK_VDD_FROM_PPTABLE = 0x40,
  SMU_INFO_V4_0_CAPS_ENABLE_UCLK_SS = 0x80,
};
...
typedef struct _atom_smc_dpm_info_v4_6
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  // section: board parameters
  uint32_t     i2c_padding[3];   // old i2c control are moved to new area
 ...
 // fclk spread spectrum
  ...
  uint32_t     BoardVoltageCoeffA;    // /1000
  uint32_t     BoardVoltageCoeffB;    // /1000
  // reserved
  uint32_t   boardreserved[7];
} ATOM_SMC_DPM_INFO_V4_6;

typedef enum {
    SMC_V4_7_I2C_CONTROLLER_NAME_VR_GFX            = 0,
    SMC_V4_7_I2C_CONTROLLER_NAME_VR_SOC            = 1,
    SMC_V4_7_I2C_CONTROLLER_NAME_VR_VDDCI          = 2,
    SMC_V4_7_I2C_CONTROLLER_NAME_VR_MVDD           = 3,
    SMC_V4_7_I2C_CONTROLLER_NAME_INA3221_12V_V1V2  = 4,
    SMC_V4_7_I2C_CONTROLLER_NAME_INA3221_12V_BUS   = 5,
    SMC_V4_7_I2C_CONTROLLER_NAME_INA3221_12V_EXTB  = 6,
    SMC_V4_7_I2C_CONTROLLER_NAME_PLX               = 6,
    SMC_V4_7_I2C_CONTROLLER_NAME_SPARE             = 7,
    SMC_V4_7_I2C_CONTROLLER_NAME_COUNT             = 8,
} SMCDPM_V4_7_I2CCONTROLLERNAME_E;


typedef enum {
    SMC_V4_7_I2C_CONTROLLER_THROTTLER_TYPE_NONE = 0,
    SMC_V4_7_I2C_CONTROLLER_THROTTLER_VR_GFX,
    SMC_V4_7_I2C_CONTROLLER_THROTTLER_VR_SOC,
    SMC_V4_7_I2C_CONTROLLER_THROTTLER_VR_VDDCI,
    SMC_V4_7_I2C_CONTROLLER_THROTTLER_VR_MVDD,
    SMC_V4_7_I2C_CONTROLLER_THROTTLER_LIQUID0,
    SMC_V4_7_I2C_CONTROLLER_THROTTLER_LIQUID1,
    SMC_V4_7_I2C_CONTROLLER_THROTTLER_PLX,
    SMC_V4_7_I2C_CONTROLLER_THROTTLER_INA3221_12V_V1V2,
    SMC_V4_7_I2C_CONTROLLER_THROTTLER_INA3221_12V_BUS,
    SMC_V4_7_I2C_CONTROLLER_THROTTLER_COUNT,
} SMCDPM_V4_7_I2CCONTROLLERTHROTTLER_E;

typedef enum {
    SMC_V4_7_I2C_CONTROLLER_PROTOCOL_VR_0,     // XPDE132G5
    SMC_V4_7_I2C_CONTROLLER_PROTOCOL_VR_1,     // IR35217
    SMC_V4_7_I2C_CONTROLLER_PROTOCOL_TMP_0,
    SMC_V4_7_I2C_CONTROLLER_PROTOCOL_TMP_1,
    SMC_V4_7_I2C_CONTROLLER_PROTOCOL_INA3221_12V_V1V2,
    SMC_V4_7_I2C_CONTROLLER_PROTOCOL_INA3221_12V_BUS,
    SMC_V4_7_I2C_CONTROLLER_PROTOCOL_COUNT,
} SMCDPM_V4_7_I2CCONTROLLERPROTOCOL_E;

typedef enum
{
    SMC_V4_7_I2C_CONTROLLER_SPEED_SLOW = 0,
    SMC_V4_7_I2C_CONTROLLER_SPEED_FAST = 1,
    SMC_V4_7_I2C_CONTROLLER_SPEED_FAST_400K = 2,
} SMCDPM_V4_7_I2CCONTROLLERSPEED_E;
struct atom_smc_dpm_info_v4_7
{
  ...
  // GPIO pins for I2C communications with 2nd controller for Input Telemetry Sequence, ron.evanoff
  uint8_t      GpioI2cScl;          // Serial Clock
  uint8_t      GpioI2cSda;          // Serial Data
  uint16_t     GpioPadding;

  // Additional LED Display Settings
  uint8_t      LedPin3;         // GPIO number for LedPin[3] - PCIE GEN Speed - NAVI12 Server CurrLevel should be 4
...
typedef struct _atom_smc_dpm_info_v4_8
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  // section: xgmi training
  uint8_t    xgmilinkspeed[4];
 ...
 // fclk spread spectrum
  ...
  // reserved
  uint32_t   boardreserved[7];
} ATOM_SMC_DPM_INFO_V4_8;


typedef enum {
    SMC_V4_9_I2C_CONTROLLER_NAME_VR_GFX = 0,
    SMC_V4_9_I2C_CONTROLLER_NAME_VR_SOC,
    SMC_V4_9_I2C_CONTROLLER_NAME_VR_VDDCI,
    SMC_V4_9_I2C_CONTROLLER_NAME_VR_MVDD,
    SMC_V4_9_I2C_CONTROLLER_NAME_LIQUID0,
    SMC_V4_9_I2C_CONTROLLER_NAME_LIQUID1,
    SMC_V4_9_I2C_CONTROLLER_NAME_PLX,
    SMC_V4_9_I2C_CONTROLLER_NAME_OTHER,
    SMC_V4_9_I2C_CONTROLLER_NAME_COUNT,
} SMUDPM_V4_9_I2CCONTROLLERNAME_E;

typedef enum {
    SMC_V4_9_I2C_CONTROLLER_THROTTLER_TYPE_NONE = 0,
    SMC_V4_9_I2C_CONTROLLER_THROTTLER_VR_GFX,
    SMC_V4_9_I2C_CONTROLLER_THROTTLER_VR_SOC,
    SMC_V4_9_I2C_CONTROLLER_THROTTLER_VR_VDDCI,
    SMC_V4_9_I2C_CONTROLLER_THROTTLER_VR_MVDD,
    SMC_V4_9_I2C_CONTROLLER_THROTTLER_LIQUID0,
    SMC_V4_9_I2C_CONTROLLER_THROTTLER_LIQUID1,
    SMC_V4_9_I2C_CONTROLLER_THROTTLER_PLX,
    SMC_V4_9_I2C_CONTROLLER_THROTTLER_INA3221,
    SMC_V4_9_I2C_CONTROLLER_THROTTLER_COUNT,
} SMUDPM_V4_9_I2CCONTROLLERTHROTTLER_E;

typedef enum {
    SMC_V4_9_I2C_CONTROLLER_PROTOCOL_VR_XPDE132G5,
    SMC_V4_9_I2C_CONTROLLER_PROTOCOL_VR_IR35217,
    SMC_V4_9_I2C_CONTROLLER_PROTOCOL_TMP_TMP102A,
    SMC_V4_9_I2C_CONTROLLER_PROTOCOL_INA3221,
    SMC_V4_9_I2C_CONTROLLER_PROTOCOL_COUNT,
} SMUDPM_V4_9_I2CCONTROLLERPROTOCOL_E;

typedef struct _smudpm_i2c_controller_config_v3
{
    uint8_t   Enabled;
    uint8_t   Speed;
...
// used for Navi21
typedef struct _atom_smc_dpm_info_v4_9
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  ...
  // SECTION: I2C Control
  SMUDPM_I2C_CONTROLLER_CONFIG_V3  I2cControllers[16];
  ...
  uint8_t      UclkSpreadPercentList[16];   // Q4.4
  //Slew rate of VR when it is ramping down in integer units uV/us (microvolts per microsecond).
  //Used to ensure VDDGFX ramps down all the way during GFXOFF entry/exit
  uint32_t     VddGfxRampDownSlewRate;
...
// for mi200
typedef struct _atom_smc_dpm_info_v4_10
{
  ATOM_COMMON_TABLE_HEADER  table_header;
  ...
  // I2C Controller Structure
  SMUDPM_I2C_CONTROLLER_CONFIG_V3  I2cControllers[8];
...
typedef struct _atom_gddr6_ac_timing_v2_5
{
    uint32_t  u32umc_id_access;
    uint8_t  RL;
    uint8_t  WL;
    ...
    uint8_t  tXS_Hi;
    uint8_t  tXSMRS_Hi;
    uint8_t  flag;                        //bit0=1: bankgroup enable
    uint8_t  reserved[5];
} ATOM_GDDR6_AC_TIMING_V2_5;

typedef struct _atom_gddr6_bit_byte_remap
{
...
typedef struct _atom_gddr6_dram_data_remap
{
  uint32_t table_size;
  uint8_t phyintf_ck_inverted[8];     //UMC_PHY_PHYINTF_CNTL.INV_CK
  ATOM_GDDR6_BIT_BYTE_REMAP bit_byte_remap[16];
} ATOM_GDDR6_DRAM_DATA_REMAP;

typedef struct _atom_gddr6_dram_data_remap_v2 {
  uint32_t table_size;
  uint8_t  phyintf_ck_inverted[12]; // UMC_PHY_PHYINTF_CNTL.INV_CK
  ATOM_GDDR6_BIT_BYTE_REMAP bit_byte_remap[24];
} ATOM_GDDR6_DRAM_DATA_REMAP_V2;


typedef struct _atom_vram_info_header_v2_5
{
  ATOM_COMMON_TABLE_HEADER table_header;
  uint16_t mem_adjust_tbloffset;                         // offset of atom_umc_init_reg_block structure for memory vendor specific UMC adjust settings
  ...
  uint8_t  umcip_max_ver;
  uint8_t  mc_phy_tile_num;                              // indicate the MCD tile number which use in DramDataRemapTbl and usMcAdjustPerTileTblOffset
  ATOM_VRAM_MODULE_V11  vram_module[16];        // just for allocation, real number of blocks is in ucNumOfVRAMModule;
} ATOM_VRAM_INFO_HEADER_V2_5;
typedef struct _atom_hbm2_ac_timing_v2_6
{
    uint32_t u32umc_id_access;
    uint8_t  tCL;
    uint8_t  WL;
    ...
    uint16_t  tXSMRS;
    uint8_t  reserved[8];
} ATOM_HBM2_AC_TIMING_V2_6;

typedef struct _atom_vram_info_header_v2_6
{
  ATOM_COMMON_TABLE_HEADER table_header;
  uint16_t mem_adjust_tbloffset;                         // offset of atom_umc_init_reg_block structure for memory vendor specific UMC adjust setting
  uint16_t mem_clk_patch_tbloffset;                      // offset of atom_hbm2_ac_timing_v2_6 structure for memory clock specific UMC setting
  uint16_t mc_adjust_pertile_tbloffset;                  // offset of atom_umc_init_reg_block structure for Per Byte Offset Preset Settings
  uint16_t mc_phyinit_tbloffset;                         // offset of atom_umc_init_reg_block structure for MC phy init set
  uint16_t dram_data_remap_tbloffset;                    // reserved for now
  uint16_t tmrs_seq_offset;                              // offset of HBM tmrs
...
typedef enum {
   ...
   VOLTAGE_OBJ_SVI3                  =  10,       // Indicate voltage control by SVID3 ->atom_svid2_voltage_object_v5_0
...
typedef struct _atom_svid2_voltage_object_v4_2 {
   ...
   uint16_t sviflag;                              // sviflag
   uint16_t reserved;                             // reserved, maxstep move to smc_dpm_info table
} ATOM_SVID2_VOLTAGE_OBJECT_V4_2;

//sviflag
enum atom_svi_flag_def
{
   SVI2_DIS_WAIT_VOTF = 0x0001,                  // disable SVI2 wait for VOTF signal from VR before it clear SVI_BUSY
   SVI2_FORCE_SEND_VID_BACOEXIT = 0x0002,        // force to send VID when VID is same in BACO exit mode
   SVI2_SUGARLOAF_WA = 0x0004,                   // Sugarloft VR workaround, when request voltage >= board default voltage, set init voltage = default voltage - 250mv
};
...
typedef struct _atom_svi3_voltage_object_v5_0 {
  ATOM_VOLTAGE_OBJECT_HEADER_V4 header;   // voltage mode = VOLTAGE_OBJ_SVID
  uint32_t svi3_param_valid;          //bit vector for FW to init svi3 parameter, bit0=1 for decay_conditions
  uint8_t slave_addr;
  uint8_t decay_conditions;
  uint8_t down_slew_rate;
  uint8_t up_slew_rate;
  uint8_t ll_adjust;
  uint8_t vout_offset;
  uint8_t vid_max;
  uint8_t vid_min;
  uint8_t ten_bit_tel_en;
  uint8_t sixteen_bit_tel_en;
  uint8_t ocp_thresh;
  uint8_t ocp_warn_thresh;
  uint8_t ocp_warn_min_pulse;
  uint8_t ocp_fault_delay;
  uint8_t vrhot_thresh;
  uint8_t otp_thresh;
  uint8_t ovp_ref;
  uint8_t ovp_delta;
  uint8_t uvp_ref;
  uint8_t uvp_delta;
  uint8_t phase_shed_1;
  uint8_t phase_shed_2;
  uint8_t low_pwr_psi;
  uint8_t reserved[9];
}ATOM_SVI3_VOLTAGE_OBJECT_V5_0;

typedef struct _atom_voltage_objects_info_v5_0 {
    ATOM_COMMON_TABLE_HEADER table_header;
    ATOM_SVI3_VOLTAGE_OBJECT_V5_0  svi3[16];
} ATOM_VOLTAGE_OBJECTS_INFO_V5_0;
...
typedef enum {
  ...
  ATOM_ENCODER_CMD_ENABLE_HPO                   = 0x13,
  ATOM_ENCODER_CMD_DISABLE_HPO                  = 0x14,
...
typedef struct _dig_transmitter_control_parameters_v1_7
{
  uint8_t phyid;           // 0=UNIPHYA, 1=UNIPHYB, 2=UNIPHYC, 3=UNIPHYD, 4= UNIPHYE 5=UNIPHYF
  uint8_t action;          // define as ATOM_TRANSMITER_ACTION_xxx
  union {
  ...
  uint8_t  lanenum;        // Lane number 1, 2, 4 for DP, 3 or 4 for HDMI FRL
  union {
    uint32_t symclk_10khz;   // Symbol Clock in 10Khz for Non FRL case
    uint32_t symclk_Hz;       // Symbol clock in units of Hz for HDMI FRL case
  } symclk_units;
  uint8_t  hpdsel;         // =1: HPD1, =2: HPD2, .... =6: HPD6, =0: HPD is not assigned
  uint8_t  digfe_sel;      // DIG stream( front-end ) selection, bit0 means DIG0 FE is enable,
  uint8_t  connobj_id;     // Connector Object Id defined in ObjectId.h
  uint8_t  HPO_instance;       // HPO instance (0: inst0, 1: inst1)
  uint8_t  TxFFELaneSel;       // Lane select for TxFFE [3:0] (bit0: lane0, bit1: lane1, bit2: lane3, bit3: lane3);
  uint8_t reserved1[3];
} DIG_TRANSMITTER_CONTROL_PARAMETERS_V1_7;

typedef struct _dig_transmitter_control_ps_allocation_v1_7
{
  DIG_TRANSMITTER_CONTROL_PARAMETERS_V1_7 param;
  uint32_t reserved[4];
}DIG_TRANSMITTER_CONTROL_PS_ALLOCATION_V1_7;
//ucAction
typedef enum {
  ...
  ATOM_TRANSMITTER_ACTION_SET_TMDS_VS             = 14,
  ATOM_TRANSMITTER_ACTION_RESET                   = 15,
  ATOM_TRANSMITTER_ACTION_SETUP_TxFFE             = 16,
...
typedef enum
{
  ATOM_TRANMSITTER_V7__DIGA_SEL                   = 0x01,
  ATOM_TRANMSITTER_V7__DIGB_SEL                   = 0x02,
  ATOM_TRANMSITTER_V7__DIGC_SEL                   = 0x04,
  ATOM_TRANMSITTER_V7__DIGD_SEL                   = 0x08,
  ATOM_TRANMSITTER_V7__DIGE_SEL                   = 0x10,
  ATOM_TRANMSITTER_V7__DIGF_SEL                   = 0x20,
  ATOM_TRANMSITTER_V7__DIGG_SEL                   = 0x40,
} ATOM_DIG_TRANSMITTER_CONTROL_DIGFE_SEL_V7;

//ucHPDSel
typedef enum
{
  ATOM_TRANSMITTER_V7_NO_HPD_SEL                  = 0x00,
  ATOM_TRANSMITTER_V7_HPD1_SEL                    = 0x01,
  ATOM_TRANSMITTER_V7_HPD2_SEL                    = 0x02,
  ATOM_TRANSMITTER_V7_HPD3_SEL                    = 0x03,
  ATOM_TRANSMITTER_V7_HPD4_SEL                    = 0x04,
  ATOM_TRANSMITTER_V7_HPD5_SEL                    = 0x05,
  ATOM_TRANSMITTER_V7_HPD6_SEL                    = 0x06,
} ATOM_DIG_TRANSMITTER_CONTROL_HPD_SEL_V7;
...
typedef enum {
  ...
  ATOM_DISPLAY_LCD2_CONNECT           =0x0020,
...
typedef enum {
  ...
  ATOM_DISPLAY_LCD2_ACTIVE            =0x0020,
