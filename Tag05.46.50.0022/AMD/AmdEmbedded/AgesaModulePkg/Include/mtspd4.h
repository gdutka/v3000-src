...
#define SPD_DRAM_DEVICE_TYPE           2
  ...
  #define DEVICE_TYPE_LPDDR4           0x10
  #define DEVICE_TYPE_LPDDR4X          0x11
...
#define SPD_SIGNAL_LOADING             6 // [1:0] Signal Loading
  #define SIGNAL_LOADING_MASK        0x3
#define SPD_CHANNELS_PER_PKG           6 // [3:2] Channels per Package
  #define CHANNELS_PER_PKG_SHIFT       2
  #define CHANNELS_PER_PKG_MASK        3
#define SPD_DIE_COUNT                  6 // [6:4] Die Count
...
#define SPD_RANKS                      12 //
  ...
  #define RANKS_MASK                    7 //
#define SPD_BYTE_MODE_ID               12 // Byte Mode Identification
  #define BYTE_MODE_ID_SHIFT            6 // [6] 0 = Standard Device, 1 = Byte Mode Device
...
#define SPD_CHANNELS_PER_SYS           13 // [7:5] Number of System Channels
...
#define SPD_NVDIMM_HYBRID_MODULE_MEDIA_TYPES_LSB  201
  ...
  #define UNKNOWN_UNDEFINED_MSK         1
...
#define SPD_NVDIMM_FUNCTION_0_INTERFACE_DESCRIPTORS_LSB  204
  ...
  #define FUNCTION_CLASS_LOW_MSK        7
...
#define SPD_NVDIMM_FUNCTION_0_INTERFACE_DESCRIPTORS_MSB  205
  ...
  #define FUNCTION_INTERFACE_IMPLEMENTED_MSK       1
...
typedef UINT16 SPD_CAPACITY_TABLE;
