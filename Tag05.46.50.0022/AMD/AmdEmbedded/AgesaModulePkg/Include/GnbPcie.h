 ...
 * @file
 *
 * PCIe component definitions for Family 15h
 *
 *
 *
...
/// PCIe PSPP Power policy for Family 15h ONLY
typedef enum  {
  PsppDisabled,                                           ///< PSPP disabled
  PsppPerformance = 1,                                    ///< Performance
  PsppBalanceHigh,                                        ///< Balance-High (Deprecated after FM15h)
  PsppBalanceLow,                                         ///< Balance-Low (Deprecated after FM15h)
  PsppPowerSaving,                                        ///< Power Saving
  MaxPspp                                                 ///< Max Pspp for boundary check
} PCIE_PSPP_POLICY_FM15H;
