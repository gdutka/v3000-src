...
#define DXIO_MSG_DBUG_SETVALUES                 0x2e       /*!< Allows the configuration of a new configuredPackageType variable. */
...
/// Heap Type defines for DXIO_MSG_DBUG_SetValues
#define DXIO_SETVALUES_CFGPKGTYPE               2
...
typedef struct {
  ...
  UINT32          capabilities1:32;            ///< capabilities1
} DXIO_LINK_CAP;
...
///DXIO Package Type Descriptor
typedef enum {
  dxio_e_configuredPackageType_AM4       = 0,
  dxio_e_configuredPackageType_FP5       = 1,
  dxio_e_configuredPackageType_NUM_PKGS  = 2
} DXIO_CONFIGURED_PACKAGETYPE_E;
//------------------------------------------------------------------------------
// SpeedSet Overrides
//------------------------------------------------------------------------------
