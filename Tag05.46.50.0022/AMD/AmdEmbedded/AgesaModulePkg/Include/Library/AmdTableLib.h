...
#define PACKAGE_TYPE_SP3R3          (1 << 7)
#define PACKAGE_TYPE_SP3            (1 << 4)
...
#define AMD_PF_SP3r3          BIT1
#define AMD_PF_SP3_WS         BIT2
#define AMD_PF_SP3            BIT3
#define AMD_PF_X2APIC         BIT4
#define AMD_PF_APIC           BIT5
#define AMD_PF_DIS_IBRS       BIT6
#define AMD_PF_EMULATION      BIT7
#define AMD_PF_BRANCH_SAMPLING BIT8

// Not a platform type, but treat all others as AND
#define AMD_PF_AND            BIT31

#define AMD_PF_ALL    (AMD_PF_AM4 | AMD_PF_SP3r3 | AMD_PF_SP3_WS | AMD_PF_SP3 | AMD_PF_X2APIC | AMD_PF_APIC | AMD_PF_DIS_IBRS | AMD_PF_EMULATION | AMD_PF_BRANCH_SAMPLING)
...
typedef struct {
  ...
  UINT32          PlatformSp3r3:1;            ///< BIT_1 SP3r3 package
  UINT32          PlatformSp3Ws:1;            ///< BIT_2 SP3 package WS
  UINT32          PlatformSp3:1;              ///< BIT_3 SP3 package
  UINT32          PlatformX2Apic:1;           ///< BIT_4 x2APIC mode desired
  UINT32          PlatformApic:1;             ///< BIT_5 APIC mode desired
  UINT32          PlatformDisIbrs:1;          ///< BIT_6 IBRS (Indirect Branch Prediction Speculation) should be disabled
  UINT32          PlatformEmulation:1;        ///< BIT_7 In emulation environment
  UINT32          PlatformBranchSampling:1;   ///< BIT_8 Branch Sampling desired
  UINT32          :(31 - 9);                  ///< The possibilities are (not quite) endless.
 ...
 */
typedef struct {
  UINT32       :(31 - 0);                      ///< available for future expansion.
...
/**
 * Get the SoC Logical ID for the current core.
 */
VOID
...
/**
 * Get the Core Logical ID for the current core.
 */
VOID
GetCoreLogicalIdOnCurrentCore (
  IN       AMD_CONFIG_PARAMS  *StdHeader,
  IN       CORE_LOGICAL_ID    *CoreLogicalId
  );
