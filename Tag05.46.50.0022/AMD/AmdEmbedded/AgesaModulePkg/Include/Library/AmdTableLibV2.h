...
#define AMD_PF_EMULATION       BIT3
#define AMD_PF_BRANCH_SAMPLING BIT4

// Not a platform type, but treat all others as AND
#define AMD_PF_AND            BIT31

#define AMD_PF_ALL    (AMD_PF_AM4 | AMD_PF_X2APIC | AMD_PF_APIC | AMD_PF_EMULATION | AMD_PF_BRANCH_SAMPLING)
...
typedef struct {
  ...
  UINT32          PlatformEmulation:1;        ///< BIT_3 In emulation environment
  UINT32          PlatformBranchSampling:1;   ///< BIT_4 Branch Sampling desired
  UINT32          :(30 - 5);                  ///< The possibilities are (not quite) endless.
