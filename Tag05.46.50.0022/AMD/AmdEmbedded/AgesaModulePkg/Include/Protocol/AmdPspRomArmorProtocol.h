 ...
 *
 */
#ifndef _PSP_ROM_ARMOR_PROTOCOL_H_
#define _PSP_ROM_ARMOR_PROTOCOL_H_
...
typedef
EFI_STATUS
(EFIAPI *PSP_EXECUTE_SPI_COMMAND) (
  VOID
);

typedef
EFI_STATUS
(EFIAPI *PSP_SWITCH_CHIP_SELECT) (
  IN UINT8 ChipSelect
);

/// Structure for _PSP_ROM_ARMOR_PROTOCOL_H_ protocol
typedef struct  _PSP_ROM_ARMOR_PROTOCOLL {
  PSP_ENTER_SMMONLY_MODE    PspEnterSmmOnlyMode;
  PSP_ENFORCE_WHITE_LIST    PspEnforceWhitelist;
  PSP_EXECUTE_SPI_COMMAND   PspExecuteSpiCommand;
  PSP_SWITCH_CHIP_SELECT    PspSwitchChipSelect;
  SPI_COMMUNICATION_BUFFER  RomArmorCommBuff;
  UINT8                                                                                                                                             gRomArmorActive;
} PSP_ROM_ARMOR_PROTOCOL ;

extern EFI_GUID gPspRomArmorProtocolGuid;
#endif //_PSP_ROM_ARMOR_PROTOCOL_H_
