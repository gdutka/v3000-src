...
/// SCOPE with 3 NameSeg
typedef struct _SCOPE2 {
  UINT8   ScopeOpcode;                  ///< Opcode
  UINT16  ScopeLength;                  ///< Scope Length
  UINT8   ScopeValue1;                  ///< Value1
  UINT8   ScopeValue2;                  ///< Value2
  UINT8   ScopeValue3;                  ///< Value3, SegCount
  UINT8   ScopeNamePt1a__;              ///< Name Pointer
  UINT8   ScopeNamePt1a_S;              ///< Name Pointer
  UINT8   ScopeNamePt1a_B;              ///< Name Pointer
  UINT8   ScopeNamePt1b__;              ///< Name Pointer
  UINT8   ScopeNamePt2a_P;              ///< Name Pointer
  UINT8   ScopeNamePt2a_L;              ///< Name Pointer
  UINT8   ScopeNamePt2a_T;              ///< Name Pointer
  UINT8   ScopeNamePt2a_F;              ///< Name Pointer
  UINT8   ScopeNamePt3a_C;              ///< Name Pointer
  UINT8   ScopeNamePt3a_P;              ///< Name Pointer
  UINT8   ScopeNamePt3a_U;              ///< Name Pointer
  UINT8   ScopeNamePt3a_0;              ///< Name Pointer
} SCOPE2;
#define   SCOPE2_STRUCT_SIZE sizeof (SCOPE2) // 18 Bytes
...
#define     SCOPE2_LENGTH   (SCOPE2_STRUCT_SIZE + \
                            PCT_STRUCT_SIZE + \
                            PSS_HEADER_STRUCT_SIZE + \
                            PSS_BODY_STRUCT_SIZE + \
                            PPC_HEADER_BODY_STRUCT_SIZE)
...
#define     SCOPE2_VALUE1   0x5C // RootChar '\'
#define     SCOPE2_VALUE2   0x2F
#define     SCOPE2_VALUE3   0x3
#define     SCOPE_NAME__    '_'
#define     SCOPE_NAME_P    'P'
#define     SCOPE_NAME_R    'R'
#define     SCOPE_NAME_S    'S'
#define     SCOPE_NAME_B    'B'
#define     SCOPE_NAME_L    'L'
#define     SCOPE_NAME_T    'T'
#define     SCOPE_NAME_F    'F'
...
typedef struct  _CPC_HEADER {
  UINT8   NameOpcode;                   ///< Name Opcode
  UINT8   CpcName_a__;                  ///< String "_"
  UINT8   CpcName_a_C_0;                ///< String "C"
  UINT8   CpcName_a_P;                  ///< String "P"
  UINT8   CpcName_a_C_1;                ///< String "C"
  UINT8   PkgOpcode;                    ///< Package Opcode
  UINT16  PkgLength;                    ///< CPC Length
  UINT8   PkgNumElements;               ///< Package Num Elements
  UINT8   NumEntriesPrefix;             ///< 0xA
  UINT8   NumEntries;                   ///< 17
  UINT8   RevisionPrefix;               ///< 0xA
  UINT8   Revision;                     ///< 1
} CPC_HEADER;
#define   CPC_HEADER_STRUCT_SIZE sizeof (CPC_HEADER)  // 13 Bytes


// Acutally, we don't need below structure, leave the code here could make us know _CPC body well
//#define   CPC_REGISTER_COUNT  21
//typedef struct  _CPC_HEADER_BODY {
//  CPC_HEADER        Header;
//  RES_TEMP_GEN_REG  Register[CPC_REGISTER_COUNT];  ///< Registers
//} CPC_HEADER_BODY;

//#define   CPC_HEADER_BODY_STRUCT_SIZE sizeof (CPC_HEADER_BODY)
