...
#define MDIO_AN_VEND_PROV_1000BASET_FULL   BIT15
#define MDIO_AN_VEND_PROV_1000BASET_HALF   BIT14
#define MDIO_AN_VEND_PROV_DOWNSHIFT_EN     BIT4
...
#define PORT_DEF  0x00  // PORT_DEF, this is for getting the PHY_IDs, not to be modified w.r.t PortNum
