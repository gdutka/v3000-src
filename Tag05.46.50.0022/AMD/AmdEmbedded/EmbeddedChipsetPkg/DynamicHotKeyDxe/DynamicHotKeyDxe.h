...
#define GET_NEXT_DYNAMIC_STRING_PTR(a)            (DYNAMIC_STRING_EXTERNAL *)((UINTN)a + sizeof(DYNAMIC_STRING_EXTERNAL) - sizeof(CHAR8) + AsciiStrnSizeS(&(a->String), MAX_STRING_LENGTH))
...
typedef struct {
  ...
  EFI_STRING_ID        StringToken;   ///< StringToken
} DYNAMIC_STRING;
