...
/**
  This function uses to add the EFI_MEMORY_RUNTIME memory attribute to
  whole flash.
...
//[-start-220905-IB14740261-remove]//
//  EFI_EVENT                           ReadyToBootEvent;
//[-end-220905-IB14740261-remove]//
