...
typedef struct {
  ...
  UINT8   Reserved3[0x10];  // FF98h - FFA7h, Reserved, 16Bytes, --
...
typedef struct {
  ...
  UINT64  IA32_EFER;             // FED0h, EFER, Quadword, Read-Only
  ...
  UINT64  _R8;                   // FFB8h, R8,  Quadword, Read/Write
...
///
/// Minimum SMM Revision ID that supports AMD64
///
#define SMRAM_SAVE_STATE_MIN_REV_ID_AMD64 0x30064
...
///
/// AMD SMRAM Save State Map I/O Instruction Restart DWORD structure
///
typedef union {
  struct {
    UINT32  Type:1;
  ...
  UINT32  Uint32;
} AMD_SMRAM_SAVE_STATE_SMMIOTRAP;
