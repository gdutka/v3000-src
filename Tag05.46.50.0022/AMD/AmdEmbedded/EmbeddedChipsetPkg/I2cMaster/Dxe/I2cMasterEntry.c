...
--*/
{
  ...
  DEBUG ((EFI_D_INFO, "InitializeI2cMasterEntry Start. \n"));
  ...
  if (EFI_ERROR(Status)) {
    DEBUG ((EFI_D_INFO, "ERROR !!! LocateProtocol I2cPlatformSpecificProtocol Status:%x \n" , Status));
    return Status;
  }
  ...
  DEBUG ((EFI_D_INFO, "InitializeI2cMasterEntry End. \n"));
  return EFI_SUCCESS;
}
