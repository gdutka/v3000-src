  ...
  )
{
  ...
  //  IC_SDA_HOLD.IC_SDA_TX_HOLD
  //
  I2cPort->I2cHcWrite32(
             I2cPort, 
             I2cPort->Info.SdaHoldTimeLen, 
             (I2cPort->Info.SpeedClockInfo[SpeedIndex].SdaHold << 16 | I2cPort->Info.SpeedClockInfo[SpeedIndex].SdaHold)
             );
  ...
  )
{
  ...
  *I2cDev    = NULL;
  ...
  do {
    Status = I2cEnumerate->Enumerate (I2cEnumerate, (CONST EFI_I2C_DEVICE**)I2cDev);
