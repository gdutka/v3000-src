...
echo ApcbV3Editor.bat -r SSP %SRC_BIN_PATH% "!INPUT_HEADER_FILE!" %OUTXML_NAME%

call ApcbV3Editor.bat -r SSP %SRC_BIN_PATH% "!INPUT_HEADER_FILE!" %OUTXML_NAME%

@echo Read complete, Press any key to exit.
@pause>nul
@echo on