...
#define MAX_NUMBER_OF_PSP_L1_ENTRIES    32
...
typedef struct {
  ...
  PSP_DIRECTORY_ENTRY   PspEntry[MAX_NUMBER_OF_PSP_L1_ENTRIES];      ///< Array of PSP entries each pointing to a binary in SPI flash
