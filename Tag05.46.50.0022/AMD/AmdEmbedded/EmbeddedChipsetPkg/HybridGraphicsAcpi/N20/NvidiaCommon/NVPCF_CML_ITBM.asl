...
/*
    == Readme ==
    For NVPCF 2.0 support with CML-ITBM (IOTRAP in CPTB table), SBIOS has to adjust below code to meet platform:
    * OEM/IBV should check "_customize" keyword for TO-DO *
    ...
    - OEM needs modify the ITBM SCI event handler
...
/* Please refer ..\Intel\AlderLake\AlderLakeBoardPkg\Acpi\AcpiTables\Dsdt\Gpe.asl */
//Scope (\_GPE)
//{
//    //
