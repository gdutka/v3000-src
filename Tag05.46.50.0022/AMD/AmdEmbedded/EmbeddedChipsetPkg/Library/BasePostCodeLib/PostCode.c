...
#define   IBV_DEBUG_CODE_GROUP  0x02
/**
  ...
  )
{
  ...
  IoWrite32 ((UINT32)(PcdGet16(PcdH2ODebugPort)), (UINT32)(Value | (IBV_DEBUG_CODE_GROUP << 8)));
  ...
  )
{
  ...
  IoWrite32 ((UINT32)(PcdGet16(PcdH2ODebugPort)), (UINT32)(Value));
  if (PcdGetBool (PcdPostCodeRedirectedToReportStatusCode)) {
