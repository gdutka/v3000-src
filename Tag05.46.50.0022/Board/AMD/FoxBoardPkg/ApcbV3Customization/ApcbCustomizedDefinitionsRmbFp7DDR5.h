...
#define APCB_TOKEN_UID_MEMORYBUSFREQUENCYLIMIT_VALUE                           UNSUPPORTED_DDR_FREQUENCY
...
//
// ESPI ABL Initialized
//
// ESPI default clk value
#define APCB_TOKEN_UID_ESPI_CLOCK_VALUE                                      ESPI_CLOCKVAL_33MHZ
// Enable Port 80 Uuard mode
#define APCB_TOKEN_UID_ESPI_IOMODE_VALUE                                      ESPI_IOMODEVAL_QUAD
// IRQ1: High
//#define APCB_TOKEN_UID_ESPI_IRQ_POLARITY_VALUE                                0x1002
// ## PLAT-82947 A spurious IO60/64 read is observed on Z9 exit
#define APCB_TOKEN_UID_ESPI_IRQ_POLARITY_VALUE                                0x00

#define APCB_TOKEN_UID_ESPI_IRQ_MASK_VALUE                                    0xFFEFFD
// EC 0x3F8
...
// UCSI decode
#define APCB_TOKEN_UID_ESPI_MMIORANGE0_BASE_VALUE                             0xFEEC2000
#define APCB_TOKEN_UID_ESPI_MMIORANGE0_SIZE_VALUE                             0xFF

#define APCB_TOKEN_UID_ESPI_KBC6064_ENABLE_VALUE                              FALSE
...
#define APCB_TOKEN_UID_DF_BOTTOMIO_VALUE                                       0x80
...
#define BLDCFG_EARLY_PCIE_TRAINING      FALSE
  ...
  #define APCB_TOKEN_UID_BMC_START_LANE_VALUE                                    129
  //Alias: BLDCFG_BMC_END_LANE
  #define APCB_TOKEN_UID_BMC_END_LANE_VALUE                                      129
#else
  //Alias: BLDCFG_BMC_SOCKET_INFO
...
#define APCB_TOKEN_UID_PCIE_RESET_GPIO_PIN_SELECT_VALUE                        0x0002001B
#define APCB_TOKEN_UID_PSP_SYSTEM_TPM_ALG_SMX_VALUE                            1
#define APCB_TOKEN_UID_PSP_SYSTEM_TPM_CONFIG_VALUE                             1
// Power sensor routing is disabled as per the PcdPowerSensorsRoutingSelect, setting APCB token as 0
#define APCB_TOKEN_UID_NBIO_POWER_SENSORS_ROUTING_SELECT_VALUE                 0
// Modern standby feature is disabled as per the PcdModernStandbyEnable, setting the APCB token as 0
#define APCB_TOKEN_UID_MODERN_STANDBY_ENABLE_VALUE                             0
#define APCB_TOKEN_UID_PSP_RPMC_ENABLE_VALUE                                   1
#define APCB_TOKEN_UID_RPMC_RECOVERY_TYPE_VALUE                                1
#define APCB_TOKEN_UID_SECOND_PCIE_LINK_START_LANE_VALUE                       15
#define APCB_TOKEN_UID_SECOND_PCIE_LINK_END_LANE_VALUE                         15
...
//MPM M Event
#define APCB_TOKEN_UID_MPM_AC_GPIO_INDEX_VALUE                                 10
#define APCB_TOKEN_UID_MPM_WLAN_GPIO_INDEX_VALUE                               18
...
#define BLDCFG_MPM_WLAN_POWEREN_CONTROL_VALUE            0x2
#define BLDCFG_MPM_WLAN_POWEREN_CMDSTSPORT_VALUE         0x666
#define BLDCFG_MPM_WLAN_POWEREN_DATAPORT_VALUE           0x662
#define BLDCFG_MPM_WLAN_POWEREN_OFFSET_VALUE             0xAA
#define BLDCFG_MPM_WLAN_POWEREN_MASK_VALUE               0x10
#define BLDCFG_MPM_WLAN_POWEREN_DATA_VALUE               0x10
