...
TOOL_DIRECTORY_PATH = CURRENT_DIRECTORY.joinpath("../../../FoxBoardPkg/ApcbToolV3/Tools").resolve()
...
def build() -> None:
    ...
    compiler.add_include_directory("../Inc/RMB")
    ...
    if "1" == os.environ.get("APCB_EXTERNAL_BUILD", "0"):
        ...
        compiler.add_compile_definition("APCB_INTERNAL_BUILD", "1")
    ...
    with open(CURRENT_DIRECTORY.joinpath("ApcbCreate.json"), "r") as configuration_file:
        ...
        if "APCB_DATA_BOARD_DIR_LIST" in os.environ.keys():
            ...
            board_list = ["CRB_Fox", "CRB_Lilac_Emu", "CRB_Lilac_Dramdown_Instance1", "CRB_Lilac_Dramdown_Instance2"]
        ...
        for target_name, target_configuration in configuration.items():
            ...
            if "ApcbDataDefaultRecovery" == target_name:
                ...
                if "ApcbDataUpdatable_68" == target_name:
                    apcbDataUpdatable_68_path = CURRENT_DIRECTORY.joinpath("ApcbDataUpdatable_68")
                    apcbDataUpdatable_path = CURRENT_DIRECTORY.joinpath("ApcbDataUpdatable")
                    apcbDataUpdatable_file_path = apcbDataUpdatable_path.joinpath("ApcbData_FP7r2_GID_0x3000_Type_TokenBoolean.c")
                    shutil.copy2(str(apcbDataUpdatable_file_path), str(apcbDataUpdatable_68_path))
                    apcbDataUpdatable_file_path = apcbDataUpdatable_path.joinpath("ApcbData_FP7r2_GID_0x3000_Type_Token1Byte.c")
                    shutil.copy2(str(apcbDataUpdatable_file_path), str(apcbDataUpdatable_68_path))
                    apcbDataUpdatable_file_path = apcbDataUpdatable_path.joinpath("ApcbData_FP7r2_GID_0x3000_Type_Token2Bytes.c")
                    shutil.copy2(str(apcbDataUpdatable_file_path), str(apcbDataUpdatable_68_path))
                    apcbDataUpdatable_file_path = apcbDataUpdatable_path.joinpath("ApcbData_FP7r2_GID_0x3000_Type_Token4Bytes.c")
                    shutil.copy2(str(apcbDataUpdatable_file_path), str(apcbDataUpdatable_68_path))
                    apcbDataUpdatable_file_path = apcbDataUpdatable_path.joinpath("ApcbData_FP7r2_GID_0x3000_Type_TokenBooleanDebug.c")
                    shutil.copy2(str(apcbDataUpdatable_file_path), str(apcbDataUpdatable_68_path))
                    apcbDataUpdatable_file_path = apcbDataUpdatable_path.joinpath("ApcbData_FP7r2_GID_0x3000_Type_Token1ByteDebug.c")
                    shutil.copy2(str(apcbDataUpdatable_file_path), str(apcbDataUpdatable_68_path))
                    apcbDataUpdatable_file_path = apcbDataUpdatable_path.joinpath("ApcbData_FP7r2_GID_0x3000_Type_Token2BytesDebug.c")
                    shutil.copy2(str(apcbDataUpdatable_file_path), str(apcbDataUpdatable_68_path))
                    apcbDataUpdatable_file_path = apcbDataUpdatable_path.joinpath("ApcbData_FP7r2_GID_0x3000_Type_Token4BytesDebug.c")
                    shutil.copy2(str(apcbDataUpdatable_file_path), str(apcbDataUpdatable_68_path))
