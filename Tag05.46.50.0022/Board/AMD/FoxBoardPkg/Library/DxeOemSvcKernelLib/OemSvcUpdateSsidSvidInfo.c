...
EFI_STATUS
OemProgramAdapterIdRegSsidSvid (
  IN     UINT8    Bus,
  IN     UINT8    Dev,
  IN     UINT8    Func,
  IN OUT UINT32   *SsidSvid
...
STATIC OEM_SSID_SVID_TABLE SsidTable[] = {
  // Vendor ID            Device ID            FunctionToProgramSsidSvid
  // {INTERNAL_VGA_VID,    INTERNAL_VGA_DID17,  OemProgramIgdAdapterIdRegSsidSvid},  // VanGogh/Rembrandt iGPU
  // {0x10DE,              DEVICE_ID_DONT_CARE, OemProgramSsidSvid0xFFFF10DE},    // nV
