...
set SMMSUPV_PKG_PATH=%WORKSPACE%\%CHIPSET_REL_PATH%\AmdSupervisorPkg
...
@REM #[-start-220301-IB14740220-modify]#
@REM  @for /f "tokens=3" %%a in ('find "TARGET " %WORKSPACE%\Conf\target.txt') do @set TARGET=%%a
@REM #[-end-220301-IB14740220-modify]#
...
@REM #[-start-220301-IB14740220-modify]#
if /I "%TARGET%" == "DEBUG" (
  copy %SMMSUPV_PKG_PATH%\Binary\SmmSupervisor\Debug\SmmSupvSig.bin               %BIN_PATH%\. /Y
) else (
  copy %SMMSUPV_PKG_PATH%\Binary\SmmSupervisor\Release\SmmSupvSig.bin               %BIN_PATH%\. /Y
)
@REM #[-end-220301-IB14740220-modify]#
